// Verbatim copy of the server's com.openrsc.server.constants.ItemId —
// the authoritative id registry. Only the package line is changed.
// IdEnumParityTest pins this against the server source; refresh by
// re-copying when it fails.
package openrsc.bot.api.id;

import java.util.HashMap;
import java.util.Map;

public enum ItemId implements ItemRef {
  NOTHING_REROLL5(-7),
  NOTHING_REROLL4(-6),
  NOTHING_REROLL3(-5),
  NOTHING_REROLL2(-4),
  ...
  // Halloween 2021
  RACIST_DO_NOT_USE(
      1488), // Considered an unhappy number -- https://en.wikipedia.org/wiki/Fourteen_Words
