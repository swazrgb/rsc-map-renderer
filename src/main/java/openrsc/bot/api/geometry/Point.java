 ...
 * {@link openrsc.bot.api.Targetable#z()}, {@code GameObject.z()}, {@code Location.z}) calls this
 ...
 * {@code y} as floor planes (see below). {@link openrsc.bot.core.world.CollisionMap} already names
...
public record Point(int x, int y) implements Area, Comparable<Point> {
   ...
   * {@code dx*dx + dz*dz <= 255} (see {@code BotImpl} {@code VIEW_RADIUS_SQ}), which drives
