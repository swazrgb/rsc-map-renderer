...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(e,t,n){let r=new Float32Array(So),i=new J(0,1,0);return new oa({name:`SphericalGaussianBlur`,defines:{n:So,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new oa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ro(){return new oa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zo(),fragmentShader:`
	...
	`}var Bo=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var dc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function fc(e,t){let n=dc[t];return n===void 0?(K(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var pc=new J;function mc(){return wt.getLuminanceCoefficients(pc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${pc.x.toFixed(4)}, ${pc.y.toFixed(4)}, ${pc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=rc(i,i.VERTEX_SHADER,y),S=rc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=lc(i,x,`vertex`),n=lc(i,S,`fragment`);q(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,hl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ui(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new oa({vertexShader:pl,fragmentShader:ml,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ai(new Xi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},gl=class extends ot{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,h=new hl,g={},_=t.getContextAttributes(),v=null,y=null,x=[],S=[],C=new gt,w=null,E=new Ra;E.viewport=new Ft;let D=new Ra;D.viewport=new Ft;let O=[E,D],k=new Ua,j=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=x[e];return t===void 0&&(t=new _n,x[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=x[e];return t===void 0&&(t=new _n,x[e]=t),t.getGripSpace()},this.getHand=function(e){let t=x[e];return t===void 0&&(t=new _n,x[e]=t),t.getHandSpace()};function N(e){let t=S.indexOf(e.inputSource);if(t===-1)return;let n=x[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ee(){r.removeEventListener(`select`,N),r.removeEventListener(`selectstart`,N),r.removeEventListener(`selectend`,N),r.removeEventListener(`squeeze`,N),r.removeEventListener(`squeezestart`,N),r.removeEventListener(`squeezeend`,N),r.removeEventListener(`end`,ee),r.removeEventListener(`inputsourceschange`,te);for(let e=0;e<x.length;e++){let t=S[e];t!==null&&(S[e]=null,x[e].disconnect(t))}j=null,M=null,h.reset();for(let e in g)delete g[e];e.setRenderTarget(v),f=null,d=null,u=null,r=null,y=null,se.stop(),n.isPresenting=!1,e.setPixelRatio(w),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&K(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&K(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(v=e.getRenderTarget(),r.addEventListener(`select`,N),r.addEventListener(`selectstart`,N),r.addEventListener(`selectend`,N),r.addEventListener(`squeeze`,N),r.addEventListener(`squeezestart`,N),r.addEventListener(`squeezeend`,N),r.addEventListener(`end`,ee),r.addEventListener(`inputsourceschange`,te),_.xrCompatible!==!0&&await t.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(C),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;_.depth&&(o=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=_.stencil?I:F,a=_.stencil?A:T);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new Lt(d.textureWidth,d.textureHeight,{format:P,type:b,depthTexture:new Vi(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new Lt(f.framebufferWidth,f.framebufferHeight,{format:P,type:b,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function te(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=S.indexOf(n);r>=0&&(S[r]=null,x[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=S.indexOf(n);if(r===-1){for(let e=0;e<x.length;e++)if(e>=S.length){S.push(n),r=e;break}else if(S[e]===null){S[e]=n,r=e;break}if(r===-1)break}let i=x[r];i&&i.connect(n)}}let ne=new J,re=new J;function ie(e,t,n){ne.setFromMatrixPosition(t.matrixWorld),re.setFromMatrixPosition(n.matrixWorld);let r=ne.distanceTo(re),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ae(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;h.texture!==null&&(h.depthNear>0&&(t=h.depthNear),h.depthFar>0&&(n=h.depthFar)),k.near=D.near=E.near=t,k.far=D.far=E.far=n,(j!==k.near||M!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),j=k.near,M=k.far),k.layers.mask=e.layers.mask|6,E.layers.mask=k.layers.mask&-5,D.layers.mask=k.layers.mask&-3;let i=e.parent,a=k.cameras;ae(k,i);for(let e=0;e<a.length;e++)ae(a[e],i);a.length===2?ie(k,E,D):k.projectionMatrix.copy(E.projectionMatrix),L(e,k,i)};function L(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=lt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(d===null&&f===null))return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(k)},this.getCameraTexture=function(e){return g[e]};let R=null;function oe(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(y,f.framebuffer),e.setRenderTarget(y));let i=!1;t.length!==k.cameras.length&&(k.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(y,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(y))}let o=O[n];o===void 0&&(o=new Ra,o.layers.enable(n),o.viewport=new Ft,O[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(k.matrix.copy(o.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),i===!0&&k.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&h.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=g[n];e||(e=new Ui,g[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<x.length;e++){let t=S[e],n=x[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}R&&R(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let se=new co;se.setAnimationLoop(oe),this.setAnimationLoop=function(e){R=e},this.dispose=function(){}}},_l=new Bt,vl=new Y;vl.set(-1,0,0,0,1,0,0,0,1);function yl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,na(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(_l.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(vl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function bl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return q(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?K(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):K(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var xl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Sl=null;function Cl(){return Sl===null&&(Sl=new ci(xl,16,16,re,D),Sl.name=`DFG_LUT`,Sl.minFilter=_,Sl.magFilter=_,Sl.wrapS=f,Sl.wrapT=f,Sl.generateMipmaps=!1,Sl.needsUpdate=!0),Sl}var wl=class{constructor(e={}){let{canvas:t=$e(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=b}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let m=f,h=new Set([ae,ie,ne]),g=new Set([b,T,C,A,O,k]),_=new Uint32Array(4),v=new Int32Array(4),x=new J,S=null,w=null,E=[],j=[],M=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let N=this,ee=!1,P=null,F=null,I=null,te=null;this._outputColorSpace=Ve;let re=0,L=0,R=null,oe=-1,se=null,ce=new Ft,z=new Ft,B=null,le=new Sn(0),ue=0,de=t.width,fe=t.height,V=1,pe=null,me=null,he=new Ft(0,0,de,fe),ge=new Ft(0,0,de,fe),_e=!1,ve=new Ti,ye=!1,be=!1,xe=new Bt,Se=new J,Ce=new Ft,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Te=!1;function Ee(){return R===null?V:1}let H=n;function De(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,Qe,!1),t.addEventListener(`webglcontextrestored`,et,!1),t.addEventListener(`webglcontextcreationerror`,nt,!1),H===null){let t=`webgl2`;if(H=De(t,e),H===null)throw De(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw q(`WebGLRenderer: `+e.message),e}let Oe,ke,U,Ae,W,G,je,Me,Ne,Pe,Fe,Ie,Le,Re,ze,Be,He,Ue,We,Ge,Ke,qe,Je;function Xe(){Oe=new Ho(H),Oe.init(),Ke=new fl(H,Oe),ke=new vo(H,Oe,e,Ke),U=new ul(H,Oe),ke.reversedDepthBuffer&&d&&U.buffers.depth.setReversed(!0),F=H.createFramebuffer(),I=H.createFramebuffer(),te=H.createFramebuffer(),Ae=new Go(H),W=new Wc,G=new dl(H,Oe,U,W,ke,Ke,Ae),je=new Vo(N),Me=new lo(H),qe=new go(H,Me),Ne=new Uo(H,Me,Ae,qe),Pe=new qo(H,Ne,Me,qe,Ae),Ue=new Ko(H,ke,G),ze=new yo(W),Fe=new Uc(N,je,Oe,ke,qe,ze),Ie=new yl(N,W),Le=new Jc,Re=new tl(Oe),He=new ho(N,je,U,Pe,p,s),Be=new ll(N,Pe,ke),Je=new bl(H,Ae,ke,U),We=new _o(H,Oe,Ae),Ge=new Wo(H,Oe,Ae),Ae.programs=Fe.programs,N.capabilities=ke,N.extensions=Oe,N.properties=W,N.renderLists=Le,N.shadowMap=Be,N.state=U,N.info=Ae}Xe(),m!==1009&&(M=new Yo(m,t.width,t.height,o,r,i));let Ze=new gl(N,H);this.xr=Ze,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){let e=Oe.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Oe.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(e){e!==void 0&&(V=e,this.setSize(de,fe,!1))},this.getSize=function(e){return e.set(de,fe)},this.setSize=function(e,n,r=!0){if(Ze.isPresenting){K(`WebGLRenderer: Can't change size while VR device is presenting.`);return}de=e,fe=n,t.width=Math.floor(e*V),t.height=Math.floor(n*V),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),M!==null&&M.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(de*V,fe*V).floor()},this.setDrawingBufferSize=function(e,n,r){de=e,fe=n,V=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(m===1009){q(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){K(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}M.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ce)},this.getViewport=function(e){return e.copy(he)},this.setViewport=function(e,t,n,r){e.isVector4?he.set(e.x,e.y,e.z,e.w):he.set(e,t,n,r),U.viewport(ce.copy(he).multiplyScalar(V).round())},this.getScissor=function(e){return e.copy(ge)},this.setScissor=function(e,t,n,r){e.isVector4?ge.set(e.x,e.y,e.z,e.w):ge.set(e,t,n,r),U.scissor(z.copy(ge).multiplyScalar(V).round())},this.getScissorTest=function(){return _e},this.setScissorTest=function(e){U.setScissorTest(_e=e)},this.setOpaqueSort=function(e){pe=e},this.setTransparentSort=function(e){me=e},this.getClearColor=function(e){return e.copy(He.getClearColor())},this.setClearColor=function(){He.setClearColor(...arguments)},this.getClearAlpha=function(){return He.getClearAlpha()},this.setClearAlpha=function(){He.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(R!==null){let t=R.texture.format;e=h.has(t)}if(e){let e=R.texture.type,t=g.has(e),n=He.getClearColor(),r=He.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(_[0]=i,_[1]=a,_[2]=o,_[3]=r,H.clearBufferuiv(H.COLOR,0,_)):(v[0]=i,v[1]=a,v[2]=o,v[3]=r,H.clearBufferiv(H.COLOR,0,v))}else r|=H.COLOR_BUFFER_BIT}t&&(r|=H.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&H.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),P=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,Qe,!1),t.removeEventListener(`webglcontextrestored`,et,!1),t.removeEventListener(`webglcontextcreationerror`,nt,!1),He.dispose(),Le.dispose(),Re.dispose(),W.dispose(),je.dispose(),Pe.dispose(),qe.dispose(),Je.dispose(),Fe.dispose(),Ze.dispose(),Ze.removeEventListener(`sessionstart`,ut),Ze.removeEventListener(`sessionend`,dt),ft.stop()};function Qe(e){e.preventDefault(),tt(`WebGLRenderer: Context Lost.`),ee=!0}function et(){tt(`WebGLRenderer: Context Restored.`),ee=!1;let e=Ae.autoReset,t=Be.enabled,n=Be.autoUpdate,r=Be.needsUpdate,i=Be.type;Xe(),Ae.autoReset=e,Be.enabled=t,Be.autoUpdate=n,Be.needsUpdate=r,Be.type=i}function nt(e){q(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function rt(e){let t=e.target;t.removeEventListener(`dispose`,rt),at(t)}function at(e){ot(e),W.remove(e)}function ot(e){let t=W.get(e).programs;t!==void 0&&(t.forEach(function(e){Fe.releaseProgram(e)}),e.isShaderMaterial&&Fe.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=we);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=xt(e,t,n,r,i);U.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ne.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;qe.setup(i,r,s,n,c);let h,g=We;if(c!==null&&(h=Me.get(c),g=Ge,g.setIndex(h)),i.isMesh)r.wireframe===!0?(U.setLineWidth(r.wireframeLinewidth*Ee()),g.setMode(H.LINES)):g.setMode(H.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),U.setLineWidth(e*Ee()),i.isLineSegments?g.setMode(H.LINES):i.isLineLoop?g.setMode(H.LINE_LOOP):g.setMode(H.LINE_STRIP)}else i.isPoints?g.setMode(H.POINTS):i.isSprite&&g.setMode(H.TRIANGLES);if(i.isBatchedMesh)if(Oe.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Me.get(c).bytesPerElement:1,o=W.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(H,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function st(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,vt(e,t,n),e.side=0,e.needsUpdate=!0,vt(e,t,n),e.side=2):vt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),w=Re.get(n),w.init(t),j.push(w),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(w.pushLight(e),e.castShadow&&w.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(w.pushLight(e),e.castShadow&&w.pushShadow(e))}),w.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];st(a,n,e),r.add(a)}else st(t,n,e),r.add(t)}),w=j.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){W.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Oe.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ct=null;function lt(e){ct&&ct(e)}function ut(){ft.stop()}function dt(){ft.start()}let ft=new co;ft.setAnimationLoop(lt),typeof self<`u`&&ft.setContext(self),this.setAnimationLoop=function(e){ct=e,Ze.setAnimationLoop(e),e===null?ft.stop():ft.start()},Ze.addEventListener(`sessionstart`,ut),Ze.addEventListener(`sessionend`,dt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){q(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ee===!0)return;P!==null&&P.renderStart(e,t);let n=Ze.enabled===!0&&Ze.isPresenting===!0,r=M!==null&&(R===null||n)&&M.begin(N,R);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),Ze.enabled===!0&&Ze.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(Ze.cameraAutoUpdate===!0&&Ze.updateCamera(t),t=Ze.getCamera()),e.isScene===!0&&e.onBeforeRender(N,e,t,R),w=Re.get(e,j.length),w.init(t),w.state.textureUnits=G.getTextureUnits(),j.push(w),xe.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),ve.setFromProjectionMatrix(xe,Ye,t.reversedDepth),be=this.localClippingEnabled,ye=ze.init(this.clippingPlanes,be),S=Le.get(e,E.length),S.init(),E.push(S),Ze.enabled===!0&&Ze.isPresenting===!0){let e=N.xr.getDepthSensingMesh();e!==null&&pt(e,t,-1/0,N.sortObjects)}pt(e,t,0,N.sortObjects),S.finish(),N.sortObjects===!0&&S.sort(pe,me,t.reversedDepth),Te=Ze.enabled===!1||Ze.isPresenting===!1||Ze.hasDepthSensing()===!1,Te&&He.addToRenderList(S,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ye===!0&&ze.beginShadows();let i=w.state.shadowsArray;if(Be.render(i,e,t),ye===!0&&ze.endShadows(),(r&&M.hasRenderPass())===!1){let n=S.opaque,r=S.transmissive;if(w.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];ht(n,r,e,a)}Te&&He.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];mt(S,e,n,n.viewport)}}else r.length>0&&ht(n,r,e,t),Te&&He.render(e),mt(S,e,t)}R!==null&&L===0&&(G.updateMultisampleRenderTarget(R),G.updateRenderTargetMipmap(R)),r&&M.end(N),e.isScene===!0&&e.onAfterRender(N,e,t),qe.resetDefaultState(),oe=-1,se=null,j.pop(),j.length>0?(w=j[j.length-1],G.setTextureUnits(w.state.textureUnits),ye===!0&&ze.setGlobalState(N.clippingPlanes,w.state.camera)):w=null,E.pop(),S=E.length>0?E[E.length-1]:null,P!==null&&P.renderEnd()};function pt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)w.pushLightProbeGrid(e);else if(e.isLight)w.pushLight(e),e.castShadow&&w.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||ve.intersectsSprite(e)){r&&Ce.setFromMatrixPosition(e.matrixWorld).applyMatrix4(xe);let t=Pe.update(e),i=e.material;i.visible&&S.push(e,t,i,n,Ce.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||ve.intersectsObject(e))){let t=Pe.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ce.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ce.copy(e.boundingSphere.center)),Ce.applyMatrix4(e.matrixWorld).applyMatrix4(xe)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&S.push(e,t,s,n,Ce.z,o)}}else i.visible&&S.push(e,t,i,n,Ce.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)pt(i[e],t,n,r)}function mt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;w.setupLightsView(n),ye===!0&&ze.setGlobalState(N.clippingPlanes,n),r&&U.viewport(ce.copy(r)),i.length>0&&gt(i,t,n),a.length>0&&gt(a,t,n),o.length>0&&gt(o,t,n),U.buffers.depth.setTest(!0),U.buffers.depth.setMask(!0),U.buffers.color.setMask(!0),U.setPolygonOffset(!1)}function ht(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[r.id]===void 0){let e=Oe.has(`EXT_color_buffer_half_float`)||Oe.has(`EXT_color_buffer_float`);w.state.transmissionRenderTarget[r.id]=new Lt(1,1,{generateMipmaps:!0,type:e?D:b,minFilter:y,samples:Math.max(4,ke.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:wt.workingColorSpace})}let a=w.state.transmissionRenderTarget[r.id],o=r.viewport||ce;a.setSize(o.z*N.transmissionResolutionScale,o.w*N.transmissionResolutionScale);let s=N.getRenderTarget(),c=N.getActiveCubeFace(),l=N.getActiveMipmapLevel();N.setRenderTarget(a),N.getClearColor(le),ue=N.getClearAlpha(),ue<1&&N.setClearColor(16777215,.5),N.clear(),Te&&He.render(n);let u=N.toneMapping;N.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),w.setupLightsView(r),ye===!0&&ze.setGlobalState(N.clippingPlanes,r),gt(e,n,r),G.updateMultisampleRenderTarget(a),G.updateRenderTargetMipmap(a),Oe.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,_t(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(G.updateMultisampleRenderTarget(a),G.updateRenderTargetMipmap(a))}N.setRenderTarget(s,c,l),N.setClearColor(le,ue),d!==void 0&&(r.viewport=d),N.toneMapping=u}function gt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&_t(o,t,n,s,l,c)}}function _t(e,t,n,r,i,a){e.onBeforeRender(N,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(N,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=2):N.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(N,t,n,r,i,a)}function vt(e,t,n){t.isScene!==!0&&(t=we);let r=W.get(e),i=w.state.lights,a=w.state.shadowsArray,o=i.state.version,s=Fe.getParameters(e,i.state,a,t,n,w.state.lightProbeGridArray),c=Fe.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=je.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,rt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Y(e,s),d}else s.uniforms=Fe.getUniforms(e),P!==null&&e.isNodeMaterial&&P.build(e,n,s),e.onBeforeCompile(s,N),d=Fe.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=ze.uniform),Y(e,s),r.needsLights=Ct(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=w.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function yt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=nc.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Y(e,t){let n=W.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function bt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];x.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(x))return n}return null}function xt(e,t,n,r,i){t.isScene!==!0&&(t=we),G.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=R===null?N.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:wt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=je.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(h=N.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=W.get(r),y=w.state.lights;if(ye===!0&&(be===!0||e!==se)){let t=e===se&&r.id===oe;ze.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==ze.numPlanes||v.numIntersection!==ze.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=w.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=vt(r,t,i),P&&r.isNodeMaterial&&P.onUpdateProgram(r,x,v));let S=!1,C=!1,T=!1,E=x.getUniforms(),D=v.uniforms;if(U.useProgram(x.program)&&(S=!0,C=!0,T=!0),r.id!==oe&&(oe=r.id,C=!0),v.needsLights){let e=bt(w.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||se!==e){U.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),E.setValue(H,`projectionMatrix`,e.projectionMatrix),E.setValue(H,`viewMatrix`,e.matrixWorldInverse);let t=E.map.cameraPosition;t!==void 0&&t.setValue(H,Se.setFromMatrixPosition(e.matrixWorld)),ke.logarithmicDepthBuffer&&E.setValue(H,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&E.setValue(H,`isOrthographic`,e.isOrthographicCamera===!0),se!==e&&(se=e,C=!0,T=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&E.setValue(H,`directionalShadowMap`,y.state.directionalShadowMap,G),y.state.spotShadowMap.length>0&&E.setValue(H,`spotShadowMap`,y.state.spotShadowMap,G),y.state.pointShadowMap.length>0&&E.setValue(H,`pointShadowMap`,y.state.pointShadowMap,G)),i.isSkinnedMesh){E.setOptional(H,i,`bindMatrix`),E.setOptional(H,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),E.setValue(H,`boneTexture`,e.boneTexture,G))}i.isBatchedMesh&&(E.setOptional(H,i,`batchingTexture`),E.setValue(H,`batchingTexture`,i._matricesTexture,G),E.setOptional(H,i,`batchingIdTexture`),E.setValue(H,`batchingIdTexture`,i._indirectTexture,G),E.setOptional(H,i,`batchingColorTexture`),i._colorsTexture!==null&&E.setValue(H,`batchingColorTexture`,i._colorsTexture,G));let O=n.morphAttributes;if((O.position!==void 0||O.normal!==void 0||O.color!==void 0)&&Ue.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,E.setValue(H,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(D.envMapIntensity.value=t.environmentIntensity),D.dfgLUT!==void 0&&(D.dfgLUT.value=Cl()),C){if(E.setValue(H,`toneMappingExposure`,N.toneMappingExposure),v.needsLights&&St(D,T),a&&r.fog===!0&&Ie.refreshFogUniforms(D,a),Ie.refreshMaterialUniforms(D,r,V,fe,w.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;D.probesSH.value=e.texture,D.probesMin.value.copy(e.boundingBox.min),D.probesMax.value.copy(e.boundingBox.max),D.probesResolution.value.copy(e.resolution)}nc.upload(H,yt(v),D,G)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(nc.upload(H,yt(v),D,G),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&E.setValue(H,`center`,i.center),E.setValue(H,`modelViewMatrix`,i.modelViewMatrix),E.setValue(H,`normalMatrix`,i.normalMatrix),E.setValue(H,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];Je.update(n,x),Je.bind(n,x)}}return x}function St(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Ct(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return re},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(e,t,n){let r=W.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),W.get(e.texture).__webglTexture=t,W.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=W.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){R=e,re=t,L=n;let r=null,i=!1,a=!1;if(e){let o=W.get(e);if(o.__useDefaultFramebuffer!==void 0){U.bindFramebuffer(H.FRAMEBUFFER,o.__webglFramebuffer),ce.copy(e.viewport),z.copy(e.scissor),B=e.scissorTest,U.viewport(ce),U.scissor(z),U.setScissorTest(B),oe=-1;return}else if(o.__webglFramebuffer===void 0)G.setupRenderTarget(e);else if(o.__hasExternalTextures)G.rebindTextures(e,W.get(e.texture).__webglTexture,W.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&W.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);G.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=W.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&G.useMultisampledRTT(e)===!1?W.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ce.copy(e.viewport),z.copy(e.scissor),B=e.scissorTest}else ce.copy(he).multiplyScalar(V).floor(),z.copy(ge).multiplyScalar(V).floor(),B=_e;if(n!==0&&(r=F),U.bindFramebuffer(H.FRAMEBUFFER,r)&&U.drawBuffers(e,r),U.viewport(ce),U.scissor(z),U.setScissorTest(B),i){let r=W.get(e.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=W.get(e.textures[t]);H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=W.get(e.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,t.__webglTexture,n)}oe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){q(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=W.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){U.bindFramebuffer(H.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+s),!ke.textureFormatReadable(c)){q(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!ke.textureTypeReadable(l)){q(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&H.readPixels(t,n,r,i,Ke.convert(c),Ke.convert(l),a)}finally{let e=R===null?null:W.get(R).__webglFramebuffer;U.bindFramebuffer(H.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=W.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){U.bindFramebuffer(H.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+s),!ke.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!ke.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,d),H.bufferData(H.PIXEL_PACK_BUFFER,a.byteLength,H.STREAM_READ),H.readPixels(t,n,r,i,Ke.convert(l),Ke.convert(u),0);let f=R===null?null:W.get(R).__webglFramebuffer;U.bindFramebuffer(H.FRAMEBUFFER,f);let p=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await it(H,p,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,d),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,a),H.deleteBuffer(d),H.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;G.setTexture2D(e,0),H.copyTexSubImage2D(H.TEXTURE_2D,n,0,0,o,s,i,a),U.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Ke.convert(t.format),_=Ke.convert(t.type),v;t.isData3DTexture?(G.setTexture3D(t,0),v=H.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(G.setTexture2DArray(t,0),v=H.TEXTURE_2D_ARRAY):(G.setTexture2D(t,0),v=H.TEXTURE_2D),U.activeTexture(H.TEXTURE0),U.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,t.flipY),U.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),U.pixelStorei(H.UNPACK_ALIGNMENT,t.unpackAlignment);let y=U.getParameter(H.UNPACK_ROW_LENGTH),b=U.getParameter(H.UNPACK_IMAGE_HEIGHT),x=U.getParameter(H.UNPACK_SKIP_PIXELS),S=U.getParameter(H.UNPACK_SKIP_ROWS),C=U.getParameter(H.UNPACK_SKIP_IMAGES);U.pixelStorei(H.UNPACK_ROW_LENGTH,h.width),U.pixelStorei(H.UNPACK_IMAGE_HEIGHT,h.height),U.pixelStorei(H.UNPACK_SKIP_PIXELS,l),U.pixelStorei(H.UNPACK_SKIP_ROWS,u),U.pixelStorei(H.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=W.get(e),r=W.get(t),h=W.get(n.__renderTarget),g=W.get(r.__renderTarget);U.bindFramebuffer(H.READ_FRAMEBUFFER,h.__webglFramebuffer),U.bindFramebuffer(H.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,W.get(e).__webglTexture,i,d+n),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,W.get(t).__webglTexture,a,m+n)),H.blitFramebuffer(l,u,o,s,f,p,o,s,H.DEPTH_BUFFER_BIT,H.NEAREST);U.bindFramebuffer(H.READ_FRAMEBUFFER,null),U.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||W.has(e)){let n=W.get(e),r=W.get(t);U.bindFramebuffer(H.READ_FRAMEBUFFER,I),U.bindFramebuffer(H.DRAW_FRAMEBUFFER,te);for(let e=0;e<c;e++)w?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,n.__webglTexture,i),T?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,r.__webglTexture,a),i===0?T?H.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):H.copyTexSubImage2D(v,a,f,p,l,u,o,s):H.blitFramebuffer(l,u,o,s,f,p,o,s,H.COLOR_BUFFER_BIT,H.NEAREST);U.bindFramebuffer(H.READ_FRAMEBUFFER,null),U.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?H.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?H.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):H.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):H.texSubImage2D(H.TEXTURE_2D,a,f,p,o,s,g,_,h);U.pixelStorei(H.UNPACK_ROW_LENGTH,y),U.pixelStorei(H.UNPACK_IMAGE_HEIGHT,b),U.pixelStorei(H.UNPACK_SKIP_PIXELS,x),U.pixelStorei(H.UNPACK_SKIP_ROWS,S),U.pixelStorei(H.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&H.generateMipmap(v),U.unbindTexture()},this.initRenderTarget=function(e){W.get(e).__webglFramebuffer===void 0&&G.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?G.setTextureCube(e,0):e.isData3DTexture?G.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?G.setTexture2DArray(e,0):G.setTexture2D(e,0),U.unbindTexture()},this.resetState=function(){re=0,L=0,R=null,U.reset(),qe.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ye}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=wt._getDrawingBufferColorSpace(e),t.unpackColorSpace=wt._getUnpackColorSpace()}};function Tl(e){return`/rsc-map-renderer/cabbage/`.replace(/\/$/,``)+e}async function El(){let e=await fetch(Tl(`/api/world3d/manifest.json`));if(!e.ok)throw Error(`world3d manifest: ${e.status}`);return e.json()}function Dl(e,t,n){return Tl(`/api/world3d/cell/c_p${e.plane}_${e.a}_${e.b}_${t}.bin?v=${n}`)}function Ol(e,t){return Tl(`/api/world3d/tex/${e}.png?v=${t}`)}async function kl(){let e=await fetch(Tl(`/api/map/scenery.json`));if(!e.ok)throw Error(`/api/map/scenery.json → ${e.status}`);return e.json()}async function Al(){let e=await fetch(Tl(`/api/map/scenery-atlas.json`));if(!e.ok)throw Error(`/api/map/scenery-atlas.json → ${e.status}`);return e.json()}async function jl(){let e=await fetch(Tl(`/api/npc-spawns`));if(!e.ok)throw Error(`/api/npc-spawns → ${e.status}`);return e.json()}async function Ml(){let e=await fetch(Tl(`/api/items/wearables`));if(!e.ok)throw Error(`/api/items/wearables → ${e.status}`);return e.json()}var Nl={};async function Pl(e,t){if(Nl.sendWalk)return Nl.sendWalk(e,t)}async function Fl(e,t,n,r,i=0,a=0,o=0){if(Nl.sendInteract)return Nl.sendInteract(e,t,n,r,i,a,o)}async function Il(){let e=window.showDirectoryPicker;if(!e)throw Error(`Recording needs the File System Access API — open the ?capture URL in a Chromium browser (Chrome / Edge / Brave).`);return e({mode:`readwrite`})}function Ll(e){return new Promise((t,n)=>e.toBlob(e=>e?t(e):n(Error(`canvas.toBlob returned null`)),`image/png`))}async function Rl(e,t,n){let r=String(t).padStart(6,`0`)+`.png`,i=await(await e.getFileHandle(r,{create:!0})).createWritable();await i.write(n),await i.close()}var zl=class{step;nowBase;dateBase;elapsed=0;queue=[];origRaf;origCaf;origNow;origDateNow;realSetTimeout=window.setTimeout.bind(window);constructor(e){this.step=1e3/e,this.nowBase=performance.now(),this.dateBase=Date.now(),this.origRaf=window.requestAnimationFrame,this.origCaf=window.cancelAnimationFrame,this.origNow=performance.now,this.origDateNow=Date.now,window.requestAnimationFrame=e=>this.queue.push(e),window.cancelAnimationFrame=()=>{},performance.now=()=>this.now(),Date.now=()=>this.dateBase+this.elapsed}now(){return this.nowBase+this.elapsed}tick(){let e=this.now(),t=this.queue;this.queue=[];for(let n of t)n(e);this.elapsed+=this.step}yieldMacrotask(){return new Promise(e=>this.realSetTimeout(e,0))}uninstall(){window.requestAnimationFrame=this.origRaf,window.cancelAnimationFrame=this.origCaf,performance.now=this.origNow,Date.now=this.origDateNow}},Bl=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=e(((e,t)=>{t.exports=Bl()}))(),Vl={bot:new Sn(4826879),npc:new Sn(16738893),player:new Sn(16757216)},Hl=new Sn(16777215),Ul=new Sn(16720418),Wl=new Sn(16770140),Gl={bot:.62,npc:.45,player:.52},Kl=6144,ql=640,Jl=250,Yl=120,Xl=60,Zl=1263,Ql=class{rings;ghosts;tracked=new Map;plates=new Map;bars=new Map;splatDivs=new Map;splats=new Map;splatSeq=0;splatSeen=new Map;bubbleDivs=new Map;bubbles=new Map;bubbleSeen=new Map;actionBubbles=new Map;actionBubbleSeen=new Map;chatFont=null;plateHost;hoverKey=null;selectedEntityKey=null;showPlates=!0;npcDims=null;itemFrame=null;constructor(e,t){this.plateHost=t;let n=new Zi(46,62,24);n.rotateX(-Math.PI/2);let r=new qr({transparent:!0,opacity:.95,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2,depthWrite:!1});this.rings=new _i(n,r,Kl),this.rings.renderOrder=10;let i=new qr({transparent:!0,opacity:.33,depthFunc:6,depthWrite:!0});this.ghosts=new _i(n,i,Kl),this.ghosts.renderOrder=11;for(let t of[this.rings,this.ghosts])t.instanceMatrix.setUsage(qe),t.count=0,t.frustumCulled=!1,t.userData.noPick=!0,e.add(t)}update(e,t,n=!1){let r=new Set;for(let i of e){r.add(i.key),i.dmg!=null&&i.dmgTick!=null&&this.splatSeen.get(i.key)!==i.dmgTick&&(this.splatSeen.set(i.key,i.dmgTick),this.splats.set(i.key,{dmg:i.dmg,until:t+1e3,seq:this.splatSeq++})),i.msg!=null&&i.msgTick!=null&&this.bubbleSeen.get(i.key)!==i.msgTick&&(this.bubbleSeen.set(i.key,i.msgTick),this.bubbles.set(i.key,{msg:i.msg,until:t+3e3,canvas:null,baseline:0,midX:0,scale:0,totalWidth:0,extraLinesHeight:0})),i.bubble!=null&&i.bubbleTick!=null&&this.actionBubbleSeen.get(i.key)!==i.bubbleTick&&(this.actionBubbleSeen.set(i.key,i.bubbleTick),this.actionBubbles.set(i.key,{id:i.bubble,until:t+3e3}));let e=this.tracked.get(i.key);e?(n?(e.fromX=e.toX=e.curX=i.x,e.fromZ=e.toZ=e.curZ=i.z,e.t0=t-ql):(e.ghost??!1)===(i.ghost??!1)?(e.toX!==i.x||e.toZ!==i.z)&&(e.fromX=e.curX,e.fromZ=e.curZ,e.toX=i.x,e.toZ=i.z,e.t0=t):(e.fromX=e.toX=e.curX=i.x,e.fromZ=e.toZ=e.curZ=i.z,e.t0=t-ql),e.name=i.name,e.selected=i.selected,e.inCombat=i.inCombat,e.kind=i.kind,e.npcId=i.npcId,e.shopId=i.shopId,e.appearance=i.appearance,e.combatLvl=i.combatLvl,e.skulled=i.skulled,e.dir=i.dir,e.hp=i.hp,e.maxHp=i.maxHp,e.bubble=i.bubble,e.sleeping=i.sleeping,e.ghost=i.ghost,e.respawnTicks=i.respawnTicks,e.respawnTicksMin=i.respawnTicksMin,e.respawnAssumed=i.respawnAssumed,e.respawnCheckedAgo=i.respawnCheckedAgo):this.tracked.set(i.key,{...i,fromX:i.x,fromZ:i.z,toX:i.x,toZ:i.z,curX:i.x,curZ:i.z,t0:t})}for(let e of[...this.tracked.keys()])if(!r.has(e)){this.tracked.delete(e);for(let t of[this.plates,this.bars,this.splatDivs,this.bubbleDivs]){let n=t.get(e);n&&(n.remove(),t.delete(e))}this.splats.delete(e),this.splatSeen.delete(e),this.bubbles.delete(e),this.bubbleSeen.delete(e),this.actionBubbles.delete(e),this.actionBubbleSeen.delete(e)}}frame(e,t,n,r,i,a,o){r.updateMatrixWorld();let s=r,c=s.isOrthographicCamera?i/Math.max(1,s.right-s.left):0,l=new Bt,u=new _t,d=new J,f=new J(0,1,0),p=0,m=new Set,h=[],g=[];for(let s of this.tracked.values()){let _=Math.min(1,(e-s.t0)/ql);s.curX=s.fromX+(s.toX-s.fromX)*_,s.curZ=s.fromZ+(s.toZ-s.fromZ)*_;let v=t(s.curX,s.curZ);if(v.y+=6,!s.ghost&&p<Kl){u.setFromUnitVectors(f,n(s.curX,s.curZ));let e=Gl[s.kind]*(s.selected?1.35:1);d.set(e,1,e),l.compose(v,u,d),this.rings.setMatrixAt(p,l),this.ghosts.setMatrixAt(p,l);let t=s.key===this.hoverKey?Wl:s.selected||s.key===this.selectedEntityKey?Hl:s.inCombat?Ul:Vl[s.kind];this.rings.setColorAt(p,t),this.ghosts.setColorAt(p,t),p++}let y=s.kind===`npc`&&s.npcId!=null?this.npcDims?.(s.npcId):null,b=y?y.h:s.appearance?220:130,x=v.clone().project(r),S=x,C=(x.x*.5+.5)*i,w=(-x.y*.5+.5)*a,T=s.kind===`player`?(s.skulled?`☠ `:``)+(s.name??`player`)+(s.combatLvl?` (${s.combatLvl})`:``):s.kind===`bot`?(s.skulled?`☠ `:``)+s.name:s.npcId==null?null:`${s.name??`npc`} #${s.npcId},${s.key.slice(4)}`+(s.ghost&&s.respawnTicks!=null?(s.respawnTicksMin!=null&&s.respawnTicksMin!==s.respawnTicks?` · ${s.respawnTicksMin}–${s.respawnTicks}t`:` · ${s.respawnTicks}t`)+(s.respawnAssumed?`?`:``):``),E=s.kind===`bot`?Jl:s.kind===`player`?Yl:Xl;if(T&&this.showPlates&&o<=E){m.add(s.key);let t=this.plates.get(s.key);t||(t=document.createElement(`div`),s.kind===`bot`?t.style.cssText=`position:absolute;transform:translate(-50%,-100%);pointer-events:auto;cursor:pointer;white-space:nowrap;border-radius:4px;font:11px monospace;color:#e8f2ff;background:rgba(10,14,24,.72);padding:1px 5px;z-index:900000;`:s.kind===`player`?t.style.cssText=`position:absolute;transform:translate(-50%,-100%);pointer-events:auto;cursor:pointer;white-space:nowrap;border-radius:4px;font:10px monospace;color:rgba(255,216,240,.85);background:rgba(10,14,24,.45);padding:0 4px;z-index:890000;`:t.style.cssText=`position:absolute;transform:translate(-50%,-100%);pointer-events:auto;cursor:pointer;white-space:nowrap;border-radius:4px;font:10px monospace;color:rgba(255,196,172,.8);background:rgba(10,14,24,.4);padding:0 4px;z-index:880000;`,t.dataset.entityKey=s.key,this.plateHost.appendChild(t),this.plates.set(s.key,t));let n=this.actionBubbles.get(s.key);n&&e>n.until&&this.actionBubbles.delete(s.key);let r=s.sleeping?Zl:s.kind!==`npc`&&n&&e<=n.until?n.id:null,i=`${T}|${r??``}|${+!!this.itemFrame}|${s.shopId??``}`;if(t.dataset.content!==i){t.dataset.content=i,t.textContent=``;let e=r==null?null:this.itemFrame?.(r);if(e){let n=Math.min(14/e.w,14/e.h),r=document.createElement(`span`);r.style.cssText=`display:inline-block;vertical-align:-2px;margin-right:3px;width:${e.w*n}px;height:${e.h*n}px;background-image:url(${Tl(`/api/world3d/item-atlas.png`)});background-position:${-e.x*n}px ${-e.y*n}px;background-size:${e.atlasW*n}px ${e.atlasH*n}px;image-rendering:pixelated;`,t.appendChild(r)}if(t.appendChild(document.createTextNode(T)),s.shopId){let e=document.createElement(`span`);e.dataset.shopId=s.shopId,e.title=`open shop`,e.style.cssText=`margin-left:4px;cursor:pointer;color:#ffd27a;`,e.textContent=`⚖`,t.appendChild(e)}}if(t.title=s.ghost&&s.respawnTicks!=null?`pop in ${s.respawnTicksMin!=null&&s.respawnTicksMin!==s.respawnTicks?`${s.respawnTicksMin}–${s.respawnTicks}`:`${s.respawnTicks}`} ticks`+(s.respawnAssumed?` · assumed (nobody saw the death)`:` · witnessed`)+(s.respawnCheckedAgo==null?``:` · last looked at ${s.respawnCheckedAgo}t ago`):``,S.z>1||S.x<-1.05||S.x>1.05||S.y<-1.05||S.y>1.05)t.style.display=`none`;else{let e=s.dir===8?-51.2:s.dir===9?51.2:0;t.style.display=``,h.push({div:t,x:C+e*c,top:w-b*c-12,kind:s.kind,key:s.key,group:`${Math.round(s.curX)},${Math.round(s.curZ)}:${s.dir===8?`a`:s.dir===9?`b`:`-`}`}),t.style.outline=s.key===this.hoverKey?`1px solid #ffe45c`:s.selected||s.key===this.selectedEntityKey?`1px solid #fff`:``,t.style.zIndex=String(s.key===this.hoverKey?99e4:s.kind===`bot`?9e5:s.kind===`player`?89e4:88e4),s.kind===`npc`&&(t.style.color=s.ghost?`rgba(196,200,208,.5)`:`rgba(255,196,172,.8)`,t.style.background=s.ghost?`rgba(10,14,24,.25)`:`rgba(10,14,24,.4)`)}}let D=s.maxHp!=null&&s.maxHp>0&&s.hp!=null&&(s.hp<s.maxHp||s.inCombat),O=this.bars.get(s.key);if(D){if(!O){O=document.createElement(`div`),O.style.cssText=`position:absolute;transform:translate(-50%,-100%);width:30px;height:5px;background:rgba(255,0,0,.75);pointer-events:none;overflow:hidden;z-index:800000;`;let e=document.createElement(`div`);e.style.cssText=`height:100%;background:rgba(0,255,0,.75);width:100%;`,O.appendChild(e),this.plateHost.appendChild(O),this.bars.set(s.key,O)}if(S.z>1||S.x<-1.05||S.x>1.05||S.y<-1.05||S.y>1.05)O.style.display=`none`;else{let e=s.dir===8?-51.2:s.dir===9?51.2:0;O.style.display=``,O.style.left=`${C+e*c}px`,O.style.top=`${w-b*c+2}px`,O.firstChild.style.width=`${Math.max(0,Math.min(100,s.hp/s.maxHp*100))}%`}}else O&&(O.remove(),this.bars.delete(s.key));let k=this.splats.get(s.key);k&&e>k.until&&this.splats.delete(s.key);let A=this.splatDivs.get(s.key);if(k&&e<=k.until)if(A||(A=document.createElement(`div`),A.style.cssText=`position:absolute;transform:translate(-50%,-50%);width:24px;height:24px;background-size:24px 24px;image-rendering:pixelated;font:bold 12px sans-serif;color:#fff;text-align:center;line-height:25px;pointer-events:none;`,A.style.backgroundImage=s.kind===`npc`?`url(${Tl(`/api/world3d/splat-blue.png`)})`:`url(${Tl(`/api/world3d/splat-red.png`)})`,this.plateHost.appendChild(A),this.splatDivs.set(s.key,A)),S.z>1||S.x<-1.05||S.x>1.05||S.y<-1.05||S.y>1.05)A.style.display=`none`;else{let e=s.dir===8?-25.6:s.dir===9?25.6:0;A.style.zIndex=String(75e4+k.seq),A.style.display=``,A.style.left=`${C+e*c}px`,A.style.top=`${w-b/2*c}px`,A.textContent=String(k.dmg)}else A&&(A.remove(),this.splatDivs.delete(s.key));let j=this.bubbles.get(s.key);j&&e>j.until&&this.bubbles.delete(s.key);let M=this.bubbleDivs.get(s.key);if(j&&e<=j.until&&this.chatFont){let e=window.devicePixelRatio||1,t=Math.max(1,Math.ceil(e));if(!j.canvas||j.scale!==t){let e=this.chatFont.renderOverhead(j.msg,300,`#ff0`,t);j.canvas=e.canvas,j.baseline=e.baseline,j.midX=e.midX,j.scale=t,j.totalWidth=e.totalWidth,j.extraLinesHeight=e.extraLinesHeight}M||(M=document.createElement(`div`),M.style.cssText=`position:absolute;pointer-events:none;z-index:700000;line-height:0;`,this.plateHost.appendChild(M),this.bubbleDivs.set(s.key,M)),M.firstChild!==j.canvas&&M.replaceChildren(j.canvas),S.z>1||S.x<-1.05||S.x>1.05||S.y<-1.05||S.y>1.05?M.style.display=`none`:(M.style.display=``,g.push({div:M,x:C,y:w-b*c,halfWidth:Math.min(150,j.totalWidth/2),height:j.extraLinesHeight,baseline:j.baseline,midX:j.midX}))}else M&&(M.remove(),this.bubbleDivs.delete(s.key))}{let e={bot:0,player:1,npc:2},t=new Map;for(let e of h){let n=t.get(e.group);n||t.set(e.group,n=[]),n.push(e)}for(let[,n]of t){n.sort((t,n)=>e[t.kind]-e[n.kind]||(t.key<n.key?-1:1));let t=Math.min(...n.map(e=>e.top));for(let e=0;e<n.length;e++)n[e].div.style.left=`${n[e].x}px`,n[e].div.style.top=`${t-e*15}px`}}{let e=this.chatFont?.lineHeight??14,t=window.devicePixelRatio||1,n=e=>Math.round(e*t)/t;for(let t=0;t<g.length;t++){let r=g[t],i=!0;for(;i;){i=!1;for(let n=0;n<t;n++){let t=g[n];t.y-e<r.y+r.height&&r.y-e<t.y+t.height&&t.x+t.halfWidth>r.x-r.halfWidth&&r.x+r.halfWidth>t.x-t.halfWidth&&t.y-r.height-e<r.y&&(r.y=t.y-(e+r.height),i=!0)}}r.div.style.left=`${n(r.x-r.midX)}px`,r.div.style.top=`${n(r.y-r.baseline)}px`}}for(let[e,t]of this.plates)m.has(e)||(t.remove(),this.plates.delete(e));this.rings.count=p,this.ghosts.count=p,this.rings.instanceMatrix.needsUpdate=!0,this.ghosts.instanceMatrix.needsUpdate=!0,this.rings.instanceColor&&(this.rings.instanceColor.needsUpdate=!0),this.ghosts.instanceColor&&(this.ghosts.instanceColor.needsUpdate=!0)}nearestBot(e,t,n){let r=this.nearestEntity(e,t,n,`bot`);return r?r.key.slice(4):null}nearestEntity(e,t,n,r){let i=null,a=n;for(let n of this.tracked.values()){if(r&&n.kind!==r)continue;let o=Math.hypot(n.curX-e,n.curZ-t),s=n.kind===`bot`?o-.25:o;s<a&&(a=s,i=n)}return i?{key:i.key,kind:i.kind,name:i.name,npcId:i.npcId,appearance:i.appearance,x:i.curX,z:i.curZ,inCombat:i.inCombat}:null}current(){let e=[];for(let t of this.tracked.values())e.push({key:t.key,kind:t.kind,name:t.name,npcId:t.npcId,appearance:t.appearance,dir:t.dir,x:t.curX,z:t.curZ,inCombat:t.inCombat});return e}snapshot(e,t){let n=[];for(let r of this.tracked.values())r.kind===e&&n.push({key:r.key,npcId:r.npcId,appearance:r.appearance,dir:r.dir,ghost:r.ghost,x:r.curX,z:r.curZ,moving:t-r.t0<ql&&(r.fromX!==r.toX||r.fromZ!==r.toZ),dx:r.toX-r.fromX,dz:r.toZ-r.fromZ});return n}dispose(e){for(let t of[this.rings,this.ghosts])e.remove(t),t.geometry.dispose(),t.material.dispose();for(let e of[this.plates,this.bars,this.splatDivs,this.bubbleDivs]){for(let[,t]of e)t.remove();e.clear()}this.splats.clear(),this.splatSeen.clear(),this.bubbles.clear(),this.bubbleSeen.clear(),this.tracked.clear()}},$l=class e{objects=new Map;anims=new Map;models=new Map;static async fetch(t){try{let n=await fetch(Tl(`/api/world3d/objlib.json`));if(!n.ok)return null;let r=await n.json(),i=await fetch(Tl(`/api/world3d/objlib.bin?v=${t}`));if(!i.ok)return null;let a=await i.arrayBuffer(),o=new e;for(let e of r.objects)o.objects.set(e.id,e);for(let e of r.anims??[])o.anims.set(e.id,e.frames);for(let e of r.models)o.models.set(e.model,eu(new DataView(a,e.off,e.len)));return o}catch{return null}}groupsFor(e){let t=this.objects.get(e);return t?this.models.get(t.model)??null:null}groupsForModel(e){return this.models.get(e)??null}};function eu(e){let t=[],n=e.getUint16(0),r=2;for(let i=0;i<n;i++){let n=e.getInt16(r),i=e.getInt32(r+2);r+=6;let a=new Int16Array(i*3);for(let t=0;t<i*3;t++)a[t]=e.getInt16(r),r+=2;let o=new Uint8Array(e.buffer,e.byteOffset+r,i*3).slice();r+=i*3;let s=null;if(n>=0){s=new Int16Array(i*2);for(let t=0;t<i*2;t++)s[t]=e.getInt16(r),r+=2}let c=[];for(let t=0;t<8;t++)c.push(new Uint8Array(e.buffer,e.byteOffset+r,i).slice()),r+=i;t.push({tex:n,n:i,pos:a,base:o,uv:s,shades:c})}return t}function tu(e,t,n,r,i){let a=new Map;for(let o of t){let t=e.objects.get(o.id),s=o.model==null?e.groupsFor(o.id):e.groupsForModel(o.model);if(!t||!s)continue;let c=i?i(o):0,l=c&255,u=c>>8&255,d=c>>16&255,f=c>>24&255,p=o.dir===0||o.dir===4?t.w:t.h,m=o.dir===0||o.dir===4?t.h:t.w,h=(o.x*2+p)*64,g=(o.z*2+m)*64,_=r(h/128-.5,g/128-.5)+t.lift,v=o.dir*32*2*Math.PI/256,y=Math.cos(v),b=Math.sin(v);for(let e of s){let t=a.get(e.tex);t||a.set(e.tex,t={pos:[],shade:[],base:[],uv:[],pid:[]});let r=e.shades[o.dir&7];for(let i=0;i<e.n;i++){let a=e.pos[i*3],o=e.pos[i*3+1],s=e.pos[i*3+2],c=a*y+s*b,p=s*y-a*b,m=h+c,v=g+p;t.pos.push(n-m,-o+_,v),t.shade.push(r[i]),t.base.push(e.base[i*3],e.base[i*3+1],e.base[i*3+2]),e.uv&&t.uv.push(e.uv[i*2]/512,e.uv[i*2+1]/512),t.pid.push(l,u,d,f)}}}let o=[];for(let[e,t]of a){let n=new _r;n.setAttribute(`position`,new X(new Float32Array(t.pos),3)),n.setAttribute(`shade`,new X(new Float32Array(t.shade),1)),n.setAttribute(`base`,new X(new Uint8Array(t.base),3,!0)),e>=0&&n.setAttribute(`uv`,new X(new Float32Array(t.uv),2)),i&&n.setAttribute(`pickId`,new X(new Uint8Array(t.pid),4,!0)),o.push({tex:e,geometry:n})}return o}function nu(e,t,n,r){let i=e.objects.get(t.id);if(!i)return null;let a=t.dir===0||t.dir===4?i.w:i.h,o=t.dir===0||t.dir===4?i.h:i.w,s=(t.x*2+a)*64,c=(t.z*2+o)*64,l=r(s/128-.5,c/128-.5)+i.lift;return new J(n-s,l,c)}async function ru(){try{let[e,t]=await Promise.all([fetch(Tl(`/api/world3d/doorlib.json`)),fetch(Tl(`/api/world3d/boundaries.json`))]);if(!e.ok||!t.ok)return null;let n=(await e.json()).doors,r=(await t.json()).boundaries,i=new Map;for(let e of n)i.set(e.id,e);return{defs:i,boundaries:r}}catch{return null}}function iu(e,t,n){switch(n&3){case 0:return[e,t,e+1,t];case 1:return[e,t,e,t+1];case 2:return[e+1,t,e,t+1];default:return[e,t,e+1,t+1]}}var au=-50,ou=-10,su=-50,cu=213,lu=16;function uu(e,t,n,r,i){let a=new Map,o=(e,t,n,r,i,a)=>{let o=[[0,0],[1,0],[1,1],[0,1]],s=i?[[0,2,1],[0,3,2]]:[[0,1,2],[0,2,3]],c=a&255,l=a>>8&255,u=a>>16&255,d=a>>24&255;for(let i of s)for(let a of i){if(e.pos.push(t[a][0],t[a][1],t[a][2]),e.shade.push(n),r>=0)e.base.push(255,255,255),e.uv.push(o[a][0],o[a][1]);else{let t=-1-r;e.base.push((t>>10&31)*8,(t>>5&31)*8,(t&31)*8),e.uv.push(0,0)}e.pid.push(c,l,u,d)}};for(let s of t){let t=e.get(s.id);if(!t||t.height<=0)continue;let c=i?i(s):0,[l,u,d,f]=iu(s.x,s.z,s.dir),p=r(l,u),m=r(d,f),h={x:l*128,y:-p,z:u*128},g={x:d*128,y:-m,z:f*128},_=[[h.x,h.y,h.z],[h.x,h.y-t.height,h.z],[g.x,g.y-t.height,g.z],[g.x,g.y,g.z]],v=_[1][0]-_[0][0],y=_[1][1]-_[0][1],b=_[1][2]-_[0][2],x=_[2][0]-_[0][0],S=_[2][1]-_[0][1],C=_[2][2]-_[0][2],w=C*y-b*S,T=b*x-v*C,E=v*S-x*y,D=Math.sqrt(w*w+T*T+E*E)||1;w=w/D*256,T=T/D*256,E=E/D*256;let O=Math.round((w*au+T*ou+E*su)/cu),k=Math.max(0,Math.min(255,lu-O)),A=Math.max(0,Math.min(255,lu+O)),j=_.map(([e,t,r])=>[n-e,-t,r]);if(t.texF!==12345678){let e=a.get(t.texF);e||a.set(t.texF,e={pos:[],shade:[],base:[],uv:[],pid:[]}),o(e,j,k,t.texF,!1,c)}if(t.texB!==12345678){let e=a.get(t.texB);e||a.set(t.texB,e={pos:[],shade:[],base:[],uv:[],pid:[]}),o(e,j,A,t.texB,!0,c)}}let s=[];for(let[e,t]of a){let n=new _r;n.setAttribute(`position`,new X(new Float32Array(t.pos),3)),n.setAttribute(`shade`,new X(new Float32Array(t.shade),1)),n.setAttribute(`base`,new X(new Uint8Array(t.base),3,!0)),n.setAttribute(`uv`,new X(new Float32Array(t.uv),2)),i&&n.setAttribute(`pickId`,new X(new Uint8Array(t.pid),4,!0)),s.push({tex:e,geometry:n})}return s}async function du(){try{let e=await fetch(Tl(`/api/world3d/npc-atlas.json`));if(!e.ok)return null;let t=await e.json(),n=await new Promise((e,n)=>{new Aa().load(Tl(`/api/world3d/npc-atlas.png?v=${t.baked}`),e,void 0,n)});n.magFilter=m,n.minFilter=m,n.flipY=!1,n.colorSpace=Ve;let r=new Map;for(let e of t.npcs)r.set(e.id,e);let i=new Map;for(let e of t.frames){let t=i.get(e.id);t||i.set(e.id,t=Array.from({length:10},()=>[])),t[e.o][e.f]=e}return{tex:n,width:t.width,height:t.height,scale:t.scale,meta:r,frames:i}}catch{return null}}var fu=[0,1,2,1],pu=[0,1,2,1,0,0,0,0],mu=[0,0,0,0,0,1,2,1],hu=20,gu=new J,_u=new J,vu=new J,yu=new J,bu=class{solid;ghost;geo;phantomGeo;phantom;phantomXray;phantomCap=4096;atlas=null;lastDir=new Map;stepAcc=new Map;lastFrameNow=-1;cap=4096;highlightKey=null;glowGeo;glow;constructor(e){this.geo=new _r;let t=new Float32Array(this.cap*4*3),n=new Float32Array(this.cap*4*2),r=new Uint16Array(this.cap*6);for(let e=0;e<this.cap;e++)r[e*6]=e*4,r[e*6+1]=e*4+1,r[e*6+2]=e*4+2,r[e*6+3]=e*4,r[e*6+4]=e*4+2,r[e*6+5]=e*4+3;this.geo.setAttribute(`position`,new X(t,3)),this.geo.setAttribute(`uv`,new X(n,2)),this.geo.setIndex(new X(r,1)),this.geo.setDrawRange(0,0);let i=new URLSearchParams(location.search).has(`npcdebug`),a=new qr({transparent:!i,alphaTest:i?0:.06,side:2,...i?{color:16711935,wireframe:!1}:{}});i&&(window.__npcDbgMat=a),this.solid=new ai(this.geo,a),this.solid.renderOrder=12,this.solid.frustumCulled=!1;let o=new qr({transparent:!0,opacity:.3,alphaTest:.4,depthFunc:6,depthWrite:!0,side:2});this.ghost=new ai(this.geo,o),this.ghost.renderOrder=13,this.ghost.frustumCulled=!1,this.glowGeo=new _r,this.glowGeo.setAttribute(`position`,new X(new Float32Array(12),3)),this.glowGeo.setAttribute(`uv`,new X(new Float32Array(8),2)),this.glowGeo.setIndex(new X(new Uint16Array([0,1,2,0,2,3]),1)),this.glowGeo.setDrawRange(0,0);let s=new qr({transparent:!0,alphaTest:.06,color:16770140,blending:2,depthWrite:!1,side:2});this.glow=new ai(this.glowGeo,s),this.glow.renderOrder=11,this.glow.frustumCulled=!1,e.add(this.glow),this.phantomGeo=new _r,this.phantomGeo.setAttribute(`position`,new X(new Float32Array(this.phantomCap*4*3),3)),this.phantomGeo.setAttribute(`uv`,new X(new Float32Array(this.phantomCap*4*2),2));let c=new Uint16Array(this.phantomCap*6);for(let e=0;e<this.phantomCap;e++)c.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);this.phantomGeo.setIndex(new X(c,1)),this.phantomGeo.setDrawRange(0,0),this.phantom=new ai(this.phantomGeo,new qr({transparent:!0,opacity:.35,alphaTest:.05,depthWrite:!1,side:2})),this.phantom.renderOrder=12,this.phantom.frustumCulled=!1,e.add(this.phantom),this.phantomXray=new ai(this.phantomGeo,new qr({transparent:!0,opacity:.12,alphaTest:.05,depthFunc:6,depthWrite:!1,side:2})),this.phantomXray.renderOrder=13,this.phantomXray.frustumCulled=!1,e.add(this.phantomXray),e.add(this.solid),e.add(this.ghost);for(let e of[this.solid,this.ghost,this.glow,this.phantom,this.phantomXray])e.userData.noPick=!0}dims(e){let t=this.atlas?.meta.get(e);return t?{w:t.w,h:t.h}:null}info(e){return this.atlas?.meta.get(e)??null}setAtlas(e){if(this.atlas=e,this.glow.material.map=e.tex,this.glow.material.needsUpdate=!0,this.phantom.material.map=e.tex,this.phantom.material.needsUpdate=!0,this.phantomXray.material.map=e.tex,this.phantomXray.material.needsUpdate=!0,new URLSearchParams(location.search).has(`npcdebug`)){this.ghost.material.map=e.tex,this.ghost.material.needsUpdate=!0;return}this.solid.material.map=e.tex,this.solid.material.needsUpdate=!0,this.ghost.material.map=e.tex,this.ghost.material.needsUpdate=!0}frame(e,t,n,r,i,a,o,s){let c=this.atlas;if(!c){this.geo.setDrawRange(0,0),window.__npcSprites={atlas:!1,drawn:0,fed:t.length};return}let l=Math.round(a/(2*Math.PI)*256)&255,u=this.lastFrameNow<0?0:(e-this.lastFrameNow)/hu;this.lastFrameNow=e;let d=this.geo.getAttribute(`position`),f=this.geo.getAttribute(`uv`),p=this.phantomGeo.getAttribute(`position`),m=this.phantomGeo.getAttribute(`uv`),h=this.glowGeo.getAttribute(`position`),g=this.glowGeo.getAttribute(`uv`),_=!1,v=0,y=0;for(let a of t){if(a.ghost?y>=this.phantomCap:v>=this.cap)continue;let t=c.meta.get(a.npcId),b=c.frames.get(a.npcId);if(!t||!b)continue;let x=this.lastDir.get(a.key)??0;if(a.moving&&(a.dx!==0||a.dz!==0)){let e=Math.atan2(a.dx,-a.dz);x=Math.round((e+2*Math.PI)%(2*Math.PI)/(Math.PI/4))&7,this.lastDir.set(a.key,x)}else a.dir!=null&&a.dir>=0&&a.dir<=7&&(x=a.dir,this.lastDir.set(a.key,x));if(a.moving&&u>0){let e=(a.dx===0?0:1)+(a.dz===0?0:1);this.stepAcc.set(a.key,(this.stepAcc.get(a.key)??0)+e*u)}let S=Math.floor(this.stepAcc.get(a.key)??0),C=4-x+(l+16>>5)&7,w=fu[Math.floor(S/Math.max(1,t.ws??6))%4];if(a.dir===8||a.dir===9){let n=a.dir===8?9:8;if(b[n]?.length){C=n;let r=t.cs??6;w=a.dir===8?pu[Math.floor(e/(Math.max(2,r-1)*hu))%8]:mu[Math.floor(e/(r*hu))%8]}}let T=b[C];if(!T||T.length===0)continue;let E=T[Math.min(w,T.length-1)]??T[0];if(!E)continue;let D=n(a.x,a.z).addScaledVector(o,s),O=c.scale,k=-E.ax/O,A=(E.w-E.ax)/O,j=E.ay/O,M=-(E.h-E.ay)/O,N=gu.copy(D).addScaledVector(r,k).addScaledVector(i,M),ee=_u.copy(D).addScaledVector(r,A).addScaledVector(i,M),P=vu.copy(D).addScaledVector(r,A).addScaledVector(i,j),F=yu.copy(D).addScaledVector(r,k).addScaledVector(i,j),I=a.ghost?p:d,te=a.ghost?m:f,ne=a.ghost?y:v;I.setXYZ(ne*4,N.x,N.y,N.z),I.setXYZ(ne*4+1,ee.x,ee.y,ee.z),I.setXYZ(ne*4+2,P.x,P.y,P.z),I.setXYZ(ne*4+3,F.x,F.y,F.z);let re=E.x/c.width,ie=(E.x+E.w)/c.width,ae=E.y/c.height,L=(E.y+E.h)/c.height;if(te.setXY(ne*4,re,L),te.setXY(ne*4+1,ie,L),te.setXY(ne*4+2,ie,ae),te.setXY(ne*4+3,re,ae),a.key===this.highlightKey){let e=(N.x+P.x)/2,t=(N.y+P.y)/2,n=(N.z+P.z)/2,r=1.12,i=[N,ee,P,F];for(let a=0;a<4;a++)h.setXYZ(a,e+(i[a].x-e)*r,t+(i[a].y-t)*r,n+(i[a].z-n)*r);g.setXY(0,re,L),g.setXY(1,ie,L),g.setXY(2,ie,ae),g.setXY(3,re,ae),h.needsUpdate=!0,g.needsUpdate=!0,_=!0}a.ghost?y++:v++}d.needsUpdate=!0,f.needsUpdate=!0,p.needsUpdate=!0,m.needsUpdate=!0,this.geo.setDrawRange(0,v*6),this.phantomGeo.setDrawRange(0,y*6),this.glowGeo.setDrawRange(0,_?6:0),window.__npcSprites={atlas:!0,drawn:v,ghosts:y,fed:t.length}}dispose(e){e.remove(this.solid),e.remove(this.ghost),e.remove(this.glow),e.remove(this.phantom),e.remove(this.phantomXray),this.geo.dispose(),this.glowGeo.dispose(),this.phantomGeo.dispose(),this.solid.material.dispose(),this.ghost.material.dispose(),this.glow.material.dispose(),this.phantom.material.dispose(),this.phantomXray.material.dispose(),this.atlas?.tex.dispose()}},xu=512,Su=255,Cu=254,wu=253,Tu=252,Eu=251,Du=null,Ou=new Map,ku=256;function Au(){return Du||(Du=(async()=>{let e=await fetch(Tl(`/api/world3d/player-layers/index.json`)).then(e=>{if(!e.ok)throw Error(`atlas index ${e.status}`);return e.json()}),t=await fetch(Tl(`/api/world3d/player-layers/atlas.png`)).then(e=>e.blob()),n=await createImageBitmap(t,{premultiplyAlpha:`none`}),r=document.createElement(`canvas`);r.width=n.width,r.height=n.height;let i=r.getContext(`2d`,{willReadFrequently:!0});return i.clearRect(0,0,r.width,r.height),i.drawImage(n,0,0),{idx:e,data:i.getImageData(0,0,r.width,r.height).data,aw:r.width}})(),Du)}function ju(e,t){return e[Math.max(0,Math.min(e.length-1,t|0))]}function Mu(e,t){let n=(e>>16&255)*t/255|0,r=(e>>8&255)*t/255|0,i=(e&255)*t/255|0;return n<<16|r<<8|i}function Nu(e,t){let n=(e>>16&255)*255>>8,r=(e>>8&255)*t/255|0,i=(e&255)*t/255|0;return n<<16|r<<8|i}async function Pu(e){let t=Ou.get(e);if(t)return t;let{idx:n,data:r,aw:i}=await Au(),a=e.split(`|`),o=(a[0]??``).split(`,`),s=[];for(let e=0;e<12;e++)s[e]=e<o.length&&parseInt(o[e],10)||0;let c=(a[1]??``).split(`,`).map(e=>parseInt(e,10)||0),l=ju(n.palettes.hair,c[0]??0),u=ju(n.palettes.clothing,c[1]??0),d=ju(n.palettes.clothing,c[2]??0),f=ju(n.palettes.skin,c[3]??0),p=new Uint32Array(xu*xu),m=[];for(let e=0;e<10;e++){let t=e<=7?e:2,a=n.layerOrder[t];for(let t=0;t<3;t++){p.fill(0);let o=!1;for(let c of a){let a=s[c]-1;if(a<0)continue;let m=c===4?`4`:c===3?`3`:`0`,h=n.crops[a];if(!h)continue;let g=e+`,`+t,_=h[m]?.[g]??h[0]?.[g];if(!_)continue;let[v,y,b]=_,[x,S,C,w]=n.atlas[v];for(let e=0;e<w;e++){let t=(b+e)*xu,n=(S+e)*i;for(let e=0;e<C;e++){let i=(n+x+e)*4,a=r[i+3];if(a===0)continue;let s=r[i],c=r[i+1],m=r[i+2],h;h=a===Su?s<<16|c<<8|m:a===Cu?Mu(l,s):a===wu?Mu(u,s):a===Tu?Mu(d,s):a===Eu?Nu(f,s):s<<16|c<<8|m,p[t+y+e]=4278190080|h,o=!0}}}if(!o)continue;let c=xu,h=xu,g=-1,_=-1;for(let e=0;e<xu;e++){let t=e*xu;for(let n=0;n<xu;n++)p[t+n]!==0&&(n<c&&(c=n),n>g&&(g=n),e<h&&(h=e),e>_&&(_=e))}if(g<0)continue;let v=g-c+1,y=_-h+1,b=new Uint32Array(v*y);for(let e=0;e<y;e++)for(let t=0;t<v;t++)b[e*v+t]=p[(h+e)*xu+(c+t)];m.push({o:e,f:t,px:b,w:v,h:y,ax:n.originX+(n.width1>>1)-c,ay:n.originY+n.height-h})}}let h=1,g=1;for(let e of m)h=Math.max(h,e.w),g=Math.max(g,e.h);let _=h*10,v=g*3,y=new Uint8ClampedArray(_*v*4),b=[];for(let e of m){let t=e.o*h,n=e.f*g;for(let r=0;r<e.h;r++)for(let i=0;i<e.w;i++){let a=e.px[r*e.w+i];if(a===0)continue;let o=((n+r)*_+(t+i))*4;y[o]=a>>16&255,y[o+1]=a>>8&255,y[o+2]=a&255,y[o+3]=255}b.push({o:e.o,f:e.f,x:t,y:n,w:e.w,h:e.h,ax:e.ax,ay:e.ay})}let x=document.createElement(`canvas`);x.width=_,x.height=v,x.getContext(`2d`).putImageData(new ImageData(y,_,v),0,0);let S={canvas:x,index:{scale:n.scale,width:_,height:v,frames:b}};for(Ou.set(e,S);Ou.size>ku;){let e=Ou.keys().next();if(e.done)break;Ou.delete(e.value)}return S}var Fu=[0,1,2,1],Iu=[0,1,2,1,0,0,0,0],Lu=[0,0,0,0,0,1,2,1],Ru=20,zu=new J,Bu=new J,Vu=new J,Hu=new J,Uu=160,Wu=2048,Gu=6e4,Ku=2,qu=class{scene;strips=new Map;lastDir=new Map;highlightKey=null;glowGeo;glow;stepAcc=new Map;lastFrameNow=-1;constructor(e){this.scene=e,this.glowGeo=new _r,this.glowGeo.setAttribute(`position`,new X(new Float32Array(12),3)),this.glowGeo.setAttribute(`uv`,new X(new Float32Array(8),2)),this.glowGeo.setIndex(new X(new Uint16Array([0,1,2,0,2,3]),1)),this.glowGeo.setDrawRange(0,0),this.glow=new ai(this.glowGeo,new qr({transparent:!0,alphaTest:.06,color:16770140,blending:2,depthWrite:!1,side:2,forceSinglePass:!0})),this.glow.renderOrder=11,this.glow.frustumCulled=!1,this.glow.userData.noPick=!0,this.glow.visible=!1,e.add(this.glow)}growStrip(e,t){e.cap=t,e.geo.setAttribute(`position`,new X(new Float32Array(t*4*3),3)),e.geo.setAttribute(`uv`,new X(new Float32Array(t*4*2),2));let n=new Uint16Array(t*6);for(let e=0;e<t;e++)n.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);e.geo.setIndex(new X(n,1)),e.geo.setDrawRange(0,0)}makeStrip(e){let t=new _r,n=new ai(t,new qr({transparent:!0,alphaTest:.06,side:2,forceSinglePass:!0}));n.renderOrder=12,n.frustumCulled=!1,n.userData.noPick=!0;let r=new ai(t,new qr({transparent:!0,opacity:.3,alphaTest:.04,depthFunc:6,depthWrite:!0,side:2,forceSinglePass:!0}));r.renderOrder=13,r.frustumCulled=!1,r.userData.noPick=!0,n.visible=!1,r.visible=!1,this.scene.add(n),this.scene.add(r);let i={tex:null,scale:.3,width:1,height:1,frames:Array.from({length:10},()=>[]),geo:t,solid:n,ghost:r,failedAt:0,cap:0,lastUsed:0};return this.growStrip(i,Uu),this.load(e,i),i}setStripQuads(e,t){e.geo.setDrawRange(0,t*6),e.solid.visible=t>0,e.ghost.visible=t>0}disposeStrip(e){this.scene.remove(e.solid),this.scene.remove(e.ghost),e.geo.dispose(),e.solid.material.dispose(),e.ghost.material.dispose(),e.tex?.dispose()}load(e,t){Pu(e).then(({canvas:e,index:n})=>{t.scale=n.scale,t.width=n.width,t.height=n.height;for(let e of n.frames)t.frames[e.o][e.f]=e;let r=new Bi(e);r.magFilter=m,r.minFilter=m,r.flipY=!1,r.colorSpace=Ve,t.tex=r,t.solid.material.map=r,t.solid.material.needsUpdate=!0,t.ghost.material.map=r,t.ghost.material.needsUpdate=!0}).catch(()=>{t.failedAt=performance.now()})}frame(e,t,n,r,i,a,o,s){let c=Math.round(a/(2*Math.PI)*256)&255,l=this.lastFrameNow<0?0:(e-this.lastFrameNow)/Ru;this.lastFrameNow=e;let u=!1,d={},f=new Map;for(let e of t){if(!e.appearance)continue;let t=f.get(e.appearance);t||f.set(e.appearance,t=[]),t.push(e)}for(let[t,n]of this.strips)f.has(t)||(this.setStripQuads(n,0),e-n.lastUsed>Gu&&(this.disposeStrip(n),this.strips.delete(t)));let p=0;for(let[t,a]of f){let f=this.strips.get(t);if(!f){if(p>=Ku)continue;p++,f=this.makeStrip(t),this.strips.set(t,f)}if(f.lastUsed=e,!f.tex){f.failedAt&&e-f.failedAt>8e3&&(f.failedAt=0,this.load(t,f)),this.setStripQuads(f,0);continue}if(a.length>f.cap&&f.cap<Wu){let e=f.cap;for(;e<a.length&&e<Wu;)e*=2;this.growStrip(f,Math.min(e,Wu))}let m=f.geo.getAttribute(`position`),h=f.geo.getAttribute(`uv`),g=0;for(let t of a){if(g>=f.cap)break;let a=this.lastDir.get(t.key)??0;if(t.moving&&(t.dx!==0||t.dz!==0)){let e=Math.atan2(t.dx,-t.dz);a=Math.round((e+2*Math.PI)%(2*Math.PI)/(Math.PI/4))&7,this.lastDir.set(t.key,a)}else t.dir!=null&&t.dir>=0&&t.dir<=7&&(a=t.dir,this.lastDir.set(t.key,a));if(t.moving&&l>0){let e=(t.dx===0?0:1)+(t.dz===0?0:1);this.stepAcc.set(t.key,(this.stepAcc.get(t.key)??0)+e*l)}let p=Math.floor(this.stepAcc.get(t.key)??0),_=4-a+(c+16>>5)&7,v=Fu[Math.floor(p/6)%4];if(t.dir===8||t.dir===9){let n=t.dir===8?9:8;f.frames[n]?.length&&(_=n,v=t.dir===8?Iu[Math.floor(e/100)%8]:Lu[Math.floor(e/120)%8])}d[t.key]={order:_,frame:v,tex:!!f.tex};let y=f.frames[_];if(!y||y.length===0)continue;let b=y[Math.min(v,y.length-1)]??y[0];if(!b)continue;let x=n(t.x,t.z).addScaledVector(o,s),S=f.scale,C=-b.ax/S,w=(b.w-b.ax)/S,T=b.ay/S,E=-(b.h-b.ay)/S,D=zu.copy(x).addScaledVector(r,C).addScaledVector(i,E),O=Bu.copy(x).addScaledVector(r,w).addScaledVector(i,E),k=Vu.copy(x).addScaledVector(r,w).addScaledVector(i,T),A=Hu.copy(x).addScaledVector(r,C).addScaledVector(i,T);m.setXYZ(g*4,D.x,D.y,D.z),m.setXYZ(g*4+1,O.x,O.y,O.z),m.setXYZ(g*4+2,k.x,k.y,k.z),m.setXYZ(g*4+3,A.x,A.y,A.z);let j=b.x/f.width,M=(b.x+b.w)/f.width,N=b.y/f.height,ee=(b.y+b.h)/f.height;if(h.setXY(g*4,j,ee),h.setXY(g*4+1,M,ee),h.setXY(g*4+2,M,N),h.setXY(g*4+3,j,N),t.key===this.highlightKey){let e=this.glowGeo.getAttribute(`position`),t=this.glowGeo.getAttribute(`uv`),n=(D.x+k.x)/2,r=(D.y+k.y)/2,i=(D.z+k.z)/2,a=[D,O,k,A],o=1.12;for(let t=0;t<4;t++)e.setXYZ(t,n+(a[t].x-n)*o,r+(a[t].y-r)*o,i+(a[t].z-i)*o);t.setXY(0,j,ee),t.setXY(1,M,ee),t.setXY(2,M,N),t.setXY(3,j,N),e.needsUpdate=!0,t.needsUpdate=!0;let s=this.glow.material;s.map!==f.tex&&(s.map=f.tex,s.needsUpdate=!0),u=!0}g++}m.needsUpdate=!0,h.needsUpdate=!0,this.setStripQuads(f,g)}this.glowGeo.setDrawRange(0,u?6:0),this.glow.visible=u,window.__playerSprites=d}dispose(){for(let[,e]of this.strips)this.disposeStrip(e);this.strips.clear(),this.scene.remove(this.glow),this.glowGeo.dispose(),this.glow.material.dispose()}};async function Ju(){try{let e=await fetch(Tl(`/api/world3d/item-atlas.json`));if(!e.ok)return null;let t=await e.json(),n=await new Promise((e,n)=>{new Aa().load(Tl(`/api/world3d/item-atlas.png?v=${t.baked}`),e,void 0,n)});n.magFilter=m,n.minFilter=m,n.flipY=!1,n.colorSpace=Ve;let r=new Map;for(let e of t.frames)r.set(e.id,e);return{tex:n,width:t.width,height:t.height,frames:r}}catch{return null}}var Yu=4096,Xu=class{geo;solid;ghost;atlas=null;constructor(e){this.geo=new _r,this.geo.setAttribute(`position`,new X(new Float32Array(Yu*4*3),3)),this.geo.setAttribute(`uv`,new X(new Float32Array(Yu*4*2),2));let t=new Uint16Array(Yu*6);for(let e=0;e<Yu;e++)t.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);this.geo.setIndex(new X(t,1)),this.geo.setDrawRange(0,0),this.solid=new ai(this.geo,new qr({transparent:!0,alphaTest:.06,side:2})),this.solid.renderOrder=9,this.solid.frustumCulled=!1,this.solid.userData.noPick=!0,e.add(this.solid),this.ghost=new ai(this.geo,new qr({transparent:!0,opacity:.35,alphaTest:.06,depthFunc:6,depthWrite:!0,side:2})),this.ghost.renderOrder=10,this.ghost.frustumCulled=!1,this.ghost.userData.noPick=!0,e.add(this.ghost)}setAtlas(e){this.atlas=e;for(let t of[this.solid.material,this.ghost.material])t.map=e.tex,t.needsUpdate=!0}frame(e,t,n,r,i,a){let o=this.atlas;if(!o){this.geo.setDrawRange(0,0);return}let s=this.geo.getAttribute(`position`),c=this.geo.getAttribute(`uv`),l=0;for(let u of e){if(l>=Yu)break;let e=o.frames.get(u.id);if(!e)continue;let d=t(u.x,u.z).addScaledVector(i,a*.4),f=-e.ax,p=e.w-e.ax,m=e.ay,h=-(e.h-e.ay),g=d.clone().addScaledVector(n,f).addScaledVector(r,h),_=d.clone().addScaledVector(n,p).addScaledVector(r,h),v=d.clone().addScaledVector(n,p).addScaledVector(r,m),y=d.clone().addScaledVector(n,f).addScaledVector(r,m);s.setXYZ(l*4,g.x,g.y,g.z),s.setXYZ(l*4+1,_.x,_.y,_.z),s.setXYZ(l*4+2,v.x,v.y,v.z),s.setXYZ(l*4+3,y.x,y.y,y.z);let b=e.x/o.width,x=(e.x+e.w)/o.width,S=e.y/o.height,C=(e.y+e.h)/o.height;c.setXY(l*4,b,C),c.setXY(l*4+1,x,C),c.setXY(l*4+2,x,S),c.setXY(l*4+3,b,S),l++}s.needsUpdate=!0,c.needsUpdate=!0,this.geo.setDrawRange(0,l*6)}dispose(e){e.remove(this.solid),e.remove(this.ghost),this.geo.dispose(),this.solid.material.dispose(),this.ghost.material.dispose(),this.atlas?.tex.dispose()}},Zu=class{lineHeight;ascent;descent;glyphs=new Map;fallback;atlas;tinted=new Map;constructor(e,t){this.atlas=e,this.lineHeight=t.lineHeight;let n=1,r=1;for(let e of t.chars)this.glyphs.set(e.c,e),n=Math.max(n,e.yo),r=Math.max(r,e.h-e.yo);this.ascent=n,this.descent=r,this.fallback=this.glyphs.get(61)}glyph(e){return this.glyphs.get(e)??this.fallback}tintedAtlas(e){let t=this.tinted.get(e);if(!t){t=document.createElement(`canvas`),t.width=this.atlas.width,t.height=this.atlas.height;let n=t.getContext(`2d`);n.drawImage(this.atlas,0,0),n.globalCompositeOperation=`source-in`,n.fillStyle=e,n.fillRect(0,0,t.width,t.height),this.tinted.set(e,t)}return t}width(e){let t=0;for(let n=0;n<e.length;n++)e[n]===`@`&&n+4<e.length&&e[n+4]===`@`||e[n]===`~`&&n+4<e.length&&e[n+4]===`~`?n+=4:t+=this.glyph(e.charCodeAt(n)).adv;return t}wrap(e,t){let n=[],r=0,i=0,a=0;for(let o=0;o<e.length;o++)if(e[o]===`@`&&o+4<e.length&&e[o+4]===`@`||e[o]===`~`&&o+4<e.length&&e[o+4]===`~`?o+=4:r+=this.glyph(e.charCodeAt(o)).adv,e[o]===` `&&(a=o),r>t){let t=a;a<=i&&(t=a=o),n.push(e.substring(i,t)),i=o=1+a,r=0}return r>0&&n.push(e.substring(i)),n}renderOverhead(e,t=300,n=`#ff0`,r=1){let i=this.wrap(e,t),a=i.map(e=>this.width(e)),o=Math.max(1,...a),s=o+1,c=(i.length-1)*this.lineHeight+this.ascent+this.descent+1,l=document.createElement(`canvas`);l.width=s*r,l.height=c*r,l.style.width=`${s}px`,l.style.height=`${c}px`;let u=l.getContext(`2d`);u.imageSmoothingEnabled=!1,u.setTransform(r,0,0,r,0,0);let d=n;for(let e=0;e<i.length;e++){let t=i[e],n=this.ascent+e*this.lineHeight,r=Math.floor((o-a[e])/2);for(let e=0;e<t.length;e++){if(t[e]===`@`&&e+4<t.length&&t[e+4]===`@`){d=Qu[t.substring(e+1,e+4).toLowerCase()]??d,e+=4;continue}if(t[e]===`~`&&e+4<t.length&&t[e+4]===`~`){e+=4;continue}let i=this.glyph(t.charCodeAt(e));if(i.w>0&&i.h>0){let e=r+i.xo,t=n-i.yo,a=this.tintedAtlas(`#000`);u.drawImage(a,i.x,i.y,i.w,i.h,e+1,t,i.w,i.h),u.drawImage(a,i.x,i.y,i.w,i.h,e,t+1,i.w,i.h),u.drawImage(this.tintedAtlas(d),i.x,i.y,i.w,i.h,e,t,i.w,i.h)}r+=i.adv}}let f=this.width(e);return{canvas:l,baseline:this.ascent,midX:s/2,width:s,height:c,totalWidth:f,extraLinesHeight:Math.floor(f/t)*this.lineHeight}}},Qu={red:`#ff0000`,lre:`#ff9040`,yel:`#ffff00`,gre:`#00ff00`,blu:`#0000ff`,cya:`#00ffff`,mag:`#ff00ff`,whi:`#ffffff`,bla:`#000000`,dre:`#c00000`,ora:`#ff9040`,or1:`#ffb000`,or2:`#ff7000`,or3:`#ff3000`,gr1:`#c0ff00`,gr2:`#80ff00`,gr3:`#40ff00`,bl1:`#4040ff`,bl2:`#0040ff`,bl3:`#4000ff`,dgr:`#00c000`,dbl:`#0000c0`,dcy:`#00c0c0`,dor:`#c06000`,dye:`#c0c000`,dma:`#c000c0`,gra:`#c0c0c0`,dgy:`#808080`,bgy:`#404040`,ran:`#ffff00`};function $u(){return fetch(Tl(`/api/world3d/font-h12b.json`)).then(e=>{if(!e.ok)throw Error(`font index ${e.status}`);return e.json()}).then(e=>new Promise((t,n)=>{let r=new Image;r.onload=()=>t(new Zu(r,e)),r.onerror=n,r.src=Tl(`/api/world3d/font-h12b.png`)}))}var ed=Math.sqrt(255),td=Math.PI/36,nd=4,rd=5/128,id=.4,ad=6,od=class{solid;ghost;geo;cap=0;constructor(e,t,n,r){this.geo=new _r,this.grow(4096),this.solid=new ai(this.geo,new qr({color:t,transparent:!0,opacity:n,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2,depthWrite:!1,side:2})),this.solid.renderOrder=9,this.ghost=new ai(this.geo,new qr({color:t,transparent:!0,opacity:r,depthFunc:6,depthWrite:!1,side:2})),this.ghost.renderOrder=9;for(let t of[this.solid,this.ghost])t.frustumCulled=!1,t.userData.noPick=!0,e.add(t)}set visible(e){this.solid.visible=e,this.ghost.visible=e}grow(e){this.cap=e,this.geo.setAttribute(`position`,new X(new Float32Array(e*4*3),3));let t=new Uint32Array(e*6);for(let n=0;n<e;n++)t.set([n*4,n*4+1,n*4+2,n*4,n*4+2,n*4+3],n*6);this.geo.setIndex(new X(t,1)),this.geo.setDrawRange(0,0)}extrude(e,t){let n=e.reduce((e,t)=>e+t.pts.length,0);n>this.cap&&this.grow(Math.ceil(n*1.5));let r=this.geo.getAttribute(`position`),i=r.array,a=0;for(let n of e){let e=n.pts,r=e.length;if(r<(n.closed?3:2))continue;let o=[],s=[];for(let i=0;i<r;i++){let a=n.closed||i>0,c=n.closed||i<r-1,l=e[(i-1+r)%r],u=e[(i+1)%r],d=a?cd(e[i].x-l.x,e[i].z-l.z):null,f=c?cd(u.x-e[i].x,u.z-e[i].z):null;d??=f,f??=d;let p={x:-d.z,z:d.x},m={x:-f.z,z:f.x},h=cd(p.x+m.x,p.z+m.z)??p,g=rd/Math.max(id,Math.abs(h.x*p.x+h.z*p.z)),_=t(e[i].x+h.x*g,e[i].z+h.z*g),v=t(e[i].x-h.x*g,e[i].z-h.z*g);_.y+=ad,v.y+=ad,o.push(_),s.push(v)}let c=n.closed?r:r-1;for(let e=0;e<c&&a<this.cap;e++){let t=e,n=(e+1)%r;i.set([o[t].x,o[t].y,o[t].z,s[t].x,s[t].y,s[t].z,s[n].x,s[n].y,s[n].z,o[n].x,o[n].y,o[n].z],a*12),a++}}r.needsUpdate=!0,this.geo.setDrawRange(0,a*6)}dispose(e){for(let t of[this.solid,this.ghost])e.remove(t),t.material.dispose();this.geo.dispose()}},sd=class{mob;grid;constructor(e){this.mob=new od(e,10475775,.42,.1),this.grid=new od(e,10475775,.18,.05)}set visible(e){this.mob.visible=e,this.grid.visible=e}update(e,t){this.mob.extrude(ld(e),t),this.grid.extrude(ud(e),t)}dispose(e){this.mob.dispose(e),this.grid.dispose(e)}};function cd(e,t){let n=Math.hypot(e,t);return n<1e-9?null:{x:e/n,z:t/n}}function ld(e){let t=[];for(let n=0;n<e.length;n++){let r=e[n],i=!1,a=[];for(let t=0;t<e.length&&!i;t++){if(t===n)continue;let o=e[t].x-r.x,s=e[t].z-r.z,c=Math.hypot(o,s);if(c<1e-6){i=t<n;continue}if(c>=2*ed)continue;let l=Math.atan2(s,o),u=Math.acos(c/(2*ed));a.push([l-u,l+u])}if(!i)for(let[e,n]of dd(a)){let i=Math.max(2,Math.ceil((n-e)/td)),a=[];for(let t=0;t<=i;t++){let o=e+(n-e)*t/i;a.push({x:r.x+ed*Math.cos(o),z:r.z+ed*Math.sin(o)})}t.push({pts:a,used:!1})}}let n=e=>`${e.x.toFixed(5)},${e.z.toFixed(5)}`,r=new Map;t.forEach((e,t)=>{let i=n(e.pts[0]),a=r.get(i);a||r.set(i,a=[]),a.push(t)});let i=[];for(let e=0;e<t.length;e++){if(t[e].used)continue;t[e].used=!0;let a=[...t[e].pts],o=!1;for(let e=0;e<=t.length;e++){let e=n(a[a.length-1]);if(e===n(a[0])){o=!0,a.pop();break}let i=(r.get(e)??[]).find(e=>!t[e].used);if(i==null)break;t[i].used=!0,a.push(...t[i].pts.slice(1))}i.push({pts:a,closed:o})}return i}function ud(e){let t=new Set;for(let n of e){let e=Math.floor(n.x)>>3,r=Math.floor(n.z)>>3;for(let n=-2;n<=2;n++)for(let i=-2;i<=2;i++)t.add(`${e+n},${r+i}`)}let n=[],r=new Map,i=(e,t,i,a)=>{let o={x0:e,z0:t,x1:i,z1:a,used:!1};n.push(o);let s=`${e},${t}`,c=r.get(s);c||r.set(s,c=[]),c.push(o)};for(let e of t){let[n,r]=e.split(`,`).map(Number);t.has(`${n},${r-1}`)||i(n,r,n+1,r),t.has(`${n+1},${r}`)||i(n+1,r,n+1,r+1),t.has(`${n},${r+1}`)||i(n+1,r+1,n,r+1),t.has(`${n-1},${r}`)||i(n,r+1,n,r)}let a=[];for(let e of n){if(e.used)continue;e.used=!0;let t=[{x:e.x0,z:e.z0},{x:e.x1,z:e.z1}],i=e.x1-e.x0,o=e.z1-e.z0;for(let e=0;e<=n.length;e++){let e=t[t.length-1];if(e.x===t[0].x&&e.z===t[0].z){t.pop();break}let n=(r.get(`${e.x},${e.z}`)??[]).filter(e=>!e.used);if(n.length===0)break;let a=[[-o,i],[i,o],[o,-i]],s=n[0];outer:for(let[e,t]of a)for(let r of n)if(r.x1-r.x0===e&&r.z1-r.z0===t){s=r;break outer}s.used=!0,t.push({x:s.x1,z:s.z1}),i=s.x1-s.x0,o=s.z1-s.z0}let s=[],c=t.length;for(let e=0;e<c;e++){let n=t[(e-1+c)%c],r=t[e],i=t[(e+1)%c];r.x-n.x===i.x-r.x&&r.z-n.z===i.z-r.z||s.push(r)}let l=[],u=s.length;for(let e=0;e<u;e++){let t=s[e],n=s[(e+1)%u],r=(Math.abs(n.x-t.x)+Math.abs(n.z-t.z))*8,i=Math.max(1,Math.ceil(r/nd));for(let e=0;e<i;e++)l.push({x:8*(t.x+(n.x-t.x)*e/i)-.5,z:8*(t.z+(n.z-t.z)*e/i)-.5})}a.push({pts:l,closed:!0})}return a}function dd(e){if(e.length===0)return[[0,2*Math.PI]];let t=2*Math.PI,n=[];for(let[r,i]of e)r=(r%t+t)%t,i=(i%t+t)%t,i>=r?n.push([r,i]):(n.push([r,t]),n.push([0,i]));n.sort((e,t)=>e[0]-t[0]);let r=[];for(let e of n){let t=r[r.length-1];t&&e[0]<=t[1]?t[1]=Math.max(t[1],e[1]):r.push([e[0],e[1]])}let i=[];r[0][0]>0&&i.push([0,r[0][0]]);for(let e=0;e<r.length-1;e++)i.push([r[e][1],r[e+1][0]]);return r[r.length-1][1]<t&&i.push([r[r.length-1][1],t]),i}var fd=47.5,pd=335.5,md=56,hd=4,gd=6,_d=26,vd=[1,2,5,10],yd=e=>e<=1?426.5:427.5-6*(e-1),bd=e=>vd.find(t=>t*6*e>=_d)??10,xd=18,Sd=12,Cd=e=>{let t=[1];for(let n=e;n<=md;n+=e)n!==1&&t.push(n);return t},wd=class{scene;labelHost;geo=new _r;solid;ghost;labelPool=new Map;levels=[];constructor(e,t){this.scene=e,this.labelHost=t;let n=(e,t)=>new Ei({color:16747146,transparent:!0,opacity:e,depthWrite:!1,...t?{depthFunc:6}:{}});this.solid=new Ri(this.geo,n(.28,!1)),this.ghost=new Ri(this.geo,n(.07,!0));for(let t of[this.solid,this.ghost])t.renderOrder=9,t.frustumCulled=!1,t.userData.noPick=!0,e.add(t)}set visible(e){this.solid.visible=e,this.ghost.visible=e}rebuild(e,t){this.levels=Cd(e);let n=Math.ceil((pd-fd)/hd),r=new Float32Array(this.levels.length*n*6),i=0;for(let e of this.levels){let a=yd(e),o=t(fd,a);for(let e=1;e<=n;e++){let n=t(Math.min(pd,fd+e*hd),a);r[i++]=o.x,r[i++]=o.y+gd,r[i++]=o.z,r[i++]=n.x,r[i++]=n.y+gd,r[i++]=n.z,o=n}}this.geo.setAttribute(`position`,new X(r,3))}frameLabels(e,t,n,r,i){let a=new Set;if(e){t.updateMatrixWorld();for(let e of this.levels){let o=yd(e),s=i(fd,o).project(t),c=i(pd,o).project(t);if(s.z>1||s.z<-1||c.z>1||c.z<-1)continue;let l=0,u=1,d=(e,t)=>{if(Math.abs(e)<1e-12)return t>=0;let n=t/e;if(e<0){if(n>u)return!1;n>l&&(l=n)}else{if(n<l)return!1;n<u&&(u=n)}return!0},f=c.x-s.x,p=c.y-s.y;if(!d(-f,s.x+1)||!d(f,1-s.x)||!d(-p,s.y+1)||!d(p,1-s.y))continue;let m=e=>s.x+f*e-.3*(s.y+p*e),h=m(l)<=m(u)?l:u,g=i(fd+(pd-fd)*h,o).project(t);a.add(e);let _=this.labelPool.get(e);_||(_=document.createElement(`div`),_.style.cssText=`position:absolute;transform:translate(-50%,-50%);font:10px monospace;color:rgba(255,176,176,.8);background:rgba(40,8,8,.35);padding:0 4px;border:1px solid rgba(255,138,138,.2);border-radius:4px;pointer-events:none;white-space:nowrap;z-index:879000;`,_.textContent=String(e),this.labelHost.appendChild(_),this.labelPool.set(e,_)),_.style.left=`${Math.min(n-xd,Math.max(xd,(g.x+1)/2*n))}px`,_.style.top=`${Math.min(r-Sd,Math.max(Sd,(1-g.y)/2*r))}px`}}for(let[e,t]of this.labelPool)a.has(e)||(t.remove(),this.labelPool.delete(e))}dispose(){for(let e of[this.solid,this.ghost])this.scene.remove(e),e.material.dispose();this.geo.dispose();for(let e of this.labelPool.values())e.remove();this.labelPool.clear()}},Td=class{scene;sprites=new Map;textures=new Map;constructor(e){this.scene=e}texFor(e){let t=this.textures.get(e);return t||(t=new Aa().load(Tl(`/api/world3d/projectile/${e}.png`)),t.magFilter=m,t.minFilter=m,t.colorSpace=Ve,this.textures.set(e,t)),t}frame(e,t,n,r,i){let a=new Set;for(let o of t){let t=(e-o.start)/800;if(t<0||t>=1)continue;let s=n(o.fromKey);s&&(o.fx=s.x,o.fz=s.z);let c=n(o.toKey);c&&(o.tx=c.x,o.tz=c.z);let l=r(o.fx+(o.tx-o.fx)*t,o.fz+(o.tz-o.fz)*t),u=r(o.fx,o.fz).y+110;l.y=u+(r(o.tx,o.tz).y+i(o.toKey)-u)*t;let d=this.sprites.get(o.key);d||(d=new Lr(new Cr({map:this.texFor(o.sprite),transparent:!0,alphaTest:.05,depthWrite:!1})),d.scale.set(44,44,1),d.renderOrder=14,d.userData.noPick=!0,this.scene.add(d),this.sprites.set(o.key,d)),d.position.copy(l),a.add(o.key)}for(let[e,t]of this.sprites)a.has(e)||(this.scene.remove(t),t.material.dispose(),this.sprites.delete(e));window.__projectiles={fed:t.length,live:this.sprites.size}}dispose(){for(let[,e]of this.sprites)this.scene.remove(e),e.material.dispose();this.sprites.clear();for(let[,e]of this.textures)e.dispose();this.textures.clear()}},Ed=[`head`,`body`,`legs`,`shield`,`weapon`,`hat`,`body`,`legs`,`gloves`,`boots`,`neck`,`cape`],Dd={0:[1,4,6,7,8],1:[2,5],2:[3]};function Od(e,t){let n=[],r=e.split(`|`)[0].split(`,`).map(Number);for(let e=0;e<r.length;e++){if(!r[e]||Dd[e]?.includes(r[e]))continue;let i=t?.[r[e]],a=i?.length?i.slice(0,3).join(` / `)+(i.length>3?` +${i.length-3} more`:``):`sprite ${r[e]}`;n.push({slot:Ed[e]??`slot ${e}`,names:a})}return n}var kd=[{key:`underground`,label:`Underground`},{key:`ground`,label:`Ground`},{key:`floor1`,label:`Floor 1`},{key:`floor2`,label:`Floor 2`}],Ad=[`ground`,`floor1`,`floor2`,`underground`],jd=e=>Ad[Math.max(0,Math.min(3,Math.trunc(e)))],Md=e=>{let t=Ad.indexOf(e);return t<0?0:t},Nd=new Set([`roofs`,`roofs1`,`roofs2`,`walls1`,`walls2`]),Pd=74,Fd=4e3,Id=.18;function Ld(e){switch(e){case`ground`:return{plane:0,kinds:[`terrain`,`walls`,`walls1`,`walls2`,`roofs`,`roofs1`,`roofs2`]};case`floor1`:return{plane:1,kinds:[`terrain`,`walls`,`roofs`]};case`floor2`:return{plane:2,kinds:[`terrain`,`walls`,`roofs`]};case`underground`:return{plane:3,kinds:[`terrain`,`walls`]}}}var Rd=[{x:120,z:640,yaw:45,pitch:89,zoom:500,sec:10},{x:120,z:640,yaw:45,pitch:40,zoom:40,sec:4},{x:122,z:640,yaw:225,pitch:35,zoom:35,sec:8},{x:215,z:630,yaw:270,pitch:45,zoom:60,sec:8},{x:310,z:570,yaw:315,pitch:50,zoom:80,sec:8},{x:300,z:560,yaw:405,pitch:89,zoom:700,sec:8}];function zd(){let e=parseFloat(new URLSearchParams(location.search).get(`capture`)??``);return Number.isFinite(e)&&e>0?Math.round(e):0}function Bd(e){if(!e.trim())return null;let t=e.match(/^\s*(\d+)\s*[x×X]\s*(\d+)\s*$/),n=t?parseInt(t[1],10):0,r=t?parseInt(t[2],10):0;if(!n||!r)throw Error(`bad resolution "${e}" — use e.g. 1920x1080`);return{w:n,h:r}}function Vd(e,t,n,r,i,a){let o=a*a,s=o*a;return(2*s-3*o+1)*e+(s-2*o+a)*i*t+(-2*s+3*o)*n+(s-o)*i*r}var Hd=`
in vec3 position;
in float shade;
in vec3 base;
in vec2 uv;
...
}`,Wd=1<<27,Gd=(e,t)=>e>=0&&e<4096&&t>=0&&t<4096?Wd|e<<12|t:0,Kd=(e,t,n)=>e>=0&&e<4096&&t>=0&&t<4096?201326592|(n&3)<<24|e<<12|t:0;function qd(e,t,n,r,i){let a=new DataView(e);if(a.getUint32(0)!==1381188403)throw Error(`bad cell magic`);let o=a.getUint16(4),s=a.getUint8(7),c=n*128,l=r*128,u=a.getUint16(16),d=18,f=[];for(let o=0;o<u;o++){let o=a.getInt16(d),s=a.getInt32(d+2);d+=6;let u=new Float32Array(s*3);for(let e=0;e<s;e++){let o=a.getInt16(d),s=o+c,f=a.getInt16(d+2),p=a.getInt16(d+4),m=p+l;d+=6,i&&o%128==0&&p%128==0&&i(n+o/128,r+p/128,-f),u[e*3]=t-s,u[e*3+1]=-f,u[e*3+2]=m}let p=new Uint8Array(e,d,s);d+=s;let m=new Uint8Array(e,d,s*3);d+=s*3;let h=null;if(o>=0){h=new Float32Array(s*2);for(let e=0;e<s*2;e++)h[e]=a.getInt16(d)/512,d+=2}let g=new _r;g.setAttribute(`position`,new X(u,3)),g.setAttribute(`shade`,new X(new Float32Array(p),1)),g.setAttribute(`base`,new X(new Uint8Array(m),3,!0)),h&&g.setAttribute(`uv`,new X(h,2)),f.push({tex:o,geometry:g})}if(i&&o>=2&&s===0){let e=a.getUint16(d);d+=2;for(let t=0;t<e;t++)for(let o=0;o<e;o++)i(n+t,r+o,a.getUint8(d++)*3)}return f}function Jd(e){let t=(0,l.useRef)(null),[n,r]=(0,l.useState)(()=>Md(new URLSearchParams(location.search).get(`floor`))),i=e.overlays!=null,a=e.floorIndex??n,o=jd(a),s=t=>{let n=Math.max(0,Math.min(3,Math.trunc(t)));e.onFloorIndexChange?e.onFloorIndexChange(n):r(n)},[c,u]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`roofs`)!==`0`),[f,p]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`sight`)!==`0`),[h,g]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`tags`)===`1`),_=e.overlays?.roofs??c,v=e.overlays?.sight??f,y=e.overlays?.tags??h,b=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:t,sight:v,tags:y}):u(t),x=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:t,tags:y}):p(t),S=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:v,tags:t}):g(t),[C,w]=(0,l.useState)(`loading manifest…`),[T,E]=(0,l.useState)(``),[D,O]=(0,l.useState)(null),[k,A]=(0,l.useState)(null);(0,l.useEffect)(()=>{Ml().then(A).catch(()=>{})},[]);let[j,M]=(0,l.useState)([]);(0,l.useEffect)(()=>{let e=!1,t=()=>jl().then(t=>{e||M(t)}).catch(()=>{e||setTimeout(t,5e3)});return t(),()=>{e=!0}},[]);let[N,ee]=(0,l.useState)(!1),P=(0,l.useRef)(null),F=zd(),I=(0,l.useRef)(null),[te,ne]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`size`)??``),re=(0,l.useRef)(new Map),ie=(0,l.useRef)(0),ae=(0,l.useRef)([]),[L,R]=(0,l.useState)(null),oe=(0,l.useRef)(!1);oe.current=L!=null;let se=(0,l.useRef)(null);(0,l.useEffect)(()=>{e.onFlyingChange?.(N)},[N]);let ce=(0,l.useRef)(e.flyNonce??0);(0,l.useEffect)(()=>{e.flyNonce==null||e.flyNonce===ce.current||(ce.current=e.flyNonce,P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0)))},[e.flyNonce]),(0,l.useEffect)(()=>{if(!e.follow)return;let t=(e.observers??[]).find(t=>t.username===e.follow)?.position?.floor;t!=null&&t!==a&&s(t)},[e.follow,e.observers]),(0,l.useEffect)(()=>{let t=e.panTarget;if(!t)return;let n=Math.max(0,Math.min(3,t.floor));n!==a&&s(n),le.current?.(t.x,t.z-n*944)},[e.panTarget?.nonce]),(0,l.useEffect)(()=>{if(e.visible===!1)return;let t=setTimeout(()=>se.current?.(),60);return()=>clearTimeout(t)},[e.visible]);let z=(0,l.useRef)({manifest:null,floor:`ground`,roofs:!0,sight:!0,tags:!0,focusBot:e.focus??{x:120,z:640},entities:[],entitiesRev:0,groundItems:[],observed:[],observedDoors:[],observedRev:0,respawnGhosts:[],route:null,trail:null}),B=(0,l.useRef)(e);B.current=e;let le=(0,l.useRef)(null),ue=(0,l.useRef)(s);if(ue.current=s,z.current.floor=o,z.current.roofs=_,z.current.sight=v,z.current.tags=y,z.current.route=e.route??null,z.current.trail=e.trail??null,e.focus&&(z.current.focusBot=e.focus),e.visible!==!1){let t=Ld(o).plane,n=[],r=new Map,i=new Map,a=e.layers?.bots!==!1,s=e.layers?.npcs!==!1,c=e.layers?.players!==!1,l=e.layers?.npcSpawns!==!1,u=(e,t)=>{t.msg!=null&&t.msgTick!=null&&(e.msgTick==null||t.msgTick>e.msgTick)&&(e.msg=t.msg,e.msgTick=t.msgTick)},d=new Set;for(let t of e.observers??[])t.serverIndex!=null&&d.add(t.serverIndex);let f=e.world,p=new Map;if(e.layers?.shops!==!1)for(let t of e.shops??[])for(let e of t.npcIds)p.set(e,t.id);for(let o of e.observers??[]){let l=o.position;a&&l&&l.floor===t&&n.push({key:`bot:${o.username}`,kind:`bot`,x:l.x,z:l.z-l.floor*944,name:o.username,selected:o.username===e.selectedBot,inCombat:o.inCombat??!1,appearance:o.appearance,skulled:o.skulled,dir:o.dir,hp:o.hits,maxHp:o.maxHits,dmg:o.dmg,dmgTick:o.dmg==null?null:o.serverTick,msg:o.msg,msgTick:o.msgTick,bubble:o.bubble,bubbleTick:o.bubbleTick,sleeping:o.sleeping});for(let e of s&&!f?o.npcs??[]:[]){if(Math.floor(e.z/944)!==t)continue;let i=r.get(e.serverIndex);if(i){u(i,e);continue}let a={key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,npcId:e.id,dir:e.dir,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,shopId:p.get(e.id)};r.set(e.serverIndex,a),n.push(a)}for(let e of c&&!f?o.players??[]:[]){if(Math.floor(e.z/944)!==t||d.has(e.serverIndex))continue;let r=i.get(e.serverIndex);if(r){u(r,e);continue}let a={key:`pl:${e.serverIndex}`,kind:`player`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,appearance:e.appearance,dir:e.dir,combatLvl:e.combatLvl,skulled:e.skulled,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,bubble:e.bubble,bubbleTick:e.bubbleTick};i.set(e.serverIndex,a),n.push(a)}}if(f){for(let e of s?f.npcs:[]){if(Math.floor(e.z/944)!==t)continue;let i={key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,npcId:e.id,dir:e.dir,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,shopId:p.get(e.id)};r.set(e.serverIndex,i),n.push(i)}for(let e of c?f.players:[])Math.floor(e.z/944)!==t||d.has(e.serverIndex)||n.push({key:`pl:${e.serverIndex}`,kind:`player`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,appearance:e.appearance,dir:e.dir,combatLvl:e.combatLvl,skulled:e.skulled,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,bubble:e.bubble,bubbleTick:e.bubbleTick})}let m=new Map;for(let t of l?e.npcRespawns??[]:[])m.set(t.serverIndex,t);for(let e of l?j:[]){if(Math.floor(e.z/944)!==t||r.has(e.serverIndex))continue;let i=m.get(e.serverIndex);n.push({key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:!1,npcId:e.id,ghost:!0,shopId:p.get(e.id),respawnTicks:i?.t??null,respawnTicksMin:i?.tMin??null,respawnAssumed:i?.assumed??null,respawnCheckedAgo:i?.checkedAgo??null})}z.current.entities=n,z.current.entitiesRev++;let h=[];if(f)for(let e of f.groundItems)Math.floor(e.z/944)===t&&h.push({id:e.id,x:e.x,z:e.z%944,name:e.name});else{let n=new Set;for(let r of e.observers??[])for(let e of r.groundItems??[]){if(Math.floor(e.z/944)!==t)continue;let r=`${e.id}:${e.x},${e.z}`;n.has(r)||(n.add(r),h.push({id:e.id,x:e.x,z:e.z%944,name:e.name}))}}z.current.groundItems=h;let g=[],_=new Set;for(let e of f?f.objects:[]){let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;_.has(n)||(_.add(n),g.push({plane:t,x:e.x,z:e.z%944,id:e.id}))}for(let t of f?[]:e.observers??[])for(let e of t.objects??[]){let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;_.has(n)||(_.add(n),g.push({plane:t,x:e.x,z:e.z%944,id:e.id}))}z.current.observed=g;let v=[];for(let e of f?f.wallObjects:[])e.dir!=null&&v.push({plane:Math.floor(e.z/944),x:e.x,z:e.z%944,dir:e.dir,id:e.id});let y=new Set;for(let t of f?[]:e.observers??[])for(let e of t.wallObjects??[]){if(e.dir==null)continue;let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944},${e.dir}`;y.has(n)||(y.add(n),v.push({plane:t,x:e.x,z:e.z%944,dir:e.dir,id:e.id}))}z.current.observedDoors=v,z.current.observedRev++;let b=[],x=new Set;for(let t of e.objectRespawns??[]){let e=Math.floor(t.z/944),n=`${e}:${t.x},${t.z%944}`;x.has(n)||(x.add(n),b.push({plane:e,x:t.x,z:t.z%944,id:t.id,t:t.t}))}z.current.respawnGhosts=b;{let t=new Map;for(let n of e.observers??[])n.serverIndex!=null&&t.set(n.serverIndex,n.username);let r=new Map;for(let e of n)r.set(e.key,e);let i=performance.now(),a=new Set;for(let n of e.observers??[])if(n.serverTick!=null&&re.current.get(n.username)!==n.serverTick){re.current.set(n.username,n.serverTick);for(let e of n.projectiles??[]){let n=`${e.sprite}:${e.fromNpc?`n`:`p`}${e.from}:${e.toPlayer?`p`:`n`}${e.to}`;if(a.has(n))continue;a.add(n);let o=e.fromNpc?`npc:${e.from}`:t.has(e.from)?`bot:${t.get(e.from)}`:`pl:${e.from}`,s=e.toPlayer?t.has(e.to)?`bot:${t.get(e.to)}`:`pl:${e.to}`:`npc:${e.to}`,c=r.get(o),l=r.get(s);!c||!l||ae.current.push({key:`f${ie.current++}`,sprite:e.sprite,fromKey:o,toKey:s,start:i,fx:c.x,fz:c.z,tx:l.x,tz:l.z})}}ae.current=ae.current.filter(e=>i-e.start<1e3)}}return(0,l.useEffect)(()=>{let e=t.current;if(!e)return;let n=!1,r=null,i=new wl({antialias:!0,preserveDrawingBuffer:F>0});i.setPixelRatio(window.devicePixelRatio),e.appendChild(i.domElement);let a=new wn;a.background=new Sn(1052698),a.matrixWorldAutoUpdate=!1;let o=new za(-1,1,1,-1,-4e5,4e5),s=new J,c=new URLSearchParams(location.search),l=e=>{if(e==null)return null;let t=parseFloat(e);return Number.isFinite(t)?t:null},u=(l(c.get(`yaw`))??45)*Math.PI/180,f=(l(c.get(`pitch`))??45.8)*Math.PI/180,p=.02,h=1.5533;f=Math.max(p,Math.min(h,f));let g=2e5,_=1024*128,v=null,y=()=>{v||=setTimeout(()=>{v=null;let e=z.current.manifest;if(!e)return;let t=e.botXTiles*128,n=new URLSearchParams(location.search);n.set(`floor`,z.current.floor),n.set(`roofs`,z.current.roofs?`1`:`0`),n.set(`sight`,z.current.sight?`1`:`0`),n.set(`tags`,z.current.tags?`1`:`0`),n.set(`x`,((t-s.x)/128).toFixed(1)),n.set(`z`,(s.z/128).toFixed(1)),n.set(`zoom`,(V/128).toFixed(1)),n.set(`yaw`,(u*180/Math.PI).toFixed(1)),n.set(`pitch`,(f*180/Math.PI).toFixed(1)),history.replaceState(null,``,`${location.pathname}?${n}`)},400)},b=()=>{let e=5120;s.x=Math.max(-5120,Math.min(_+e,s.x)),s.y=Math.max(-3e3,Math.min(3e3,s.y)),s.z=Math.max(-5120,Math.min(_+e,s.z));let t=Math.cos(f);o.position.set(s.x+g*t*Math.sin(u),s.y+g*Math.sin(f),s.z+g*t*Math.cos(u)),o.up.set(0,1,0),o.lookAt(s);let n=B.current.sharedView,r=z.current.manifest;n&&r&&(n.current={x:(r.botXTiles*128-s.x)/128,z:s.z/128,zoom:V/128}),y(),window.__w3d={target:{x:s.x,y:s.y,z:s.z},yaw:u,pitch:f,viewHeightUnits:V}},x=()=>{let e=Math.sin(u),t=Math.cos(u),n=Math.sin(f),r=Math.cos(f);return{right:new J(t,0,-e),up:new J(-n*e,r,-n*t)}},S=()=>{let e=Math.sin(f);if(e<.15||s.y===0)return;let t=s.y/e,n=Math.cos(f);s.x-=n*Math.sin(u)*t,s.z-=n*Math.cos(u)*t,s.y=0},C=new Lt(1,1,{count:2}),T=new Uint8Array(4),D=new Uint8Array(4),k=new za,A=null,j=null,M=(e,t)=>{let n=i.domElement.getBoundingClientRect();if(!n.width||!n.height)return!1;let r=(e-n.left)/n.width*2-1,s=-((t-n.top)/n.height*2-1),c=r*o.right,l=s*o.top,u=2*o.right/n.width,d=k.copy(o);d.left=c-u,d.right=c+u,d.bottom=l-u,d.top=l+u,d.updateProjectionMatrix();let f=i.getRenderTarget(),p=i.getClearColor(new Sn),m=i.getClearAlpha(),h=a.background;a.background=null;for(let e of pr.values())e.uniforms.pickMode.value=1,e.blending=0;let g=[];for(let e of a.children)e.userData.noPick&&e.visible&&(e.visible=!1,g.push(e));i.setRenderTarget(C),i.setClearColor(16777215,1),i.clear(),i.render(a,d);for(let e of g)e.visible=!0;i.setRenderTarget(f),i.setClearColor(p,m),a.background=h;for(let e of pr.values())e.uniforms.pickMode.value=0,e.blending=1;return j={x:e,y:t,vx:c,vy:l},!0},N=()=>{j&&=(i.readRenderTargetPixels(C,0,0,1,1,T,void 0,0),i.readRenderTargetPixels(C,0,0,1,1,D,void 0,1),A=j,null)},te=(e,t)=>A&&A.x===e&&A.y===t?!0:M(e,t)?(N(),A!==null):!1,ne=(e,t)=>{if(!te(e,t))return null;let{vx:n,vy:r}=A,i=D[0]/255+D[1]/65025+D[2]/(65025*255);if(window.__pickDebug={buf:[D[0],D[1],D[2],D[3]],d:i,vx:n,vy:r,near:o.near,far:o.far},i>=.9999)return null;let a=o.near+i*(o.far-o.near),{right:s,up:c}=x(),l=new J(-Math.cos(f)*Math.sin(u),-Math.sin(f),-Math.cos(f)*Math.cos(u));return o.position.clone().addScaledVector(s,n).addScaledVector(c,r).addScaledVector(l,a)},re=new ro,ie=(e,t)=>{let n=i.domElement.getBoundingClientRect();if(n.width===0||n.height===0)return null;let r=new gt((e-n.left)/n.width*2-1,-((t-n.top)/n.height)*2+1);re.setFromCamera(r,o);let a=-re.ray.origin.y/re.ray.direction.y;if(!isFinite(a)||a<0)return null;let c=re.ray.origin.clone().addScaledVector(re.ray.direction,a),l=2*Math.hypot(o.right,o.top),u=c.clone().sub(s);return u.y=0,u.length()>l&&c.sub(u).add(u.setLength(l)),c},L=(e,t)=>{let n=ie(e,t),r=z.current.manifest;return!n||!r?null:{x:Math.max(0,Math.floor((r.botXTiles*128-n.x)/128)),z:Math.max(0,Math.floor(n.z/128))}},ce=!1,de=(e,t,n)=>{let r=Math.max(p,Math.min(h,f+n))-f,i=new J(Math.cos(u),0,-Math.sin(u)),a=new _t().setFromAxisAngle(new J(0,1,0),t).multiply(new _t().setFromAxisAngle(i,-r)),c=o.position.clone().sub(e).applyQuaternion(a).add(e),l=s.clone().sub(e).applyQuaternion(a).add(e),d=c.sub(l),m=d.length();f=Math.max(p,Math.min(h,Math.asin(Math.max(-1,Math.min(1,d.y/m))))),u=Math.atan2(d.x,d.z);let g=Math.sin(f);if(g>=.15){let e=-l.y/g;s.set(l.x+d.x/m*e,0,l.z+d.z/m*e)}else s.copy(l),s.y=Math.max(-3e3,Math.min(3e3,s.y));b()},fe=new URLSearchParams(location.search),V=(l(fe.get(`zoom`))??60)*128,pe=()=>{let t=r?r.w:e.clientWidth||800,n=r?r.h:e.clientHeight||600;i.setPixelRatio(r?1:window.devicePixelRatio),i.setSize(t,n,!r);let a=t/n;o.left=-V*a/2,o.right=V*a/2,o.top=V/2,o.bottom=-V/2,o.updateProjectionMatrix()},me=new ResizeObserver(pe);me.observe(e),se.current=()=>{let e=z.current.manifest;if(!e)return;let t=B.current.sharedView?.current;if(!t)return;let n=e.botXTiles*128;s.x=n-t.x*128,s.z=t.z*128,t.zoom>0&&(V=t.zoom*128,pe()),b()},le.current=(e,t)=>{let n=z.current.manifest;n&&(s.x=n.botXTiles*128-(e*128+64),s.z=t*128+64,V>15360&&(V=7680,pe()),b())};let he=new Map;Promise.all([kl(),Al()]).then(([e,t])=>{for(let t of e){let e=un(t.floor,t.x,t.z),n=nn.get(e);n||nn.set(e,n=[]),n.push(t),rn.set(dn(t.floor,t.x,t.z),t)}for(let e of cn)sn.add(e);let n=new Map;for(let e of t.entries)n.set(`${e.id}_${e.dir}`,{name:e.name,tw:e.tw,th:e.th});for(let t of e){let e=n.get(`${t.id}_${t.dir}`),r=e?.tw??1,i=e?.th??1,a={id:t.id,dir:t.dir,name:e?.name??`object ${t.id}`,ax:t.x,az:t.z};for(let e=0;e<r;e++)for(let n=0;n<i;n++){let r=`${t.floor}:${t.x+e},${t.z+n}`,i=he.get(r);i||he.set(r,i=[]),i.push(a)}}}).catch(()=>{});let ge=null,_e=null,ve=!1,ye=!1,be=``,xe=null,Se=null,Ce=e=>e?e.type===`entity`?`${e.kind} ${e.name??e.key}`+(e.npcId==null?``:` (id ${e.npcId})`)+` · tile ${Math.round(e.x)},${Math.round(e.z)}`+(e.inCombat?` · in combat`:``):e.type===`object`?`${e.name} (id ${e.id}, dir ${e.dir}, anchor ${e.ax},${e.az}, ${e.w}x${e.h})`:e.type===`wall`?`${e.name} (boundary ${e.id}, dir ${e.dir}, edge ${e.x},${e.z})`:e.type===`grounditem`?`${e.name??`item`} (id ${e.id}) · tile ${Math.round(e.x)},${Math.round(e.z)}`:`tile ${e.x},${e.z} · h ${at(e.x,e.z).toFixed(0)}`:``,we=e=>{fr(e);let t=Ce(e);t!==be&&(be=t,E(t))},Te=(e,t)=>{z.current.manifest&&we(dr(e,t,!0))},Ee=e=>{let t=lt.current().find(t=>t.key===e);we(t?{type:`entity`,...t}:null)},H=null,De=()=>{let e=B.current.follow,t=z.current.manifest;if(!e||!t)return null;let n=lt.current().find(t=>t.key===`bot:${e}`);return n?new J(t.botXTiles*128-(n.x*128+64),0,n.z*128+64):null},Oe=null,ke=`idle`,U=()=>document.pointerLockElement===e,Ae=t=>{if(Oe!=null||U()||typeof e.requestPointerLock!=`function`)return;Oe=t,ke=`pending`;let n=()=>{Oe=null,ke=`idle`};try{let t=e.requestPointerLock({unadjustedMovement:!0});t instanceof Promise&&t.catch(()=>{try{let t=e.requestPointerLock();t instanceof Promise&&t.catch(n)}catch{n()}})}catch{n()}},W=!1,G=()=>{Oe=null,ke=`idle`,U()&&(W=!0,document.exitPointerLock())},je=()=>{if(U()){ke=`engaged`,H||G();return}if(Oe=null,ke=`idle`,W){W=!1;return}H=null},Me=()=>{Oe=null,ke=`idle`};document.addEventListener(`pointerlockchange`,je),document.addEventListener(`pointerlockerror`,Me);let Ne=new Map,Pe=null,Fe=(e,t,n)=>{let r=i.domElement.getBoundingClientRect(),a=r.width?(e-r.left)/r.width*2-1:0,c=r.height?-((t-r.top)/r.height*2-1):0,l=o.right,u=o.top,d=V;V=Math.min(1024*128,Math.max(768,V*n));let f=V/d;pe();let{right:p,up:m}=x();s.addScaledVector(p,a*l*(1-f)).addScaledVector(m,c*u*(1-f)),S(),b()},Ie=()=>{let[e,t]=[...Ne.values()];return{dist:Math.hypot(e.x-t.x,e.y-t.y),midX:(e.x+t.x)/2,midY:(e.y+t.y)/2,angle:Math.atan2(t.y-e.y,t.x-e.x)}},Le=()=>{let e=Ie();Pe={...e,pivot:ne(e.midX,e.midY)??ie(e.midX,e.midY)}},Re=()=>{if(!Pe||Ne.size<2)return;let e=Ie();Pe.dist>0&&e.dist>0&&Fe(e.midX,e.midY,Pe.dist/e.dist);let t=e.angle-Pe.angle;t>Math.PI?t-=2*Math.PI:t<-Math.PI&&(t+=2*Math.PI);let n=(e.midY-Pe.midY)*.008;de(De()??Pe.pivot??s,-t,n),Pe.dist=e.dist,Pe.midX=e.midX,Pe.midY=e.midY,Pe.angle=e.angle},ze=i.domElement;ze.style.touchAction=`none`,e.style.touchAction=`none`,e.addEventListener(`contextmenu`,e=>e.preventDefault()),e.addEventListener(`pointerdown`,t=>{if(P.current&&(P.current=null,ee(!1)),t.pointerType===`touch`&&(Ne.set(t.pointerId,{x:t.clientX,y:t.clientY}),e.setPointerCapture(t.pointerId),Ne.size>=2)){H=null,ge={kind:`none`},Ne.size===2&&Le();return}if(t.button!==0&&t.button!==1&&t.button!==2)return;ge={kind:`none`};let n=t.button===0?t.target.closest?.(`[data-grip]`):null;if(n&&Ct){let[r,i]=(n.dataset.grip??``).split(`:`);Ft={kx:r===`null`?null:r,kz:i===`null`?null:i},It=n.style.cursor,ze.style.cursor=It,e.setPointerCapture(t.pointerId);return}if(B.current.areaSelect&&t.button===0&&!t.shiftKey){let n=L(t.clientX,t.clientY);if(n){ce=!0,Ct={x0:n.x,z0:n.z,x1:n.x,z1:n.z},wt=!0,e.setPointerCapture(t.pointerId);return}}let r=t.button===0&&!t.shiftKey?`pan`:`rotate`;t.button===1&&t.preventDefault();let i=t.target.closest?.(`[data-entity-key]`);H={mode:r,button:t.button,pointerId:t.pointerId,lastX:t.clientX,lastY:t.clientY,downX:t.clientX,downY:t.clientY,moved:0,pivot:r===`rotate`?De()??ne(t.clientX,t.clientY)??ie(t.clientX,t.clientY):null,plateKey:i?.dataset.entityKey??null,shopId:(t.target.closest?.(`[data-shop-id]`))?.dataset.shopId??null,transport:t.target.closest?.(`[data-transport]`)?$n:null},window.__w3dPivot=H.pivot?{x:H.pivot.x,y:H.pivot.y,z:H.pivot.z}:null,e.setPointerCapture(t.pointerId)}),e.addEventListener(`pointermove`,e=>{if(Ft){let t=L(e.clientX,e.clientY);t&&(Ft=Pt(Ft,t));return}if(ce){let t=L(e.clientX,e.clientY);t&&Ct&&(Ct.x1=t.x,Ct.z1=t.z,wt=!0);return}if(e.pointerType===`touch`&&Ne.has(e.pointerId)&&(Ne.set(e.pointerId,{x:e.clientX,y:e.clientY}),Pe&&Ne.size>=2)){Re();return}if(!H){let t=e.target.closest?.(`[data-entity-key]`);ge=t?.dataset.entityKey?{kind:`plate`,key:t.dataset.entityKey}:e.target===ze?{kind:`canvas`,x:e.clientX,y:e.clientY}:{kind:`none`};return}let t=U(),n=t?e.movementX:e.clientX-H.lastX,r=t?e.movementY:e.clientY-H.lastY;if(H.lastX=e.clientX,H.lastY=e.clientY,ke!==`idle`&&(ke===`engaged`&&(ke=`idle`),n=0,r=0),H.moved=(H.moved??0)+Math.hypot(n,r),H.mode===`rotate`&&H.moved>=4&&e.pointerType===`mouse`&&(H.noClick=!0,Ae(H.pointerId)),H.mode===`rotate`){let e=De()??H.pivot??s;de(e,-n*.008,r*.008)}else if(!De()){let e=V/(i.domElement.clientHeight||600),{right:t,up:a}=x();s.addScaledVector(t,-n*e).addScaledVector(a,r*e),S(),b()}});let Be=e=>e<-9?`#ff0000`:e<-6?`#ff3000`:e<-3?`#ff7000`:e<0?`#ffb000`:e>9?`#00ff00`:e>6?`#40ff00`:e>3?`#80ff00`:e>0?`#c0ff00`:`#fff`,Ve=(e,t)=>{if(e+2304>=2640)return 0;let n=2203-(t+(1776-944*Math.floor(t/944)));return n>0?1+Math.floor(n/6):0},He=1,Ue=(e,t)=>{let n=B.current.selectedBot,r=z.current.manifest;if(!n||!r)return[];let i=ur(e,t);if(!i)return[];let a=Ld(z.current.floor).plane,o=e=>e+a*944,s=B.current.useItem??null,c=()=>B.current.onUseItemDone?.(),l=[],u=(e,t,r,i,a,o=0)=>Fl(n,e,t,r,i,a,o).catch(()=>{}),d=i.bot??i.ent;if(d&&!d.ghost&&d.kind===`npc`&&d.npcId!=null){let e=parseInt(d.key.slice(4),10),t=d.name??Gt.info(d.npcId)?.name??`npc`,r=Math.round(d.x),i=o(Math.round(d.z)),a=Gt.info(d.npcId);if(s)l.push({verb:`Use ${s.name} with`,target:t,tcolor:`#ff0`,prio:710,run:()=>{u(`use_item_on_npc`,r,i,e,He++,s.id),c()}});else{let o=(B.current.observers??[]).find(e=>e.username===n);if(a?.atk){let n=(o?.combatLvl??0)-(a.lvl??0);l.push({verb:`Attack`,target:t,tcolor:`#ff0`,suffix:` (level-${a.lvl})`,scolor:Be(n),prio:n>=0?715:2715,run:()=>u(`npc_attack`,r,i,e,He++)})}l.push({verb:`Talk-to`,target:t,tcolor:`#ff0`,prio:720,run:()=>u(`npc_talk`,r,i,e,He++)}),a?.cmd1&&l.push({verb:a.cmd1,target:t,tcolor:`#ff0`,prio:725,run:()=>u(`npc_command1`,r,i,e,He++)}),a?.cmd2&&l.push({verb:a.cmd2,target:t,tcolor:`#ff0`,prio:833,run:()=>u(`npc_command2`,r,i,e,He++)})}}else if(d&&(d.kind===`player`||d.kind===`bot`)&&!(d.kind===`bot`&&d.name===n)){let e=d.kind===`player`?parseInt(d.key.slice(3),10):(B.current.observers??[]).find(e=>e.username===d.name)?.serverIndex,t=d.name??`player`,n=Math.round(d.x),r=o(Math.round(d.z));e!=null&&!s&&(Ve(n,r)>0?l.push({verb:`Attack`,target:t,tcolor:`#fff`,prio:805,run:()=>u(`player_attack`,n,r,e,He++)}):l.push({verb:`Duel with`,target:t,tcolor:`#fff`,prio:2806,run:()=>u(`player_duel`,n,r,e,He++)}),l.push({verb:`Trade with`,target:t,tcolor:`#fff`,prio:2810,run:()=>u(`player_trade`,n,r,e,He++)}),l.push({verb:`Follow`,target:t,tcolor:`#fff`,prio:2820,run:()=>u(`player_follow`,n,r,e,He++)}))}for(let e of i.ground){let t=Math.round(e.x),n=o(Math.round(e.z));s?l.push({verb:`Use ${s.name} with`,target:e.name??`item`,tcolor:`#ff9040`,prio:210,run:()=>{u(`use_item_on_ground_item`,t,n,e.id,He++,s.id),c()}}):l.push({verb:`Take`,target:e.name??`item`,tcolor:`#ff9040`,prio:220,run:()=>u(`ground_item`,t,n,e.id,He++)})}if(i.wall?.type===`wall`){let e=i.wall,t=vn?.get(e.id),n=o(e.z);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:310,run:()=>{u(`use_item_on_wall_object`,e.x,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:320,run:()=>u(`wall_object`,e.x,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2300,run:()=>u(`wall_object2`,e.x,n,e.id,e.dir)}))}if(i.obj?.type===`object`){let e=i.obj,t=tn?.objects.get(e.id),n=o(e.az);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:410,run:()=>{u(`use_item_on_object`,e.ax,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:420,run:()=>u(`object`,e.ax,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2400,run:()=>u(`object2`,e.ax,n,e.id,e.dir)}))}if(i.tile){let e=i.tile;l.push({verb:`Walk here`,prio:920,run:()=>{Pl(n,{x:e.x,z:o(e.z)}).catch(()=>{}),s&&c()}})}return l.sort((e,t)=>e.prio-t.prio),l},We=(t,n)=>{let r=Ue(t,n);if(r.length===0)return;r.push({verb:`Cancel`,prio:4e3});let i=e.getBoundingClientRect();R({x:t-i.left,y:n-i.top,entries:r})},Ge=t=>{let n=H&&!H.noClick&&Math.hypot(t.clientX-H.downX,t.clientY-H.downY)<4;if(n&&oe.current){R(null),H=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(n&&H.button===2&&(B.current.walkTool||B.current.useItem)&&B.current.selectedBot){We(t.clientX,t.clientY),H=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(H&&H.button===0&&!H.noClick&&Math.hypot(t.clientX-H.downX,t.clientY-H.downY)<4){if(H.transport){let n=H.transport,r=Math.max(0,Math.min(3,n.dfloor));ue.current(r),le.current?.(n.dx,n.dz),H=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(H.shopId){B.current.onSelectShop?.(H.shopId),H=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}let n=H.plateKey?lt.current().find(e=>e.key===H.plateKey):null,r=n?{type:`entity`,...n}:dr(t.clientX,t.clientY),i=B.current.selectedBot;if((B.current.walkTool||B.current.useItem)&&i&&r){let e=Ue(t.clientX,t.clientY);if(n&&e.length){let t=n.name??``,r=e.filter(e=>e.target===t);r.length&&(e=r)}e[0]?.run?.()}else r?.type===`entity`?(lt.selectedEntityKey=r.key,r.kind===`bot`?(B.current.onSelectBot?.(r.key.slice(4)),O(null)):O({kind:r.kind,name:r.name??null,npcId:r.npcId??null,key:r.key,inCombat:!!r.inCombat,appearance:r.appearance})):r?.type===`object`?O({kind:`object`,name:r.name,npcId:r.id,key:`obj:${r.ax},${r.az}`,inCombat:!1}):r?.type===`wall`?O({kind:`boundary`,name:r.name,npcId:r.id,key:`wall:${r.x},${r.z},${r.dir}`,inCombat:!1}):(lt.selectedEntityKey=null,O(null))}H=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId)},Ke=t=>{if((Oe===t.pointerId||U())&&G(),Ft){Ft=null,ze.style.cursor=``,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(ce){ce=!1,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),Ct&&B.current.onAreaSelected?.({x0:Math.min(Ct.x0,Ct.x1),x1:Math.max(Ct.x0,Ct.x1),z0:Math.min(Ct.z0,Ct.z1),z1:Math.max(Ct.z0,Ct.z1)});return}if(t.pointerType===`touch`){let n=Ne.delete(t.pointerId);if(Pe){if(e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),Ne.size<2)if(Pe=null,Ne.size===1){let[[e,t]]=[...Ne.entries()];H={mode:`pan`,button:0,pointerId:e,lastX:t.x,lastY:t.y,downX:t.x,downY:t.y,pivot:null,plateKey:null,noClick:!0}}else H=null;return}if(!n)return}Ge(t)};e.addEventListener(`pointerup`,Ke),e.addEventListener(`pointercancel`,Ke),e.addEventListener(`pointerleave`,()=>{H||(ge={kind:`none`})}),e.addEventListener(`lostpointercapture`,e=>{Oe===e.pointerId||U()||H&&H.pointerId===e.pointerId&&(H=null)}),e.addEventListener(`wheel`,e=>{e.preventDefault(),Fe(e.clientX,e.clientY,1.0015**e.deltaY)},{passive:!1});let qe=1009,Ye=0,Xe=0,Ze=0,Qe=[null,null,null,null],$e=e=>{let t=Qe[e];return t||(t=new Float32Array(qe*qe).fill(NaN),Qe[e]=t),t},et=Ld(z.current.floor).plane,tt=(e,t,n,r)=>{t>=0&&t<qe&&n>=0&&n<qe&&(e[n*qe+t]=r)},nt=(e,t,n)=>{if(t<0||t>=qe||n<0||n>=qe)return 0;let r=e[n*qe+t];return Number.isNaN(r)?0:r},K=(e,t,n)=>{let r=t+.5,i=n+.5,a=Math.floor(r),o=Math.floor(i),s=r-a,c=i-o,l=nt(e,a,o),u=nt(e,a+1,o),d=nt(e,a,o+1),f=nt(e,a+1,o+1);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c},q=null,rt=et,it=()=>{let e=z.current.floor;return e!==q&&(q=e,rt=Ld(e).plane),rt},at=(e,t)=>K($e(it()),e,t),ot=e=>(t,n)=>K($e(e),t,n),st=(e,t)=>{let n=at(e+.5,t)-at(e-.5,t),r=at(e,t+.5)-at(e,t-.5);return new J(n/128,1,-r/128).normalize()},ct=document.createElement(`div`);ct.style.cssText=`position:absolute;inset:0;overflow:hidden;pointer-events:none;user-select:none;`,e.appendChild(ct);let lt=new Ql(a,ct),ut=-1,dt=new sd(a),ft=new wd(a,ct),pt=0,mt=null,ht=-1,vt=new od(a,5088255,.6,.16),yt,Y=null,bt=-1,xt=(e,t)=>{let n=[],r=[];for(let t of z.current.route??[]){let i=Math.floor(t.z/944)===e;(t.hop||!i)&&(r.length>1&&n.push({pts:r,closed:!1}),r=[]),i&&r.push({x:t.x,z:t.z%944})}r.length>1&&n.push({pts:r,closed:!1}),vt.extrude(n,t)},St=new od(a,5163519,.9,.3),Ct=null,wt=!1,Tt=-1,Et=()=>Ct?{x0:Math.min(Ct.x0,Ct.x1)-.5,x1:Math.max(Ct.x0,Ct.x1)+.5,z0:Math.min(Ct.z0,Ct.z1)-.5,z1:Math.max(Ct.z0,Ct.z1)+.5}:null,Dt=e=>{let t=Et();if(!t){St.extrude([],e);return}let{x0:n,x1:r,z0:i,z1:a}=t,o=2*(r-n+a-i)+4,s=Math.max(1,Math.ceil(o/512)),c=[];for(let e=n;e<r;e+=s)c.push({x:e,z:i});for(let e=i;e<a;e+=s)c.push({x:r,z:e});for(let e=r;e>n;e-=s)c.push({x:e,z:a});for(let e=a;e>i;e-=s)c.push({x:n,z:e});c.length<2&&c.push({x:n,z:i},{x:r,z:a}),St.extrude([{pts:c,closed:!0}],e)},Ot=[{kx:`x0`,kz:`z0`},{kx:`x1`,kz:`z0`},{kx:`x0`,kz:`z1`},{kx:`x1`,kz:`z1`},{kx:`x0`,kz:null},{kx:`x1`,kz:null},{kx:null,kz:`z0`},{kx:null,kz:`z1`}],kt=e=>`${e.kx}:${e.kz}`,At=new Map,jt=(e,t)=>({x:e.kx===`x0`?t.x0:e.kx===`x1`?t.x1:(t.x0+t.x1)/2,z:e.kz===`z0`?t.z0:e.kz===`z1`?t.z1:(t.z0+t.z1)/2}),Mt=[`ew-resize`,`nesw-resize`,`ns-resize`,`nwse-resize`],Nt=t=>{let n=Et(),r=B.current.areaSelect===!0;if(!(n!=null&&!ce&&!r)){for(let e of At.values())e.style.display=`none`;return}o.updateMatrixWorld();let i=e.clientWidth||800,a=e.clientHeight||600,s=t((n.x0+n.x1)/2,(n.z0+n.z1)/2).project(o),c=(s.x+1)/2*i,l=(1-s.y)/2*a;for(let e of Ot){let r=kt(e),s=At.get(r);s||(s=document.createElement(`div`),s.dataset.grip=r,s.style.cssText=`position:absolute;width:9px;height:9px;transform:translate(-50%,-50%);border-radius:2px;background:#4ec9ff;border:1px solid #0d1117;pointer-events:auto;z-index:906000;`,ct.appendChild(s),At.set(r,s));let u=jt(e,n),d=t(u.x,u.z).project(o);if(d.z>1||d.z<-1||d.x<-1.05||d.x>1.05||d.y<-1.05||d.y>1.05){s.style.display=`none`;continue}let f=(d.x+1)/2*i,p=(1-d.y)/2*a;s.style.display=``,s.style.left=`${f}px`,s.style.top=`${p}px`;let m=Math.atan2(l-p,f-c),h=(Math.round(m/(Math.PI/4))%4+4)%4;s.style.cursor=Mt[h]}},Pt=(e,t)=>{if(!Ct)return e;let{x0:n,x1:r,z0:i,z1:a}=Ct,{kx:o,kz:s}=e;return o===`x0`?n=t.x:o===`x1`&&(r=t.x),s===`z0`?i=t.z:s===`z1`&&(a=t.z),n>r&&([n,r]=[r,n],o&&=o===`x0`?`x1`:`x0`),i>a&&([i,a]=[a,i],s&&=s===`z0`?`z1`:`z0`),(n!==Ct.x0||r!==Ct.x1||i!==Ct.z0||a!==Ct.z1)&&(Ct={x0:n,x1:r,z0:i,z1:a},wt=!0,B.current.onAreaSelected?.({x0:n,x1:r,z0:i,z1:a})),{kx:o,kz:s}},Ft=null,It=``,Rt=null,zt=(e,t)=>!e||!t?(e??null)===(t??null):e.x0===t.x0&&e.x1===t.x1&&e.z0===t.z0&&e.z1===t.z1,Bt=new od(a,15246141,.7,.14),Vt,Ht=null,Ut=-1,Wt=(e,t)=>{let n=[],r=[],i=null;for(let t of z.current.trail??[]){if(i&&t.x===i.x&&t.z===i.z)continue;let a=Math.floor(t.z/944)===e;(i!=null&&Math.max(Math.abs(t.x-i.x),Math.abs(t.z-i.z))>5||!a)&&(r.length>1&&n.push({pts:r,closed:!1}),r=[]),a&&r.push({x:t.x,z:t.z%944}),i=t}r.length>1&&n.push({pts:r,closed:!1}),Bt.extrude(n,t)},Gt=new bu(a),Kt=new qu(a);lt.npcDims=e=>Gt.dims(e);let qt=!1,Jt=()=>{qt||lt.chatFont||(qt=!0,$u().then(e=>{Cr||(lt.chatFont=e)}).catch(()=>{qt=!1}))};Jt();let Yt=new Xu(a),Xt=new Td(a),Zt=!1,Qt=()=>{Zt||(Zt=!0,du().then(e=>{if(Cr||!e){Zt=!1;return}Gt.setAtlas(e)}))},$t=!1,en=()=>{$t||($t=!0,Ju().then(e=>{if(Cr||!e){$t=!1;return}Yt.setAtlas(e),lt.itemFrame=t=>{let n=e.frames.get(t);return n?{x:n.x,y:n.y,w:n.w,h:n.h,atlasW:e.width,atlasH:e.height}:null}}))},tn=null,nn=new Map,rn=new Map,an=new Map,on=new Map,sn=new Set,cn=new Set,ln=-1,un=(e,t,n)=>`${e}:${Math.floor((t-24)/48)},${Math.floor((n-24)/48)}`,dn=(e,t,n)=>`${e}:${t},${n}`,fn=new Map,pn=new Map,mn=e=>{let t=on.get(e);t&&(a.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),on.delete(e));let n=fn.get(e);if(n){for(let e of n)a.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});fn.delete(e)}let r=pn.get(e);if(r){for(let{group:e}of r)a.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});pn.delete(e)}},gn=e=>Gd(e.x,e.z),_n=e=>{let t=z.current.manifest;if(!tn||!t)return;mn(e);let n=nn.get(e)??[],r=parseInt(e.split(`:`)[0],10),i=[],o=new Set;for(let e of n){let t=dn(r,e.x,e.z);o.add(t);let n=an.get(t);n!==-1&&i.push({id:n??e.id,dir:e.dir,x:e.x,z:e.z})}for(let[t,n]of an){if(n<0)continue;let[a,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(a,10)!==r||o.has(t))continue;let[c,l]=s.split(`,`).map(Number);un(r,c,l)===e&&i.push({id:n,dir:0,x:c,z:l})}if(i.length===0)return;let s=t.botXTiles*128,c=ot(r),l=i.filter(e=>tn.anims.has(e.id)),u=i.filter(e=>e.id===Pd),d=i.filter(e=>!tn.anims.has(e.id)&&e.id!==Pd);if(d.length>0){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=r;for(let{tex:e,geometry:r}of tu(tn,d,s,c,gn))n.add(new ai(r,hr(e,t.baked)));n.visible=r===et,on.set(e,n),a.add(n)}if(l.length>0){let n=Math.max(...l.map(e=>tn.anims.get(e.id).length)),i=[];for(let e=0;e<n;e++){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=r;let o=l.map(t=>{let n=tn.anims.get(t.id);return{...t,model:n[e%n.length]}});for(let{tex:e,geometry:r}of tu(tn,o,s,c,gn))n.add(new ai(r,hr(e,t.baked)));n.visible=r===et&&e===0,i.push(n),a.add(n)}fn.set(e,i)}if(u.length>0){let n=[];for(let e of u){let i=nu(tn,e,s,c);if(!i)continue;let o=new hn;o.userData.kind=`scenery`,o.userData.plane=r,o.position.copy(i);for(let{tex:n,geometry:r}of tu(tn,[e],s,c,gn))r.translate(-i.x,-i.y,-i.z),o.add(new ai(r,hr(n,t.baked)));let l=e.dir*32*2*Math.PI/256,u=new J(-Math.cos(l),0,-Math.sin(l)).normalize();o.visible=r===et,n.push({group:o,axis:u}),a.add(o)}pn.set(e,n)}},vn=null,yn=new Map,bn=new Map,xn=new Map,Cn=new Map,Tn=(e,t,n,r)=>`${e}:${t},${n},${r}`,En=e=>{let t=Cn.get(e);t&&(a.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),Cn.delete(e))},Dn=e=>{let t=z.current.manifest;if(!vn||!t)return;En(e);let n=yn.get(e)??[],r=parseInt(e.split(`:`)[0],10),i=[],o=new Set;for(let e of n){let t=Tn(r,e.x,e.z,e.dir);o.add(t);let n=xn.get(t);n!==-1&&i.push(n==null?e:{...e,id:n})}for(let[t,n]of xn){if(n<0)continue;let[a,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(a,10)!==r||o.has(t))continue;let[c,l,u]=s.split(`,`).map(Number);un(r,c,l)===e&&i.push({id:n,x:c,z:l,floor:r,dir:u})}if(i.length===0)return;let s=t.botXTiles*128,c=new hn;c.userData.kind=`doors`,c.userData.plane=r;let l=ot(r),u=(e,t)=>l(e-.5,t-.5);for(let{tex:e,geometry:n}of uu(vn,i,s,u,e=>Kd(e.x,e.z,e.dir)))c.add(new ai(n,hr(e,t.baked)));c.visible=r===et,Cn.set(e,c),a.add(c)},On=!1,kn=()=>{vn||On||(On=!0,ru().then(e=>{if(On=!1,!(Cr||!e)){vn=e.defs;for(let t of e.boundaries){let e=un(t.floor,t.x,t.z),n=yn.get(e);n||yn.set(e,n=[]),n.push(t),bn.set(Tn(t.floor,t.x,t.z,t.dir),t)}for(let e of cn)sn.add(e)}}))},An=new _r;An.setAttribute(`position`,new X(new Float32Array(576),3));let jn=new Uint16Array(288);for(let e=0;e<48;e++)jn.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);An.setIndex(new X(jn,1)),An.setDrawRange(0,0);let Mn=new ai(An,new qr({color:16770140,transparent:!0,opacity:.28,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-3,polygonOffsetUnits:-3,side:2}));Mn.renderOrder=9,Mn.frustumCulled=!1,Mn.userData.noPick=!0,a.add(Mn);let Nn=e=>{let t=An.getAttribute(`position`),n=z.current.manifest;if(!n)return;let r=n.botXTiles*128,i=0;for(let n of e){if(i>=48)break;let e=(e,t)=>new J(r-e*128,at(e-.5,t-.5)+3,t*128),a=[e(n.x,n.z),e(n.x+1,n.z),e(n.x+1,n.z+1),e(n.x,n.z+1)];for(let e=0;e<4;e++)t.setXYZ(i*4+e,a[e].x,a[e].y,a[e].z);i++}t.needsUpdate=!0,An.setDrawRange(0,i*6)},Pn=null,Fn=``,In=new qr({color:16770140,transparent:!0,opacity:.4,blending:2,depthWrite:!1}),Ln=e=>{let t=e?`${e.id}:${e.ax},${e.az},${e.dir}`:``;if(t===Fn)return;Fn=t,Pn&&=(a.remove(Pn),Pn.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),null);let n=z.current.manifest;if(!e||!tn||!n)return;let r=new hn;for(let{geometry:t}of tu(tn,[{id:e.id,dir:e.dir,x:e.ax,z:e.az}],n.botXTiles*128,at)){let e=new ai(t,In);e.renderOrder=9,r.add(e)}r.userData.noPick=!0,Pn=r,a.add(r)},Rn=new Map,zn=(t,n,r,i)=>{let a=z.current,s=new Set;if(n&&r<=60){o.updateMatrixWorld();let n=e.clientWidth||800,r=e.clientHeight||600;for(let e of a.respawnGhosts){if(e.plane!==t)continue;let a=`${e.x},${e.z}`,c=i(e.x,e.z).project(o);if(c.z>1||c.z<-1||c.x<-1.05||c.x>1.05||c.y<-1.05||c.y>1.05)continue;s.add(a);let l=Rn.get(a);l||(l=document.createElement(`div`),l.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:rgba(196,200,208,.5);background:rgba(10,14,24,.25);padding:0 4px;border-radius:4px;pointer-events:none;white-space:nowrap;z-index:880000;`,ct.appendChild(l),Rn.set(a,l));let u=`${tn?.objects.get(e.id)?.name??e.id} · ${e.t}t`;l.textContent!==u&&(l.textContent=u),l.style.left=`${(c.x+1)/2*n}px`,l.style.top=`${(1-c.y)/2*r-26}px`}}for(let[e,t]of Rn)s.has(e)||(t.remove(),Rn.delete(e))},Bn=new Map,Vn=(t,n,r)=>{let i=B.current.cannons??[],a=new Set;if(i.length>0&&n<=200){o.updateMatrixWorld();let n=e.clientWidth||800,s=e.clientHeight||600;for(let e of i){if(Math.floor(e.z/944)!==t)continue;let i=`${e.x},${e.z}`,c=r(e.x,e.z%944).project(o);if(c.z>1||c.z<-1||c.x<-1.05||c.x>1.05||c.y<-1.05||c.y>1.05)continue;a.add(i);let l=Bn.get(i);l||(l=document.createElement(`div`),l.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:#f0c674;background:rgba(24,18,8,.55);padding:0 4px;border:1px solid rgba(240,198,116,.35);border-radius:4px;pointer-events:none;white-space:nowrap;z-index:880000;`,ct.appendChild(l),Bn.set(i,l));let u=`⚒ ${e.owner}`+(e.stage<4?` ${e.stage}/4`:``);l.textContent!==u&&(l.textContent=u),l.style.left=`${(c.x+1)/2*n}px`,l.style.top=`${(1-c.y)/2*s-26}px`}}for(let[e,t]of Bn)a.has(e)||(t.remove(),Bn.delete(e))},Hn=new Map,Un=(t,n)=>{let r=B.current.victims??[],i=new Set;if(r.length>0){o.updateMatrixWorld();let a=e.clientWidth||800,s=e.clientHeight||600;for(let e of r){if(Math.floor(e.z/944)!==t)continue;let r=e.name,c=n(e.x,e.z%944).project(o);if(c.z>1||c.z<-1||c.x<-1.05||c.x>1.05||c.y<-1.05||c.y>1.05)continue;i.add(r);let l=Hn.get(r);l||(l=document.createElement(`div`),l.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:#ff6b6b;background:rgba(40,8,8,.6);padding:0 4px;border:1px solid rgba(255,107,107,.45);border-radius:4px;pointer-events:none;white-space:nowrap;z-index:880001;`,ct.appendChild(l),Hn.set(r,l));let u=`☠ ${e.name}`;l.textContent!==u&&(l.textContent=u),l.style.left=`${(c.x+1)/2*a}px`,l.style.top=`${(1-c.y)/2*s-26}px`}}for(let[e,t]of Hn)i.has(e)||(t.remove(),Hn.delete(e))},Wn=new Ei({color:8315903,transparent:!0,opacity:.85}),Gn=[],Kn=new Map,qn=()=>{for(let e of Gn)a.remove(e),e.traverse(e=>{(e instanceof ai||e instanceof Pi)&&e.geometry.dispose()});Gn.length=0,Kn.clear();let e=z.current.manifest;if(B.current.layers?.transports===!1||!tn||!e)return;let t=Ld(z.current.floor).plane;for(let n of B.current.transports??[]){if(!n.anchor)continue;let r=he.get(`${t}:${n.anchor.x},${n.anchor.z}`),i=r?.find(e=>e.ax===n.anchor.x&&e.az===n.anchor.z)??r?.[0];if(!i)continue;Kn.set(`${i.ax},${i.az}`,n);let o=new hn;for(let{geometry:t}of tu(tn,[{id:i.id,dir:i.dir,x:i.ax,z:i.az}],e.botXTiles*128,at)){let e=new Yi(t,35);t.dispose();let n=new Ri(e,Wn);n.renderOrder=8,o.add(n)}o.userData.noPick=!0,Gn.push(o),a.add(o)}},Jn,Yn,Xn,Zn=-1,Qn=-1,$n=null,er=new od(a,8315903,.9,.25),tr=null,nr=-1,rr=e=>{let t=$n,n=[];for(let e of t?t.entries:[])n.push({closed:!0,pts:[{x:e.x-.5,z:e.z-.5},{x:e.x+.5,z:e.z-.5},{x:e.x+.5,z:e.z+.5},{x:e.x-.5,z:e.z+.5}]});er.extrude(n,e)},ir=null,ar=t=>{let n=$n,r=n?n.anchor??n.entries[0]:null;if(!n||!r){ir&&(ir.style.display=`none`);return}ir||(ir=document.createElement(`div`),ir.dataset.transport=`1`,ir.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:#7ee3ff;background:rgba(10,24,32,.8);padding:1px 5px;border:1px solid rgba(126,227,255,.5);border-radius:4px;pointer-events:auto;cursor:pointer;white-space:nowrap;z-index:905000;`,ct.appendChild(ir)),o.updateMatrixWorld();let i=t(r.x,r.z).project(o);if(i.z>1||i.z<-1||i.x<-1.05||i.x>1.05||i.y<-1.05||i.y>1.05){ir.style.display=`none`;return}let a=e.clientWidth||800,s=e.clientHeight||600,c=`⇋ ${n.name} → (${n.dx}, ${n.dz}) f${n.dfloor}`;ir.textContent!==c&&(ir.textContent=c,ir.title=(n.req?`requires ${n.req} — `:``)+`click to follow the transport`),ir.style.display=``,ir.style.left=`${(i.x+1)/2*a}px`,ir.style.top=`${(1-i.y)/2*s-24}px`},or=(e,t,n)=>{for(let r=0;r>=-4;r--)for(let i=0;i>=-4;i--){let a=rn.get(dn(e,t+r,n+i));if(!a)continue;let o=an.get(dn(e,a.x,a.z))??a.id,s=tn?.objects.get(o);if(!s)continue;let c=a.dir===0||a.dir===4?s.w:s.h,l=a.dir===0||a.dir===4?s.h:s.w;if(t>=a.x&&t<a.x+c&&n>=a.z&&n<a.z+l)return{type:`object`,id:o,name:s.name,ax:a.x,az:a.z,dir:a.dir,w:c,h:l}}return null},sr=(e,t,n,r,i,a)=>{let o=i-n,s=a-r,c=o*o+s*s,l=c===0?0:Math.max(0,Math.min(1,((e-n)*o+(t-r)*s)/c));return Math.hypot(e-(n+l*o),t-(r+l*s))},cr=(e,t,n)=>{if(!vn)return null;let r=Math.floor(t+.5),i=Math.floor(n+.5),a=null,o=.3;for(let s=-1;s<=1;s++)for(let c=-1;c<=1;c++){let l=r+s,u=i+c;for(let r=0;r<4;r++){let i=Tn(e,l,u,r),s=xn.get(i)??bn.get(i)?.id;if(s==null)continue;let c=vn.get(s);if(!c||c.height<=0)continue;let d=l-.5,f=u-.5,[p,m,h,g]=r===0?[d,f,d+1,f]:r===1?[d,f,d,f+1]:r===2?[d+1,f,d,f+1]:[d,f,d+1,f+1],_=sr(t,n,p,m,h,g);_<o&&(o=_,a={type:`wall`,id:s,name:c.name,x:l,z:u,dir:r})}}return a},lr=(e,t)=>{if(!tn||!te(e,t))return null;let n=T[3];if(n<8||n>15)return null;let r=T[0]|T[1]<<8|T[2]<<16|n<<24,i=r>>12&4095,a=r&4095,o=Ld(z.current.floor).plane;if((r>>26&1)==1){let e=r>>24&3,t=Tn(o,i,a,e),n=xn.get(t)??bn.get(t)?.id,s=n==null?void 0:vn?.get(n);return s?{type:`wall`,id:n,name:s.name,x:i,z:a,dir:e}:null}return or(o,i,a)},ur=(e,t,n=!1)=>{let r=z.current.manifest;if(!r)return null;let a=r.botXTiles*128,s=o.position,c=new J(-Math.cos(f)*Math.sin(u),-Math.sin(f),-Math.cos(f)*Math.cos(u)),l=(e,t,n)=>(e-s.x)*c.x+(t-s.y)*c.y+(n-s.z)*c.z,d=null,p=1/0,m=null,h=1/0;{let n=i.domElement.getBoundingClientRect();if(n.width&&n.height){let r=e-n.left,i=t-n.top,s=n.width/(o.right-o.left);for(let e of lt.current()){let t=a-(e.x*128+64),c=at(e.x,e.z),u=e.z*128+64,f=new J(t,c,u).project(o),g=e.kind===`npc`&&e.npcId!=null?Gt.dims(e.npcId):null,_=g?Math.max(56,g.w):90,v=g?Math.max(70,g.h):230,y=e.dir===8||e.dir===9,b=e.dir===8?-30:e.dir===9?30:0,x=(_/2+(y?15:0))*s,S=v*s,C=(f.x+1)/2*n.width+b*s,w=(1-f.y)/2*n.height,T=g?g.h:e.appearance?220:130,E=Math.min(w-S,w-T*s-12),D=w+10,O=(E+D)/2,k=(D-E)/2,A=(r-C)/x,j=(i-O)/k;if(A*A+j*j>1)continue;let M=l(t,c+Math.max(0,Math.min(1,(w-i)/S))*v,u);e.kind===`bot`?M<p&&(p=M,d=e):M<h&&(h=M,m=e)}}}let g=ne(e,t)??ie(e,t);if(!g)return{bot:d,ent:m,ground:[],wall:null,obj:null,tile:null,entDepth:null,objDepth:null};let _=l(g.x,g.y,g.z),v=(a-g.x)/128-.5,y=g.z/128-.5;if(!d&&!m){let e=lt.nearestEntity(v,y,.6);e&&(e.kind===`bot`?d=e:(m=e,h=l(a-(e.x*128+64),at(e.x,e.z),e.z*128+64)))}let b=(e,t)=>{let r=Math.floor(e+.5);return!n||t===null?r:e>=t-.5-Id&&e<=t+.5+Id?t:r},x=b(v,n?xe:null),S=b(y,n?Se:null);n&&(xe=x,Se=S);let C=[];for(let e of z.current.groundItems){let t=Math.hypot(e.x-v,e.z-y);t<.7&&C.push({g:e,d:t})}C.sort((e,t)=>e.d-t.d);let w=Ld(z.current.floor).plane,T=lr(e,t),E=null,D=null;if(T)T.type===`wall`?E=T:D=T;else if(!tn)E=cr(w,v,y),D=or(w,x,S);else{let e=or(w,x,S);e&&e.type===`object`&&(e.ax>=4096||e.az>=4096)&&(D=e)}return{bot:d,ent:m,ground:C.map(e=>e.g),wall:E,obj:D,tile:{x,z:S},entDepth:m?h:null,objDepth:_}};window.__w3dResolve=(e,t)=>dr(e,t);let dr=(e,t,n=!1)=>{let r=ur(e,t,n);if(!r)return null;if(r.bot)return{type:`entity`,...r.bot};let i=r.wall??r.obj;if(r.ent)return i&&r.objDepth!=null&&r.entDepth!=null&&r.objDepth<r.entDepth?i:{type:`entity`,...r.ent};if(r.ground.length>0){let e=r.ground[0];return{type:`grounditem`,id:e.id,name:e.name,x:e.x,z:e.z}}return i||(r.tile?{type:`tile`,x:r.tile.x,z:r.tile.z}:null)},fr=e=>{if(lt.hoverKey=e?.type===`entity`?e.key:null,Gt.highlightKey=e?.type===`entity`&&e.kind===`npc`?e.key:null,Kt.highlightKey=e?.type===`entity`&&(e.kind===`bot`||e.kind===`player`)?e.key:null,e?.type===`object`){Ln(e);let t=[];for(let n=0;n<e.w;n++)for(let r=0;r<e.h;r++)t.push({x:e.ax+n,z:e.az+r});$n=Kn.get(`${e.ax},${e.az}`)??null,Nn(t)}else ir&&ir.matches(`:hover`)||($n=null),Ln(null),e?.type===`entity`||e?.type===`grounditem`?Nn([{x:Math.round(e.x),z:Math.round(e.z)}]):e?.type===`wall`||e?.type===`tile`?Nn([{x:e.x,z:e.z}]):Nn([]);ze.style.cursor=Ft?It:e?.type===`entity`||e?.type===`object`||e?.type===`wall`?`pointer`:``},pr=new Map,mr=new Aa,hr=(e,t)=>{let n=pr.get(e);if(n)return n;let r={map:{value:null},textured:{value:e>=0},vScroll:{value:0},pickMode:{value:0}};if(e>=0){let n=mr.load(Ol(e,t));n.magFilter=m,n.minFilter=m,n.wrapS=d,n.wrapT=d,n.flipY=!1,r.map.value=n}return n=new sa({glslVersion:Je,vertexShader:Hd,fragmentShader:Ud,uniforms:r,side:2}),pr.set(e,n),n},gr=-1;window.__w3dAnim=()=>({cells:fn.size,anims:tn?tn.anims.size:-1,visible:[...fn.values()].map(e=>e.map(e=>+!!e.visible).join(``))}),window.__w3dSel=()=>({selectedEntityKey:lt.selectedEntityKey,hoverKey:lt.hoverKey,propSelected:B.current.selectedBot??null}),window.__w3dWindmills=()=>{let e=[];for(let[,t]of pn)for(let{group:n}of t)e.push({plane:n.userData.plane,visible:n.visible,quat:[n.quaternion.x,n.quaternion.y,n.quaternion.z,n.quaternion.w]});return e},window.__w3dPlanes=()=>{let e=0,t=0,n=n=>{n.userData.plane!==et&&(t++,n.visible&&e++)};for(let[,e]of on)n(e);for(let[,e]of Cn)n(e);for(let[,e]of fn)e.forEach(n);for(let[,e]of vr)n(e);return{activePlane:et,retained:t,wrongVisible:e,loaded:vr.size,scenery:on.size}};let vr=new Map,yr=new Set,br=[],xr=null,Sr=()=>{let e=z.current,t=e.manifest;if(!t)return;let n=t.botXTiles*128,{plane:r,kinds:i}=Ld(e.floor);if(xr!==e.floor){xr=e.floor,et=r;let a=(n-s.x)/128,o=s.z/128;br=[];for(let e of t.cells)if(e.plane===r)for(let n of i){if(!e.kinds.includes(n))continue;let r=`p${e.plane}_${e.a}_${e.b}_${n}`;if(vr.has(r)||yr.has(r))continue;let i=e.botX0+t.cellTiles/2,s=e.botZ0+t.cellTiles/2;br.push({cell:e,kind:n,key:r,d:Math.hypot(i-a,s-o)})}br.sort((e,t)=>e.d-t.d)}for(;yr.size<24&&br.length>0;){let{cell:e,kind:r,key:i}=br.shift();vr.has(i)||yr.has(i)||(yr.add(i),fetch(Dl(e,r,t.baked)).then(e=>{if(!e.ok)throw Error(`${e.status}`);return e.arrayBuffer()}).then(o=>{let s=new hn;s.userData.kind=r,s.userData.plane=e.plane;let c=$e(e.plane),l=r===`terrain`?(e,t,n)=>tt(c,e,t,n):void 0;for(let{tex:r,geometry:i}of qd(o,n,e.botX0,e.botZ0,l))s.add(new ai(i,hr(r,t.baked)));if(s.visible=e.plane===et,vr.set(i,s),a.add(s),r===`terrain`){Ye++,Xe=performance.now();let t=un(e.plane,e.botX0,e.botZ0);cn.add(t),sn.add(t)}}).catch(()=>{}).finally(()=>{yr.delete(i),br.length>0&&setTimeout(Sr,0)}))}for(let[,e]of vr){let t=Nd.has(e.userData.kind)&&!z.current.roofs;e.visible=e.userData.plane===r&&!t}for(let[,e]of on)e.visible=e.userData.plane===r;for(let[,e]of Cn)e.visible=e.userData.plane===r;for(let[,e]of fn)if(e.length>0&&e[0].userData.plane!==r)for(let t of e)t.visible=!1;for(let[,e]of pn)for(let{group:t}of e)t.visible=t.userData.plane===r;if(e.observedRev!==ln&&tn){ln=e.observedRev;let t=e=>{let[t,n]=[e.split(`:`)[0],e.split(`:`)[1]],[r,i]=n.split(`,`).map(Number);sn.add(un(parseInt(t,10),r,i))};if(vn){let n=new Map;for(let t of e.observedDoors){let e=Tn(t.plane,t.x,t.z,t.dir),r=bn.get(e);(!r||r.id!==t.id)&&n.set(e,t.id)}for(let[e,r]of n)xn.get(e)!==r&&(xn.set(e,r),t(e));for(let e of[...xn.keys()])n.has(e)||(xn.delete(e),t(e))}let n=new Map;for(let t of e.observed){let e=dn(t.plane,t.x,t.z),r=rn.get(e);(!r||r.id!==t.id)&&n.set(e,t.id)}for(let[e,r]of n)an.get(e)!==r&&(an.set(e,r),t(e));for(let e of[...an.keys()])n.has(e)||(an.delete(e),t(e))}if(tn){let e=0;for(let t of sn){if(e++>=8)break;sn.delete(t),cn.has(t)&&(_n(t),Dn(t))}}y();let o=vr.size+yr.size+br.length;w(yr.size+br.length>0?`loading ${vr.size}/${o} cells…`:``)},Cr=!1,wr=!1,Tr=e=>{tn||wr||(wr=!0,$l.fetch(e).then(e=>{if(wr=!1,!(Cr||!e)){tn=e;for(let e of cn)sn.add(e)}}))};El().then(e=>{if(Cr)return;z.current.manifest=e,Tr(e.baked),kn(),Qt(),en();let t=e.botXTiles*128;_=Math.max(e.botXTiles,e.botZTiles)*128;let n=z.current.focusBot,r=l(fe.get(`x`))??n.x,i=l(fe.get(`z`))??n.z,a=t-r*128,o=i*128;s.set(a,0,o),b(),w(``),Sr()}).catch(e=>w(`world mesh not ready (${e.message??e}) — retrying…`));let Er=setInterval(()=>{z.current.manifest?(tn||Tr(z.current.manifest.baked),kn(),Qt(),en(),Jt()):El().then(e=>{z.current.manifest=e,w(``),Sr()}).catch(()=>{})},5e3),Dr=Rd.map(e=>({...e})),Or=Dr.length,kr=[];for(let e=0;e<Or;e++){let t=Dr[(e+1)%Or].yaw-Dr[e].yaw;t=((t+180)%360+360)%360-180,kr.push(t)}let Ar=kr.reduce((e,t)=>e+t,0),jr=[Dr[0].yaw];for(let e=0;e<Or;e++)jr.push(jr[e]+kr[e]);let Mr=e=>{let t=Math.floor(e/Or),n=(e%Or+Or)%Or;return jr[n]+t*Ar},Nr=[];for(let e=0;e<Or;e++)Nr.push(Dr[(e+1)%Or].sec??6);let Pr=[0];for(let e=0;e<Or;e++)Pr.push(Pr[e]+Nr[e]);let Fr=Pr[Or],Ir=e=>Nr[(e%Or+Or)%Or]+Nr[((e-1)%Or+Or)%Or],Lr=e=>{let t=z.current.manifest;if(!t)return;let n=Fr>0?(e%Fr+Fr)%Fr:0,r=0;for(;r<Or-1&&n>=Pr[r+1];)r++;let i=(n-Pr[r])/Math.max(1e-6,Nr[r]),a=e=>Dr[(e%Or+Or)%Or],o=e=>{let t=(e(a(r+1))-e(a(r-1)))/Ir(r),n=(e(a(r+2))-e(a(r)))/Ir(r+1);return Vd(e(a(r)),t,e(a(r+1)),n,Nr[r],i)},c=(Mr(r+1)-Mr(r-1))/Ir(r),l=(Mr(r+2)-Mr(r))/Ir(r+1),d=Vd(Mr(r),c,Mr(r+1),l,Nr[r],i),m=t.botXTiles*128;s.set(m-o(e=>e.x)*128,0,o(e=>e.z)*128),u=d*Math.PI/180,f=Math.max(p,Math.min(h,o(e=>e.pitch)*Math.PI/180)),V=Math.exp(o(e=>Math.log(e.zoom*128))),pe(),b()},Rr=0,zr=0,Br=null,Vr=0,Hr=t=>{if(Vr=requestAnimationFrame(Hr),B.current.visible===!1)return;let n=z.current;if(n.manifest){dt.visible=n.sight,lt.showPlates=n.tags;let r=n.entitiesRev!==ut;r&&(ut=n.entitiesRev,lt.update(n.entities,t,B.current.scrubbing===!0));let i=n.manifest.botXTiles*128,a=(e,t)=>new J(i-(e*128+64),at(e,t),t*128+64);r&&dt.update(n.entities.filter(e=>e.kind===`bot`),a);let c=t-Xe>=250||t-Ze>=2e3;c&&(Ze=t),(n.route!==yt||n.floor!==Y||c&&Ye!==bt)&&(yt=n.route,Y=n.floor,bt=Ye,xt(Ld(n.floor).plane,a)),(n.trail!==Vt||n.floor!==Ht||c&&Ye!==Ut)&&(Vt=n.trail,Ht=n.floor,Ut=Ye,Wt(Ld(n.floor).plane,a));let l=B.current.areaRect;l!==void 0&&!zt(l,Rt)&&(Rt=l?{...l}:null,!ce&&!Ft&&(Ct=l?{...l}:null,wt=!0)),(wt||c&&Ye!==Tt)&&(wt=!1,Tt=Ye,Dt(a)),Nt(a),zn(Ld(n.floor).plane,n.tags,V/128,a),Vn(Ld(n.floor).plane,V/128,a),Un(Ld(n.floor).plane,a);{let t=B.current.layers?.wilderness!==!1;ft.visible=t;let r=bd((e.clientHeight||600)/(V/128));t&&(r!==pt||n.floor!==mt||c&&Ye!==ht)&&(pt=r,mt=n.floor,ht=Ye,ft.rebuild(r,a)),ft.frameLabels(t,o,e.clientWidth||800,e.clientHeight||600,a)}{let e=B.current.layers?.transports!==!1;(B.current.transports!==Jn||e!==Yn||n.floor!==Xn||c&&(Ye!==Zn||he.size!==Qn))&&(Jn=B.current.transports,Yn=e,Xn=n.floor,Zn=Ye,Qn=he.size,$n=null,qn())}ar(a),($n!==tr||c&&Ye!==nr)&&(tr=$n,nr=Ye,rr(a));let d=pr.get(17);d&&(d.uniforms.vScroll.value=-(t/1280%1));let p=B.current.follow;if(p&&!P.current){p!==Br&&(Br=p,zr=0);let e=lt.current().find(e=>e.key===`bot:${p}`);if(e){let n=a(e.x,e.z),r=zr?Math.min(.1,(t-zr)/1e3):0,i=r>0?1-Math.exp(-r/.12):1;s.x+=(n.x-s.x)*i,s.y=0,s.z+=(n.z-s.z)*i,b()}zr=t}else zr=0;if(ae.current.length>0){let e=new Map,n=new Map;for(let t of lt.current()){e.set(t.key,{x:t.x,z:t.z});let r=t.kind===`npc`&&t.npcId!=null?Gt.dims(t.npcId):null;n.set(t.key,(r?r.h:t.appearance?220:130)/2)}Xt.frame(t,ae.current,t=>e.get(t)??null,a,e=>n.get(e)??60)}else Xt.frame(t,[],()=>null,a,()=>60);let m=Math.floor(t/120);if(m!==gr){gr=m;for(let[,e]of fn){let t=e.length>0&&e[0].userData.plane===et;for(let n=0;n<e.length;n++)e[n].visible=t&&n===m%e.length}}let h=t/Fd*Math.PI*2;for(let[,e]of pn)for(let{group:t,axis:n}of e)t.visible&&t.quaternion.setFromAxisAngle(n,h);lt.frame(t,a,st,o,e.clientWidth||800,e.clientHeight||600,V/128);let{right:g,up:_}=x(),v=new J(Math.cos(f)*Math.sin(u),Math.sin(f),Math.cos(f)*Math.cos(u)),y=g.multiplyScalar(-1),S=160*Math.sin(f);Gt.frame(t,lt.snapshot(`npc`,t),a,y,_,u,v,S),Kt.frame(t,[...lt.snapshot(`bot`,t),...lt.snapshot(`player`,t)],a,y,_,u,v,S),Yt.frame(n.groundItems,a,y,_,v,S)}let r=P.current;if(r){let e=(t-r.start)/1e3;Lr(e),e>=Fr&&(P.current=null,ee(!1))}if(t-Rr>250&&(Rr=t,Sr()),a.updateMatrixWorld(),N(),ye&&A&&(ye=!1,Te(A.x,A.y)),ge){let e=ge;ge=null,e.kind===`canvas`?(_e={x:e.x,y:e.y},ve=!0):(_e=null,ve=!1,e.kind===`plate`?Ee(e.key):we(null))}i.render(a,o),ve&&_e&&(ve=!1,M(_e.x,_e.y)&&(ye=!0))};async function Ur(e){if(n)return;n=!0,cancelAnimationFrame(Vr);let t;try{t=await Il()}catch(e){console.error(`[capture] no output folder — aborting.`,e),n=!1,Vr=requestAnimationFrame(Hr);return}r=e,pe();let a=i.domElement,o=new zl(F);P.current={start:o.now()},ee(!0),requestAnimationFrame(Hr);let s=Math.max(1,Math.round(Fr*F)),c=0;try{for(;c<s;c++)o.tick(),await o.yieldMacrotask(),await Rl(t,c,await Ll(a))}finally{P.current=null,ee(!1),o.uninstall(),n=!1,r=null,pe(),Vr=requestAnimationFrame(Hr)}console.info(`[capture] wrote ${c} frames @ ${F}fps. Encode e.g.:\n  ffmpeg -framerate ${F} -i %06d.png -c:v libwebp -loop 0 -lossless 0 -q:v 75 -fps_mode passthrough flyby.webp`)}return I.current=Ur,Vr=requestAnimationFrame(Hr),pe(),b(),()=>{Cr=!0,document.removeEventListener(`pointerlockchange`,je),document.removeEventListener(`pointerlockerror`,Me),document.pointerLockElement===e&&document.exitPointerLock(),se.current=null,I.current=null;for(let e of[...on.keys(),...fn.keys(),...pn.keys()])mn(e);for(let e of[...Cn.keys()])En(e);dt.dispose(a),ft.dispose(),vt.dispose(a),Bt.dispose(a),St.dispose(a),Xt.dispose();for(let[,e]of Rn)e.remove();Rn.clear();for(let e of Gn)a.remove(e),e.traverse(e=>{(e instanceof ai||e instanceof Pi)&&e.geometry.dispose()});Wn.dispose(),er.dispose(a),ir?.remove();for(let e of At.values())e.remove();At.clear(),Gt.dispose(a),Kt.dispose(),Yt.dispose(a),lt.dispose(a),ct.remove(),v&&clearTimeout(v),clearInterval(Er),cancelAnimationFrame(Vr),me.disconnect();for(let[,e]of vr)e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});for(let[,e]of pr)(e.uniforms.map?.value)?.dispose(),e.dispose();C.dispose(),i.dispose(),e.removeChild(i.domElement)}},[]),(0,$.jsxs)(`div`,{style:{position:`relative`,width:`100%`,height:`100%`},children:[(0,$.jsx)(`div`,{ref:t,style:{position:`absolute`,inset:0,overflow:`hidden`}}),(0,$.jsxs)(`div`,{style:{position:`absolute`,top:8,left:8,display:`flex`,gap:6,zIndex:1e6,background:`rgba(16,16,26,.8)`,padding:`6px 8px`,borderRadius:6,alignItems:`center`,fontSize:13,userSelect:`none`},children:[!i&&kd.map(e=>(0,$.jsx)(`button`,{className:o===e.key?`active`:``,onClick:()=>s(Ad.indexOf(e.key)),children:e.label},e.key)),!i&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:_,onChange:e=>b(e.target.checked)}),`roofs`]}),!e.hideSight&&(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:v,onChange:e=>x(e.target.checked)}),`sight`]}),(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:y,onChange:e=>S(e.target.checked)}),`tags`]}),e.extraToggles,F>0&&!N&&(0,$.jsx)(`input`,{type:`text`,value:te,onChange:e=>ne(e.target.value),placeholder:`${window.innerWidth}x${window.innerHeight} (blank = window)`,title:`Recording resolution WxH (blank = live canvas size)`,style:{marginLeft:8,width:150,padding:`2px 6px`,font:`inherit`}}),(0,$.jsx)(`button`,{style:{marginLeft:8},onClick:()=>{if(F>0){if(N)return;let e;try{e=Bd(te)}catch(e){alert(String(e instanceof Error?e.message:e));return}I.current?.(e);return}P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0))},children:F>0?N?`● Recording ${F}fps…`:`● Record flyby`:N?`Stop`:`Fly`})]}),C&&(0,$.jsx)(`span`,{style:{marginLeft:8,opacity:.8},children:C})]}),L&&(0,$.jsxs)(`div`,{style:{position:`absolute`,left:Math.max(0,L.x-4),top:Math.max(0,L.y-8),zIndex:2e6,background:`rgba(208,208,208,0.63)`,padding:`2px 6px 4px 4px`,font:`bold 12px sans-serif`,whiteSpace:`nowrap`,userSelect:`none`},onPointerDown:e=>e.stopPropagation(),children:[(0,$.jsx)(`div`,{style:{color:`#0ff`,textShadow:`1px 0 #000, 0 1px #000`},children:`Choose option`}),L.entries.map((e,t)=>(0,$.jsxs)(`div`,{style:{textShadow:`1px 0 #000, 0 1px #000`,cursor:`pointer`,lineHeight:`15px`},onMouseEnter:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#ff0`)},onMouseLeave:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#fff`)},onClick:()=>{e.run?.(),R(null)},children:[(0,$.jsx)(`span`,{"data-verb":!0,style:{color:`#fff`},children:e.verb}),e.target&&(0,$.jsxs)(`span`,{style:{color:e.tcolor??`#fff`},children:[` `,e.target]}),e.suffix&&(0,$.jsx)(`span`,{style:{color:e.scolor??`#fff`},children:e.suffix})]},t))]}),T&&(0,$.jsx)(`div`,{style:{position:`absolute`,bottom:8,left:8,background:`rgba(16,16,26,.85)`,padding:`4px 10px`,borderRadius:6,fontSize:13,fontFamily:`monospace`,pointerEvents:`none`},children:T}),D&&(0,$.jsxs)(`div`,{style:{position:`absolute`,bottom:8,right:8,minWidth:180,background:`rgba(16,16,26,.92)`,padding:`8px 12px`,borderRadius:8,fontSize:13,fontFamily:`monospace`,border:`1px solid #3a4664`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,gap:12},children:[(0,$.jsx)(`b`,{children:D.name??D.key}),(0,$.jsx)(`span`,{style:{cursor:`pointer`,opacity:.7},onClick:()=>O(null),children:`✕`})]}),(0,$.jsxs)(`div`,{style:{opacity:.85,marginTop:4},children:[D.kind,D.npcId==null?``:` · id ${D.npcId}`,D.inCombat?` · in combat`:``]}),D.appearance&&(0,$.jsxs)(`div`,{style:{marginTop:6,borderTop:`1px solid #3a4664`,paddingTop:6,maxWidth:260},children:[Od(D.appearance,k).map(e=>(0,$.jsxs)(`div`,{style:{display:`flex`,gap:8,lineHeight:`18px`},children:[(0,$.jsx)(`span`,{style:{opacity:.55,width:52,flexShrink:0},children:e.slot}),(0,$.jsx)(`span`,{children:e.names})]},e.slot)),Od(D.appearance,k).length===0&&(0,$.jsx)(`div`,{style:{opacity:.55},children:`nothing equipped`})]})]})]})}function Yd(e){let t=e.d.length,n=new Int16Array(t*2),r=e.x,i=e.z;n[0]=r,n[1]=i;for(let a=1;a<t;a++){let t=e.d.charCodeAt(a-1)-48;r+=Math.floor(t/3)-1,i+=t%3-1,n[a*2]=r,n[a*2+1]=i}return n}var Xd=[];function Zd({data:e}){let t=(0,l.useMemo)(()=>({npcs:e.npcs.map(e=>({si:e.si,id:e.id??0,pos:Yd(e),n:e.d.length})),players:e.players.map(e=>({si:e.si,a:e.a??``,pos:Yd(e),n:e.d.length}))}),[e]),n=(0,l.useRef)(0),[r,i]=(0,l.useState)(0),[a,o]=(0,l.useState)(!0);return(0,l.useEffect)(()=>{if(!a)return;let t=0,r=a=>{n.current||=a,i(Math.floor((a-n.current)/e.tickMs)),t=requestAnimationFrame(r)};return t=requestAnimationFrame(r),()=>cancelAnimationFrame(t)},[e.tickMs,a]),(0,$.jsx)(`div`,{style:{width:`100vw`,height:`100vh`},children:(0,$.jsx)(Jd,{observers:(0,l.useMemo)(()=>{if(!a)return Xd;let n=t.npcs.map(t=>{let n=r%t.n*2;return{serverIndex:t.si,id:t.id,name:e.names[t.id]??null,x:t.pos[n],z:t.pos[n+1],inCombat:!1}}),i=t.players.map(e=>{let t=r%e.n*2;return{serverIndex:e.si,id:0,name:null,x:e.pos[t],z:e.pos[t+1],inCombat:!1,appearance:e.a}});return[{username:`demo`,status:`online`,scriptClass:null,description:null,serverTick:r,position:null,fatiguePercent:0,sleeping:!1,inCombat:!1,npcs:n,players:i}]},[t,r,a,e.names]),focus:{x:122,z:650},hideSight:!0,extraToggles:(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:a,onChange:e=>o(e.target.checked)}),`simulation`]})})})}function Qd(){let[e,t]=(0,l.useState)(null),[n,r]=(0,l.useState)(null);return(0,l.useEffect)(()=>{fetch(Tl(`/api/demo/entities.json`)).then(e=>e.ok?e.json():Promise.reject(Error(`${e.status}`))).then(t).catch(e=>r(String(e)))},[]),n?(0,$.jsx)(`div`,{style:{width:`100vw`,height:`100vh`},children:(0,$.jsx)(Jd,{observers:[],focus:{x:122,z:650}})}):e?(0,$.jsx)(Zd,{data:e}):(0,$.jsx)(`div`,{style:{padding:16},children:`Loading world…`})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(Qd,{}));
//# sourceMappingURL=index-q9yQyitJ.js.map