...
import openrsc.gamedata.defs.extras.FishingDefs;
import openrsc.gamedata.defs.extras.SmeltingDefs;
...
public final class ServerDataImpl implements ServerData {
  ...
  @Override
  public Spell spell(int spellId) {
    var d = defs.spells().get(spellId);
    return d == null ? null : new Spell(d.id(), d.name(), d.requiredLevel());
  }
