...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function go(e,t,n){let r=new Float32Array(to),i=new J(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:to,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(){return new Vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(){return new Vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yo(),fragmentShader:`
	...
	`}var bo=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,Hu=1<<27,Uu=(e,t)=>e>=0&&e<4096&&t>=0&&t<4096?Hu|e<<12|t:0,Wu=(e,t,n)=>e>=0&&e<4096&&t>=0&&t<4096?201326592|(n&3)<<24|e<<12|t:0;function Gu(e,t,n,r,i){let a=new DataView(e);if(a.getUint32(0)!==1381188403)throw Error(`bad cell magic`);let o=n*128,s=r*128,c=a.getUint16(16),l=18,u=[];for(let d=0;d<c;d++){let c=a.getInt16(l),d=a.getInt32(l+2);l+=6;let f=new Float32Array(d*3);for(let e=0;e<d;e++){let c=a.getInt16(l),u=c+o,d=a.getInt16(l+2),p=a.getInt16(l+4),m=p+s;l+=6,i&&c%128==0&&p%128==0&&i(n+c/128,r+p/128,-d),f[e*3]=t-u,f[e*3+1]=-d,f[e*3+2]=m}let p=new Uint8Array(e,l,d);l+=d;let m=new Uint8Array(e,l,d*3);l+=d*3;let h=null;if(c>=0){h=new Float32Array(d*2);for(let e=0;e<d*2;e++)h[e]=a.getInt16(l)/512,l+=2}let g=new _r;g.setAttribute(`position`,new X(f,3)),g.setAttribute(`shade`,new X(new Float32Array(p),1)),g.setAttribute(`base`,new X(new Uint8Array(m),3,!0)),h&&g.setAttribute(`uv`,new X(h,2)),u.push({tex:c,geometry:g})}return u}function Ku(e){let t=(0,l.useRef)(null),n=()=>{let e=new URLSearchParams(location.search).get(`floor`);return Mu.some(t=>t.key===e)?e:`ground`},[r,i]=(0,l.useState)(n),a=e.overlays!=null,o=e.floorIndex==null?r:Mu[Math.max(0,Math.min(3,e.floorIndex))].key,s=t=>{e.onFloorIndexChange?e.onFloorIndexChange(Mu.findIndex(e=>e.key===t)):i(t)};(0,l.useEffect)(()=>{if(e.floorIndex!=null){let t=n();t!==Mu[e.floorIndex]?.key&&e.onFloorIndexChange?.(Mu.findIndex(e=>e.key===t))}},[]);let[c,u]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`roofs`)!==`0`),[f,p]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`sight`)!==`0`),[h,g]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`tags`)!==`0`),_=e.overlays?.roofs??c,v=e.overlays?.sight??f,y=e.overlays?.tags??h,b=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:t,sight:v,tags:y}):u(t),x=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:t,tags:y}):p(t),S=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:v,tags:t}):g(t),[C,w]=(0,l.useState)(`loading manifest…`),[T,E]=(0,l.useState)(``),[D,O]=(0,l.useState)(null),[k,A]=(0,l.useState)(null);(0,l.useEffect)(()=>{dl().then(A).catch(()=>{})},[]);let[j,M]=(0,l.useState)([]);(0,l.useEffect)(()=>{let e=!1,t=()=>ul().then(t=>{e||M(t)}).catch(()=>{e||setTimeout(t,5e3)});return t(),()=>{e=!0}},[]);let[N,ee]=(0,l.useState)(!1),P=(0,l.useRef)(null),F=(0,l.useRef)(new Set),I=(0,l.useRef)([]),[te,ne]=(0,l.useState)(null),re=(0,l.useRef)(!1);re.current=te!=null;let ie=(0,l.useRef)(null);(0,l.useEffect)(()=>{e.onFlyingChange?.(N)},[N]);let ae=(0,l.useRef)(e.flyNonce??0);(0,l.useEffect)(()=>{e.flyNonce==null||e.flyNonce===ae.current||(ae.current=e.flyNonce,P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0)))},[e.flyNonce]),(0,l.useEffect)(()=>{if(!e.follow)return;let t=(e.bots??[]).find(t=>t.username===e.follow)?.position?.floor;t!=null&&Mu[t]&&Mu[t].key!==o&&s(Mu[t].key)},[e.follow,e.bots]),(0,l.useEffect)(()=>{if(e.visible===!1)return;let t=setTimeout(()=>ie.current?.(),60);return()=>clearTimeout(t)},[e.visible]);let L=(0,l.useRef)({manifest:null,floor:`ground`,roofs:!0,sight:!0,tags:!0,focusBot:e.focus??{x:120,z:640},entities:[],entitiesRev:0,groundItems:[],observed:[],observedDoors:[],observedRev:0,respawnGhosts:[],route:null}),R=(0,l.useRef)(e);R.current=e,L.current.floor=o,L.current.roofs=_,L.current.sight=v,L.current.tags=y,L.current.route=e.route??null,e.focus&&(L.current.focusBot=e.focus);{let t=Lu(o).plane,n=[],r=new Map,i=new Map,a=(e,t)=>{t.msg!=null&&t.msgTick!=null&&(e.msgTick==null||t.msgTick>e.msgTick)&&(e.msg=t.msg,e.msgTick=t.msgTick)},s=new Set;for(let t of e.bots??[])t.serverIndex!=null&&s.add(t.serverIndex);for(let o of e.bots??[]){let c=o.position;c&&c.floor===t&&n.push({key:`bot:${o.username}`,kind:`bot`,x:c.x,z:c.z-c.floor*944,name:o.username,selected:o.username===e.selectedBot,inCombat:o.inCombat??!1,appearance:o.appearance,dir:o.dir,hp:o.hits,maxHp:o.maxHits,dmg:o.dmg,dmgTick:o.dmg==null?null:o.serverTick,msg:o.msg,msgTick:o.msgTick,bubble:o.bubble,bubbleTick:o.bubbleTick,sleeping:o.sleeping});for(let e of o.npcs??[]){if(Math.floor(e.z/944)!==t)continue;let i=r.get(e.serverIndex);if(i){a(i,e);continue}let o={key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,npcId:e.id,dir:e.dir,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick};r.set(e.serverIndex,o),n.push(o)}for(let e of o.players??[]){if(Math.floor(e.z/944)!==t||s.has(e.serverIndex))continue;let r=i.get(e.serverIndex);if(r){a(r,e);continue}let o={key:`pl:${e.serverIndex}`,kind:`player`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,appearance:e.appearance,dir:e.dir,combatLvl:e.combatLvl,skulled:e.skulled,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,bubble:e.bubble,bubbleTick:e.bubbleTick};i.set(e.serverIndex,o),n.push(o)}}let c=new Map;for(let t of e.npcRespawns??[])c.set(t.serverIndex,t);for(let e of j){if(Math.floor(e.z/944)!==t||r.has(e.serverIndex))continue;let i=c.get(e.serverIndex);n.push({key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:!1,npcId:e.id,ghost:!0,respawnTicks:i?.t??null,respawnTicksMin:i?.tMin??null,respawnAssumed:i?.assumed??null,respawnCheckedAgo:i?.checkedAgo??null})}L.current.entities=n,L.current.entitiesRev++;let l=[],u=new Set;for(let n of e.bots??[])for(let e of n.groundItems??[]){if(Math.floor(e.z/944)!==t)continue;let n=`${e.id}:${e.x},${e.z}`;u.has(n)||(u.add(n),l.push({id:e.id,x:e.x,z:e.z%944,name:e.name}))}L.current.groundItems=l;let d=[],f=new Set;for(let t of e.bots??[])for(let e of t.objects??[]){let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;f.has(n)||(f.add(n),d.push({plane:t,x:e.x,z:e.z%944,id:e.id}))}L.current.observed=d;let p=[],m=new Set;for(let t of e.bots??[])for(let e of t.wallObjects??[]){if(e.dir==null)continue;let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944},${e.dir}`;m.has(n)||(m.add(n),p.push({plane:t,x:e.x,z:e.z%944,dir:e.dir,id:e.id}))}L.current.observedDoors=p,L.current.observedRev++;let h=[],g=new Set;for(let t of e.bots??[])for(let e of t.objects??[]){if(e.respawnId==null||e.respawnTicks==null)continue;let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;g.has(n)||(g.add(n),h.push({plane:t,x:e.x,z:e.z%944,dir:e.dir??0,id:e.respawnId,name:e.respawnName??null,t:e.respawnTicks}))}L.current.respawnGhosts=h;{let t=new Map;for(let n of e.bots??[])n.serverIndex!=null&&t.set(n.serverIndex,n.username);let r=new Map;for(let e of n)r.set(e.key,e);let i=performance.now();for(let n of e.bots??[])for(let e of n.projectiles??[]){let a=`${n.serverTick}:${e.sprite}:${e.fromNpc?`n`:`p`}${e.from}:${e.toPlayer?`p`:`n`}${e.to}`;if(F.current.has(a))continue;F.current.add(a);let o=e.fromNpc?`npc:${e.from}`:t.has(e.from)?`bot:${t.get(e.from)}`:`pl:${e.from}`,s=e.toPlayer?t.has(e.to)?`bot:${t.get(e.to)}`:`pl:${e.to}`:`npc:${e.to}`,c=r.get(o),l=r.get(s);!c||!l||I.current.push({key:a,sprite:e.sprite,fromKey:o,toKey:s,start:i,fx:c.x,fz:c.z,tx:l.x,tz:l.z})}I.current=I.current.filter(e=>i-e.start<1e3),F.current.size>2e3&&F.current.clear()}}return(0,l.useEffect)(()=>{let e=t.current;if(!e)return;let n=new il({antialias:!0});n.setPixelRatio(window.devicePixelRatio),e.appendChild(n.domElement);let r=new wn;r.background=new Sn(1052698);let i=new ba(-1,1,1,-1,-4e5,4e5),a=new J,o=new URLSearchParams(location.search),s=e=>{if(e==null)return null;let t=parseFloat(e);return Number.isFinite(t)?t:null},c=(s(o.get(`yaw`))??45)*Math.PI/180,l=(s(o.get(`pitch`))??45.8)*Math.PI/180,u=.02,f=1.5533;l=Math.max(u,Math.min(f,l));let p=2e5,h=1024*128,g=null,_=()=>{g||=setTimeout(()=>{g=null;let e=L.current.manifest;if(!e)return;let t=e.botXTiles*128,n=new URLSearchParams(location.search);n.set(`floor`,L.current.floor),n.set(`roofs`,L.current.roofs?`1`:`0`),n.set(`sight`,L.current.sight?`1`:`0`),n.set(`tags`,L.current.tags?`1`:`0`),n.set(`x`,((t-a.x)/128).toFixed(1)),n.set(`z`,(a.z/128).toFixed(1)),n.set(`zoom`,(N/128).toFixed(1)),n.set(`yaw`,(c*180/Math.PI).toFixed(1)),n.set(`pitch`,(l*180/Math.PI).toFixed(1)),history.replaceState(null,``,`${location.pathname}?${n}`)},400)},v=()=>{let e=5120;a.x=Math.max(-5120,Math.min(h+e,a.x)),a.y=Math.max(-3e3,Math.min(3e3,a.y)),a.z=Math.max(-5120,Math.min(h+e,a.z));let t=Math.cos(l);i.position.set(a.x+p*t*Math.sin(c),a.y+p*Math.sin(l),a.z+p*t*Math.cos(c)),i.up.set(0,1,0),i.lookAt(a);let n=R.current.sharedView,r=L.current.manifest;n&&r&&(n.current={x:(r.botXTiles*128-a.x)/128,z:a.z/128,zoom:N/128}),_(),window.__w3d={target:{x:a.x,y:a.y,z:a.z},yaw:c,pitch:l,viewHeightUnits:N}},y=()=>{let e=Math.sin(c),t=Math.cos(c),n=Math.sin(l),r=Math.cos(l);return{right:new J(t,0,-e),up:new J(-n*e,r,-n*t)}},b=()=>{let e=Math.sin(l);if(e<.15||a.y===0)return;let t=a.y/e,n=Math.cos(l);a.x-=n*Math.sin(c)*t,a.z-=n*Math.cos(c)*t,a.y=0},x=new Lt(1,1),S=new Lt(1,1),C=new Uint8Array(4),T=new Uint8Array(4),D=(e,t)=>{let a=n.domElement.getBoundingClientRect();if(!a.width||!a.height)return null;let o=(e-a.left)/a.width*2-1,s=-((t-a.top)/a.height*2-1),u=o*i.right,d=s*i.top,f=2*i.right/a.width,p=i.clone();p.left=u-f,p.right=u+f,p.bottom=d-f,p.top=d+f,p.updateProjectionMatrix();let m=n.getRenderTarget(),h=n.getClearColor(new Sn),g=n.getClearAlpha(),_=r.background;r.background=null;for(let e of jt.values())e.uniforms.pickMode.value=2,e.blending=0;let v=[];for(let e of r.children)e.userData.noPick&&e.visible&&(e.visible=!1,v.push(e));n.setRenderTarget(x),n.setClearColor(16777215,1),n.clear(),n.render(r,p),n.readRenderTargetPixels(x,0,0,1,1,C);for(let e of v)e.visible=!0;n.setRenderTarget(m),n.setClearColor(h,g),r.background=_;for(let e of jt.values())e.uniforms.pickMode.value=0,e.blending=1;let b=C[0]/255+C[1]/65025+C[2]/(65025*255);if(window.__pickDebug={buf:[C[0],C[1],C[2],C[3]],d:b,vx:u,vy:d,near:i.near,far:i.far},b>=.9999)return null;let S=i.near+b*(i.far-i.near),{right:w,up:T}=y(),E=new J(-Math.cos(l)*Math.sin(c),-Math.sin(l),-Math.cos(l)*Math.cos(c));return i.position.clone().addScaledVector(w,u).addScaledVector(T,d).addScaledVector(E,S)},k=new Ra,A=(e,t)=>{let r=n.domElement.getBoundingClientRect();if(r.width===0||r.height===0)return null;let o=new q((e-r.left)/r.width*2-1,-((t-r.top)/r.height)*2+1);k.setFromCamera(o,i);let s=-k.ray.origin.y/k.ray.direction.y;if(!isFinite(s)||s<0)return null;let c=k.ray.origin.clone().addScaledVector(k.ray.direction,s),l=2*Math.hypot(i.right,i.top),u=c.clone().sub(a);return u.y=0,u.length()>l&&c.sub(u).add(u.setLength(l)),c},j=(e,t,n)=>{let r=Math.max(u,Math.min(f,l+n))-l,o=new J(Math.cos(c),0,-Math.sin(c)),s=new _t().setFromAxisAngle(new J(0,1,0),t).multiply(new _t().setFromAxisAngle(o,-r)),d=i.position.clone().sub(e).applyQuaternion(s).add(e),p=a.clone().sub(e).applyQuaternion(s).add(e),m=d.sub(p),h=m.length();l=Math.max(u,Math.min(f,Math.asin(Math.max(-1,Math.min(1,m.y/h))))),c=Math.atan2(m.x,m.z);let g=Math.sin(l);if(g>=.15){let e=-p.y/g;a.set(p.x+m.x/h*e,0,p.z+m.z/h*e)}else a.copy(p),a.y=Math.max(-3e3,Math.min(3e3,a.y));v()},M=new URLSearchParams(location.search),N=(s(M.get(`zoom`))??60)*128,F=()=>{let t=e.clientWidth||800,r=e.clientHeight||600;n.setSize(t,r);let a=t/r;i.left=-N*a/2,i.right=N*a/2,i.top=N/2,i.bottom=-N/2,i.updateProjectionMatrix()},te=new ResizeObserver(F);te.observe(e),ie.current=()=>{let e=L.current.manifest;if(!e)return;let t=R.current.sharedView?.current;if(!t)return;let n=e.botXTiles*128;a.x=n-t.x*128,a.z=t.z*128,t.zoom>0&&(N=t.zoom*128,F()),v()};let ae=new Map;Promise.all([cl(),ll()]).then(([e,t])=>{for(let t of e){let e=et(t.floor,t.x,t.z),n=Ke.get(e);n||Ke.set(e,n=[]),n.push(t),qe.set(tt(t.floor,t.x,t.z),t)}for(let e of Qe)Ze.add(e);let n=new Map;for(let e of t.entries)n.set(`${e.id}_${e.dir}`,{name:e.name,tw:e.tw,th:e.th});for(let t of e){let e=n.get(`${t.id}_${t.dir}`),r=e?.tw??1,i=e?.th??1,a={id:t.id,dir:t.dir,name:e?.name??`object ${t.id}`,ax:t.x,az:t.z};for(let e=0;e<r;e++)for(let n=0;n<i;n++){let r=`${t.floor}:${t.x+e},${t.z+n}`,i=ae.get(r);i||ae.set(r,i=[]),i.push(a)}}}).catch(()=>{});let oe=null,se=``,ce=null,le=null,ue=e=>e?e.type===`entity`?`${e.kind} ${e.name??e.key}`+(e.npcId==null?``:` (id ${e.npcId})`)+` · tile ${Math.round(e.x)},${Math.round(e.z)}`+(e.inCombat?` · in combat`:``):e.type===`object`?`${e.name} (id ${e.id}, dir ${e.dir}, anchor ${e.ax},${e.az}, ${e.w}x${e.h})`:e.type===`wall`?`${e.name} (boundary ${e.id}, dir ${e.dir}, edge ${e.x},${e.z})`:e.type===`grounditem`?`${e.name??`item`} (id ${e.id}) · tile ${Math.round(e.x)},${Math.round(e.z)}`:`tile ${e.x},${e.z} · h ${Oe(e.x,e.z).toFixed(0)}`:``,de=e=>{At(e);let t=ue(e);t!==se&&(se=t,E(t))},fe=(e,t)=>{L.current.manifest&&de(kt(e,t,!0))},pe=e=>{let t=je.current().find(t=>t.key===e);de(t?{type:`entity`,...t}:null)},z=null,me=n.domElement;me.style.touchAction=`none`,e.style.touchAction=`none`,e.addEventListener(`contextmenu`,e=>e.preventDefault()),e.addEventListener(`pointerdown`,t=>{if(P.current&&(P.current=null,ee(!1)),t.button!==0&&t.button!==1&&t.button!==2)return;oe={kind:`none`};let n=t.button===0&&!t.shiftKey?`pan`:`rotate`;t.button===1&&t.preventDefault();let r=t.target.closest?.(`[data-entity-key]`);z={mode:n,button:t.button,lastX:t.clientX,lastY:t.clientY,downX:t.clientX,downY:t.clientY,pivot:n===`rotate`?D(t.clientX,t.clientY)??A(t.clientX,t.clientY):null,plateKey:r?.dataset.entityKey??null},window.__w3dPivot=z.pivot?{x:z.pivot.x,y:z.pivot.y,z:z.pivot.z}:null,e.setPointerCapture(t.pointerId)}),e.addEventListener(`pointermove`,e=>{if(!z){let t=e.target.closest?.(`[data-entity-key]`);oe=t?.dataset.entityKey?{kind:`plate`,key:t.dataset.entityKey}:e.target===me?{kind:`canvas`,x:e.clientX,y:e.clientY}:{kind:`none`};return}let t=e.clientX-z.lastX,r=e.clientY-z.lastY;if(z.lastX=e.clientX,z.lastY=e.clientY,z.mode===`rotate`){let e=z.pivot??a;j(e,-t*.008,r*.008)}else{let e=N/(n.domElement.clientHeight||600),{right:i,up:o}=y();a.addScaledVector(i,-t*e).addScaledVector(o,r*e),b(),v()}});let he=e=>e<-9?`#ff0000`:e<-6?`#ff3000`:e<-3?`#ff7000`:e<0?`#ffb000`:e>9?`#00ff00`:e>6?`#40ff00`:e>3?`#80ff00`:e>0?`#c0ff00`:`#fff`,ge=(e,t)=>{if(e+2304>=2640)return 0;let n=2203-(t+(1776-944*Math.floor(t/944)));return n>0?1+Math.floor(n/6):0},_e=1,ve=(e,t)=>{let n=R.current.selectedBot,r=L.current.manifest;if(!n||!r)return[];let i=Ot(e,t);if(!i)return[];let a=Lu(L.current.floor).plane,o=e=>e+a*944,s=R.current.useItem??null,c=()=>R.current.onUseItemDone?.(),l=[],u=(e,t,r,i,a,o=0)=>gl(n,e,t,r,i,a,o).catch(()=>{}),d=i.bot??i.ent;if(d&&!d.ghost&&d.kind===`npc`&&d.npcId!=null){let e=parseInt(d.key.slice(4),10),t=d.name??Fe.info(d.npcId)?.name??`npc`,r=Math.round(d.x),i=o(Math.round(d.z)),a=Fe.info(d.npcId);if(s)l.push({verb:`Use ${s.name} with`,target:t,tcolor:`#ff0`,prio:710,run:()=>{u(`use_item_on_npc`,r,i,e,_e++,s.id),c()}});else{let o=(R.current.bots??[]).find(e=>e.username===n);if(a?.atk){let n=(o?.combatLvl??0)-(a.lvl??0);l.push({verb:`Attack`,target:t,tcolor:`#ff0`,suffix:` (level-${a.lvl})`,scolor:he(n),prio:n>=0?715:2715,run:()=>u(`npc_attack`,r,i,e,_e++)})}l.push({verb:`Talk-to`,target:t,tcolor:`#ff0`,prio:720,run:()=>u(`npc_talk`,r,i,e,_e++)}),a?.cmd1&&l.push({verb:a.cmd1,target:t,tcolor:`#ff0`,prio:725,run:()=>u(`npc_command1`,r,i,e,_e++)}),a?.cmd2&&l.push({verb:a.cmd2,target:t,tcolor:`#ff0`,prio:833,run:()=>u(`npc_command2`,r,i,e,_e++)})}}else if(d&&(d.kind===`player`||d.kind===`bot`)&&!(d.kind===`bot`&&d.name===n)){let e=d.kind===`player`?parseInt(d.key.slice(3),10):(R.current.bots??[]).find(e=>e.username===d.name)?.serverIndex,t=d.name??`player`,n=Math.round(d.x),r=o(Math.round(d.z));e!=null&&!s&&(ge(n,r)>0?l.push({verb:`Attack`,target:t,tcolor:`#fff`,prio:805,run:()=>u(`player_attack`,n,r,e,_e++)}):l.push({verb:`Duel with`,target:t,tcolor:`#fff`,prio:2806,run:()=>u(`player_duel`,n,r,e,_e++)}),l.push({verb:`Trade with`,target:t,tcolor:`#fff`,prio:2810,run:()=>u(`player_trade`,n,r,e,_e++)}),l.push({verb:`Follow`,target:t,tcolor:`#fff`,prio:2820,run:()=>u(`player_follow`,n,r,e,_e++)}))}for(let e of i.ground){let t=Math.round(e.x),n=o(Math.round(e.z));s?l.push({verb:`Use ${s.name} with`,target:e.name??`item`,tcolor:`#ff9040`,prio:210,run:()=>{u(`use_item_on_ground_item`,t,n,e.id,_e++,s.id),c()}}):l.push({verb:`Take`,target:e.name??`item`,tcolor:`#ff9040`,prio:220,run:()=>u(`ground_item`,t,n,e.id,_e++)})}if(i.wall?.type===`wall`){let e=i.wall,t=at?.get(e.id),n=o(e.z);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:310,run:()=>{u(`use_item_on_wall_object`,e.x,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:320,run:()=>u(`wall_object`,e.x,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2300,run:()=>u(`wall_object2`,e.x,n,e.id,e.dir)}))}if(i.obj?.type===`object`){let e=i.obj,t=Ge?.objects.get(e.id),n=o(e.az);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:410,run:()=>{u(`use_item_on_object`,e.ax,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:420,run:()=>u(`object`,e.ax,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2400,run:()=>u(`object2`,e.ax,n,e.id,e.dir)}))}if(i.tile){let e=i.tile;l.push({verb:`Walk here`,prio:920,run:()=>{hl(n,{x:e.x,z:o(e.z)}).catch(()=>{}),s&&c()}})}return l.sort((e,t)=>e.prio-t.prio),l},ye=(t,n)=>{let r=ve(t,n);if(r.length===0)return;r.push({verb:`Cancel`,prio:4e3});let i=e.getBoundingClientRect();ne({x:t-i.left,y:n-i.top,entries:r})},be=t=>{let n=z&&Math.hypot(t.clientX-z.downX,t.clientY-z.downY)<4;if(n&&re.current){ne(null),z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(n&&z.button===2&&(R.current.walkTool||R.current.useItem)&&R.current.selectedBot){ye(t.clientX,t.clientY),z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(z&&z.button===0&&Math.hypot(t.clientX-z.downX,t.clientY-z.downY)<4){let e=z.plateKey?je.current().find(e=>e.key===z.plateKey):null,n=e?{type:`entity`,...e}:kt(t.clientX,t.clientY),r=R.current.selectedBot;if((R.current.walkTool||R.current.useItem)&&r&&n){let n=ve(t.clientX,t.clientY);if(e&&n.length){let t=e.name??``,r=n.filter(e=>e.target===t);r.length&&(n=r)}n[0]?.run?.()}else n?.type===`entity`?(je.selectedEntityKey=n.key,n.kind===`bot`?(R.current.onSelectBot?.(n.key.slice(4)),O(null)):O({kind:n.kind,name:n.name??null,npcId:n.npcId??null,key:n.key,inCombat:!!n.inCombat,appearance:n.appearance})):n?.type===`object`?O({kind:`object`,name:n.name,npcId:n.id,key:`obj:${n.ax},${n.az}`,inCombat:!1}):n?.type===`wall`?O({kind:`boundary`,name:n.name,npcId:n.id,key:`wall:${n.x},${n.z},${n.dir}`,inCombat:!1}):(je.selectedEntityKey=null,O(null))}z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId)};e.addEventListener(`pointerup`,be),e.addEventListener(`pointercancel`,be),e.addEventListener(`pointerleave`,()=>{z||(oe={kind:`none`})}),e.addEventListener(`lostpointercapture`,()=>{z=null}),e.addEventListener(`wheel`,e=>{e.preventDefault();let t=n.domElement.getBoundingClientRect(),r=t.width?(e.clientX-t.left)/t.width*2-1:0,o=t.height?-((e.clientY-t.top)/t.height*2-1):0,s=i.right,c=i.top,l=N;N=Math.min(1024*128,Math.max(768,N*1.0015**e.deltaY));let u=N/l;F();let{right:d,up:f}=y();a.addScaledVector(d,r*s*(1-u)).addScaledVector(f,o*c*(1-u)),b(),v()},{passive:!1});let xe=1009,Se=[null,null,null,null],Ce=e=>{let t=Se[e];return t||(t=new Float32Array(xe*xe).fill(NaN),Se[e]=t),t},we=Lu(L.current.floor).plane,Te=(e,t,n,r)=>{t>=0&&t<xe&&n>=0&&n<xe&&(e[n*xe+t]=r)},Ee=(e,t,n)=>{if(t<0||t>=xe||n<0||n>=xe)return 0;let r=e[n*xe+t];return Number.isNaN(r)?0:r},De=(e,t,n)=>{let r=t+.5,i=n+.5,a=Math.floor(r),o=Math.floor(i),s=r-a,c=i-o,l=Ee(e,a,o),u=Ee(e,a+1,o),d=Ee(e,a,o+1),f=Ee(e,a+1,o+1);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c},Oe=(e,t)=>De(Ce(we),e,t),B=e=>(t,n)=>De(Ce(e),t,n),ke=(e,t)=>{let n=Oe(e+.5,t)-Oe(e-.5,t),r=Oe(e,t+.5)-Oe(e,t-.5);return new J(n/128,1,-r/128).normalize()},Ae=document.createElement(`div`);Ae.style.cssText=`position:absolute;inset:0;overflow:hidden;pointer-events:none;user-select:none;`,e.appendChild(Ae);let je=new Al(r,Ae),V=-1,Me=new Cu(r),H=new Su(r,5088255,.6,.16),U,Ne=null,Pe=(e,t)=>{let n=[],r=[];for(let t of L.current.route??[]){let i=Math.floor(t.z/944)===e;(t.hop||!i)&&(r.length>1&&n.push({pts:r,closed:!1}),r=[]),i&&r.push({x:t.x,z:t.z%944})}r.length>1&&n.push({pts:r,closed:!1}),H.extrude(n,t)},Fe=new Ql(r),Ie=new lu(r);je.npcDims=e=>Fe.dims(e);let Le=!1,Re=()=>{Le||je.chatFont||(Le=!0,hu().then(e=>{Vt||(je.chatFont=e)}).catch(()=>{Le=!1}))};Re();let ze=new fu(r),Be=new Ou(r),Ve=!1,He=()=>{Ve||(Ve=!0,Ul().then(e=>{if(Vt||!e){Ve=!1;return}Fe.setAtlas(e)}))},Ue=!1,We=()=>{Ue||(Ue=!0,uu().then(e=>{if(Vt||!e){Ue=!1;return}ze.setAtlas(e),je.itemFrame=t=>{let n=e.frames.get(t);return n?{x:n.x,y:n.y,w:n.w,h:n.h,atlasW:e.width,atlasH:e.height}:null}}))},Ge=null,Ke=new Map,qe=new Map,Je=new Map,Ye=new Map,Ze=new Set,Qe=new Set,$e=-1,et=(e,t,n)=>`${e}:${Math.floor((t-24)/48)},${Math.floor((n-24)/48)}`,tt=(e,t,n)=>`${e}:${t},${n}`,nt=new Map,rt=new Map,it=e=>{let t=Ye.get(e);t&&(r.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),Ye.delete(e));let n=nt.get(e);if(n){for(let e of n)r.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});nt.delete(e)}let i=rt.get(e);if(i){for(let{group:e}of i)r.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});rt.delete(e)}},W=e=>Uu(e.x,e.z),G=e=>{let t=L.current.manifest;if(!Ge||!t)return;it(e);let n=Ke.get(e)??[],i=parseInt(e.split(`:`)[0],10),a=[],o=new Set;for(let e of n){let t=tt(i,e.x,e.z);o.add(t);let n=Je.get(t);a.push({id:n??e.id,dir:e.dir,x:e.x,z:e.z})}for(let[t,n]of Je){let[r,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(r,10)!==i||o.has(t))continue;let[c,l]=s.split(`,`).map(Number);et(i,c,l)===e&&a.push({id:n,dir:0,x:c,z:l})}if(a.length===0)return;let s=t.botXTiles*128,c=B(i),l=a.filter(e=>Ge.anims.has(e.id)),u=a.filter(e=>e.id===Pu),d=a.filter(e=>!Ge.anims.has(e.id)&&e.id!==Pu);if(d.length>0){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=i;for(let{tex:e,geometry:r}of Nl(Ge,d,s,c,W))n.add(new ai(r,Nt(e,t.baked)));n.visible=i===we,Ye.set(e,n),r.add(n)}if(l.length>0){let n=Math.max(...l.map(e=>Ge.anims.get(e.id).length)),a=[];for(let e=0;e<n;e++){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=i;let o=l.map(t=>{let n=Ge.anims.get(t.id);return{...t,model:n[e%n.length]}});for(let{tex:e,geometry:r}of Nl(Ge,o,s,c,W))n.add(new ai(r,Nt(e,t.baked)));n.visible=i===we&&e===0,a.push(n),r.add(n)}nt.set(e,a)}if(u.length>0){let n=[];for(let e of u){let a=Pl(Ge,e,s,c);if(!a)continue;let o=new hn;o.userData.kind=`scenery`,o.userData.plane=i,o.position.copy(a);for(let{tex:n,geometry:r}of Nl(Ge,[e],s,c,W))r.translate(-a.x,-a.y,-a.z),o.add(new ai(r,Nt(n,t.baked)));let l=e.dir*32*2*Math.PI/256,u=new J(-Math.cos(l),0,-Math.sin(l)).normalize();o.visible=i===we,n.push({group:o,axis:u}),r.add(o)}rt.set(e,n)}},at=null,ot=new Map,st=new Map,ct=new Map,lt=new Map,ut=(e,t,n,r)=>`${e}:${t},${n},${r}`,dt=e=>{let t=lt.get(e);t&&(r.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),lt.delete(e))},ft=e=>{let t=L.current.manifest;if(!at||!t)return;dt(e);let n=ot.get(e)??[],i=parseInt(e.split(`:`)[0],10),a=[],o=new Set;for(let e of n){let t=ut(i,e.x,e.z,e.dir);o.add(t);let n=ct.get(t);a.push(n==null?e:{...e,id:n})}for(let[t,n]of ct){let[r,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(r,10)!==i||o.has(t))continue;let[c,l,u]=s.split(`,`).map(Number);et(i,c,l)===e&&a.push({id:n,x:c,z:l,floor:i,dir:u})}if(a.length===0)return;let s=t.botXTiles*128,c=new hn;c.userData.kind=`doors`,c.userData.plane=i;let l=B(i),u=(e,t)=>l(e-.5,t-.5);for(let{tex:e,geometry:n}of Hl(at,a,s,u,e=>Wu(e.x,e.z,e.dir)))c.add(new ai(n,Nt(e,t.baked)));c.visible=i===we,lt.set(e,c),r.add(c)},K=!1,pt=()=>{at||K||(K=!0,Fl().then(e=>{if(K=!1,!(Vt||!e)){at=e.defs;for(let t of e.boundaries){let e=et(t.floor,t.x,t.z),n=ot.get(e);n||ot.set(e,n=[]),n.push(t),st.set(ut(t.floor,t.x,t.z,t.dir),t)}for(let e of Qe)Ze.add(e)}}))},mt=new _r;mt.setAttribute(`position`,new X(new Float32Array(192),3));let ht=new Uint16Array(96);for(let e=0;e<16;e++)ht.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);mt.setIndex(new X(ht,1)),mt.setDrawRange(0,0);let gt=new ai(mt,new qr({color:16770140,transparent:!0,opacity:.28,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-3,polygonOffsetUnits:-3,side:2}));gt.renderOrder=9,gt.frustumCulled=!1,gt.userData.noPick=!0,r.add(gt);let vt=e=>{let t=mt.getAttribute(`position`),n=L.current.manifest;if(!n)return;let r=n.botXTiles*128,i=0;for(let n of e){if(i>=16)break;let e=(e,t)=>new J(r-e*128,Oe(e-.5,t-.5)+3,t*128),a=[e(n.x,n.z),e(n.x+1,n.z),e(n.x+1,n.z+1),e(n.x,n.z+1)];for(let e=0;e<4;e++)t.setXYZ(i*4+e,a[e].x,a[e].y,a[e].z);i++}t.needsUpdate=!0,mt.setDrawRange(0,i*6)},yt=null,Y=``,bt=new qr({color:16770140,transparent:!0,opacity:.4,blending:2,depthWrite:!1}),xt=e=>{let t=e?`${e.id}:${e.ax},${e.az},${e.dir}`:``;if(t===Y)return;Y=t,yt&&=(r.remove(yt),yt.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),null);let n=L.current.manifest;if(!e||!Ge||!n)return;let i=new hn;for(let{geometry:t}of Nl(Ge,[{id:e.id,dir:e.dir,x:e.ax,z:e.az}],n.botXTiles*128,Oe)){let e=new ai(t,bt);e.renderOrder=9,i.add(e)}i.userData.noPick=!0,yt=i,r.add(i)},St=new Map,Ct=(t,n,r,a)=>{let o=L.current,s=new Set;if(n&&r<=60){i.updateMatrixWorld();let n=e.clientWidth||800,r=e.clientHeight||600;for(let e of o.respawnGhosts){if(e.plane!==t)continue;let o=`${e.x},${e.z}`,c=a(e.x,e.z).project(i);if(c.z>1||c.z<-1||c.x<-1.05||c.x>1.05||c.y<-1.05||c.y>1.05)continue;s.add(o);let l=St.get(o);l||(l=document.createElement(`div`),l.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:rgba(196,200,208,.5);background:rgba(10,14,24,.25);padding:0 4px;border-radius:4px;pointer-events:none;white-space:nowrap;z-index:880000;`,Ae.appendChild(l),St.set(o,l));let u=`${e.name??e.id} · ${e.t}t`;l.textContent!==u&&(l.textContent=u),l.style.left=`${(c.x+1)/2*n}px`,l.style.top=`${(1-c.y)/2*r-26}px`}}for(let[e,t]of St)s.has(e)||(t.remove(),St.delete(e))},wt=(e,t,n)=>{for(let r=0;r>=-4;r--)for(let i=0;i>=-4;i--){let a=qe.get(tt(e,t+r,n+i));if(!a)continue;let o=Je.get(tt(e,a.x,a.z))??a.id,s=Ge?.objects.get(o);if(!s)continue;let c=a.dir===0||a.dir===4?s.w:s.h,l=a.dir===0||a.dir===4?s.h:s.w;if(t>=a.x&&t<a.x+c&&n>=a.z&&n<a.z+l)return{type:`object`,id:o,name:s.name,ax:a.x,az:a.z,dir:a.dir,w:c,h:l}}return null},Tt=(e,t,n,r,i,a)=>{let o=i-n,s=a-r,c=o*o+s*s,l=c===0?0:Math.max(0,Math.min(1,((e-n)*o+(t-r)*s)/c));return Math.hypot(e-(n+l*o),t-(r+l*s))},Et=(e,t,n)=>{if(!at)return null;let r=Math.floor(t+.5),i=Math.floor(n+.5),a=null,o=.3;for(let s=-1;s<=1;s++)for(let c=-1;c<=1;c++){let l=r+s,u=i+c;for(let r=0;r<4;r++){let i=ut(e,l,u,r),s=ct.get(i)??st.get(i)?.id;if(s==null)continue;let c=at.get(s);if(!c||c.height<=0)continue;let d=l-.5,f=u-.5,[p,m,h,g]=r===0?[d,f,d+1,f]:r===1?[d,f,d,f+1]:r===2?[d+1,f,d,f+1]:[d,f,d+1,f+1],_=Tt(t,n,p,m,h,g);_<o&&(o=_,a={type:`wall`,id:s,name:c.name,x:l,z:u,dir:r})}}return a},Dt=(e,t)=>{if(!Ge)return null;let a=n.domElement.getBoundingClientRect();if(!a.width||!a.height)return null;let o=(e-a.left)/a.width*2-1,s=-((t-a.top)/a.height*2-1),c=o*i.right,l=s*i.top,u=2*i.right/a.width,d=i.clone();d.left=c-u,d.right=c+u,d.bottom=l-u,d.top=l+u,d.updateProjectionMatrix();let f=n.getRenderTarget(),p=n.getClearColor(new Sn),m=n.getClearAlpha(),h=r.background;r.background=null;for(let e of jt.values())e.uniforms.pickMode.value=1,e.blending=0;let g=[];for(let e of r.children)e.userData.noPick&&e.visible&&(e.visible=!1,g.push(e));n.setRenderTarget(S),n.setClearColor(0,0),n.clear(),n.render(r,d),n.readRenderTargetPixels(S,0,0,1,1,T);for(let e of g)e.visible=!0;n.setRenderTarget(f),n.setClearColor(p,m),r.background=h;for(let e of jt.values())e.uniforms.pickMode.value=0,e.blending=1;let _=T[3];if(_<8||_>15)return null;let v=T[0]|T[1]<<8|T[2]<<16|_<<24,y=v>>12&4095,b=v&4095,x=Lu(L.current.floor).plane;if((v>>26&1)==1){let e=v>>24&3,t=ut(x,y,b,e),n=ct.get(t)??st.get(t)?.id,r=n==null?void 0:at?.get(n);return r?{type:`wall`,id:n,name:r.name,x:y,z:b,dir:e}:null}return wt(x,y,b)},Ot=(e,t,r=!1)=>{let a=L.current.manifest;if(!a)return null;let o=a.botXTiles*128,s=i.position,u=new J(-Math.cos(l)*Math.sin(c),-Math.sin(l),-Math.cos(l)*Math.cos(c)),d=(e,t,n)=>(e-s.x)*u.x+(t-s.y)*u.y+(n-s.z)*u.z,f=null,p=1/0,m=null,h=1/0;{let r=n.domElement.getBoundingClientRect();if(r.width&&r.height){let n=e-r.left,a=t-r.top,s=r.width/(i.right-i.left);for(let e of je.current()){let t=o-(e.x*128+64),c=Oe(e.x,e.z),l=e.z*128+64,u=new J(t,c,l).project(i),g=e.kind===`npc`&&e.npcId!=null?Fe.dims(e.npcId):null,_=g?Math.max(56,g.w):90,v=g?Math.max(70,g.h):230,y=e.dir===8||e.dir===9,b=e.dir===8?-30:e.dir===9?30:0,x=(_/2+(y?15:0))*s,S=v*s,C=(u.x+1)/2*r.width+b*s,w=(1-u.y)/2*r.height,T=g?g.h:e.appearance?220:130,E=Math.min(w-S,w-T*s-12),D=w+10,O=(E+D)/2,k=(D-E)/2,A=(n-C)/x,j=(a-O)/k;if(A*A+j*j>1)continue;let M=d(t,c+Math.max(0,Math.min(1,(w-a)/S))*v,l);e.kind===`bot`?M<p&&(p=M,f=e):M<h&&(h=M,m=e)}}}let g=D(e,t)??A(e,t);if(!g)return{bot:f,ent:m,ground:[],wall:null,obj:null,tile:null,entDepth:null,objDepth:null};let _=d(g.x,g.y,g.z),v=(o-g.x)/128-.5,y=g.z/128-.5;if(!f&&!m){let e=je.nearestEntity(v,y,.6);e&&(e.kind===`bot`?f=e:(m=e,h=d(o-(e.x*128+64),Oe(e.x,e.z),e.z*128+64)))}let b=(e,t)=>{let n=Math.floor(e+.5);return!r||t===null?n:e>=t-.5-Iu&&e<=t+.5+Iu?t:n},x=b(v,r?ce:null),S=b(y,r?le:null);r&&(ce=x,le=S);let C=[];for(let e of L.current.groundItems){let t=Math.hypot(e.x-v,e.z-y);t<.7&&C.push({g:e,d:t})}C.sort((e,t)=>e.d-t.d);let w=Lu(L.current.floor).plane,T=Dt(e,t),E=null,O=null;if(T)T.type===`wall`?E=T:O=T;else if(!Ge)E=Et(w,v,y),O=wt(w,x,S);else{let e=wt(w,x,S);e&&e.type===`object`&&(e.ax>=4096||e.az>=4096)&&(O=e)}return{bot:f,ent:m,ground:C.map(e=>e.g),wall:E,obj:O,tile:{x,z:S},entDepth:m?h:null,objDepth:_}};window.__w3dResolve=(e,t)=>kt(e,t);let kt=(e,t,n=!1)=>{let r=Ot(e,t,n);if(!r)return null;if(r.bot)return{type:`entity`,...r.bot};let i=r.wall??r.obj;if(r.ent)return i&&r.objDepth!=null&&r.entDepth!=null&&r.objDepth<r.entDepth?i:{type:`entity`,...r.ent};if(r.ground.length>0){let e=r.ground[0];return{type:`grounditem`,id:e.id,name:e.name,x:e.x,z:e.z}}return i||(r.tile?{type:`tile`,x:r.tile.x,z:r.tile.z}:null)},At=e=>{if(je.hoverKey=e?.type===`entity`?e.key:null,Fe.highlightKey=e?.type===`entity`&&e.kind===`npc`?e.key:null,Ie.highlightKey=e?.type===`entity`&&(e.kind===`bot`||e.kind===`player`)?e.key:null,e?.type===`object`){xt(e);let t=[];for(let n=0;n<e.w;n++)for(let r=0;r<e.h;r++)t.push({x:e.ax+n,z:e.az+r});vt(t)}else xt(null),e?.type===`entity`||e?.type===`grounditem`?vt([{x:Math.round(e.x),z:Math.round(e.z)}]):e?.type===`wall`||e?.type===`tile`?vt([{x:e.x,z:e.z}]):vt([]);me.style.cursor=e?.type===`entity`||e?.type===`object`||e?.type===`wall`?`pointer`:``},jt=new Map,Mt=new da,Nt=(e,t)=>{let n=jt.get(e);if(n)return n;let r={map:{value:null},textured:{value:e>=0},vScroll:{value:0},pickMode:{value:0}};if(e>=0){let n=Mt.load(sl(e,t));n.magFilter=m,n.minFilter=m,n.wrapS=d,n.wrapT=d,n.flipY=!1,r.map.value=n}return n=new Hi({glslVersion:Xe,vertexShader:Bu,fragmentShader:Vu,uniforms:r,side:2}),jt.set(e,n),n},Pt=-1;window.__w3dAnim=()=>({cells:nt.size,anims:Ge?Ge.anims.size:-1,visible:[...nt.values()].map(e=>e.map(e=>+!!e.visible).join(``))}),window.__w3dSel=()=>({selectedEntityKey:je.selectedEntityKey,hoverKey:je.hoverKey,propSelected:R.current.selectedBot??null}),window.__w3dWindmills=()=>{let e=[];for(let[,t]of rt)for(let{group:n}of t)e.push({plane:n.userData.plane,visible:n.visible,quat:[n.quaternion.x,n.quaternion.y,n.quaternion.z,n.quaternion.w]});return e},window.__w3dPlanes=()=>{let e=0,t=0,n=n=>{n.userData.plane!==we&&(t++,n.visible&&e++)};for(let[,e]of Ye)n(e);for(let[,e]of lt)n(e);for(let[,e]of nt)e.forEach(n);for(let[,e]of Ft)n(e);return{activePlane:we,retained:t,wrongVisible:e,loaded:Ft.size,scenery:Ye.size}};let Ft=new Map,It=new Set,Rt=[],zt=null,Bt=()=>{let e=L.current,t=e.manifest;if(!t)return;let n=t.botXTiles*128,{plane:i,kinds:o}=Lu(e.floor);if(zt!==e.floor){zt=e.floor,we=i;let r=(n-a.x)/128,s=a.z/128;Rt=[];for(let e of t.cells)if(e.plane===i)for(let n of o){if(!e.kinds.includes(n))continue;let i=`p${e.plane}_${e.a}_${e.b}_${n}`;if(Ft.has(i)||It.has(i))continue;let a=e.botX0+t.cellTiles/2,o=e.botZ0+t.cellTiles/2;Rt.push({cell:e,kind:n,key:i,d:Math.hypot(a-r,o-s)})}Rt.sort((e,t)=>e.d-t.d)}for(;It.size<24&&Rt.length>0;){let{cell:e,kind:i,key:a}=Rt.shift();Ft.has(a)||It.has(a)||(It.add(a),fetch(ol(e,i,t.baked)).then(e=>{if(!e.ok)throw Error(`${e.status}`);return e.arrayBuffer()}).then(o=>{let s=new hn;s.userData.kind=i,s.userData.plane=e.plane;let c=Ce(e.plane),l=i===`terrain`?(e,t,n)=>Te(c,e,t,n):void 0;for(let{tex:r,geometry:i}of Gu(o,n,e.botX0,e.botZ0,l))s.add(new ai(i,Nt(r,t.baked)));if(s.visible=e.plane===we,Ft.set(a,s),r.add(s),i===`terrain`){let t=et(e.plane,e.botX0,e.botZ0);Qe.add(t),Ze.add(t)}}).catch(()=>{}).finally(()=>{It.delete(a),Rt.length>0&&setTimeout(Bt,0)}))}for(let[,e]of Ft){let t=Nu.has(e.userData.kind)&&!L.current.roofs;e.visible=e.userData.plane===i&&!t}for(let[,e]of Ye)e.visible=e.userData.plane===i;for(let[,e]of lt)e.visible=e.userData.plane===i;for(let[,e]of nt)if(e.length>0&&e[0].userData.plane!==i)for(let t of e)t.visible=!1;for(let[,e]of rt)for(let{group:t}of e)t.visible=t.userData.plane===i;if(e.observedRev!==$e&&Ge){if($e=e.observedRev,at)for(let t of e.observedDoors){let e=ut(t.plane,t.x,t.z,t.dir),n=st.get(e);!n||n.id!==t.id?ct.get(e)!==t.id&&(ct.set(e,t.id),Ze.add(et(t.plane,t.x,t.z))):ct.has(e)&&(ct.delete(e),Ze.add(et(t.plane,t.x,t.z)))}let t=new Map;for(let n of e.observed){let e=tt(n.plane,n.x,n.z),r=qe.get(e);(!r||r.id!==n.id)&&t.set(e,n.id)}for(let[e,n]of t)if(Je.get(e)!==n){Je.set(e,n);let[t,r]=e.split(`:`),[i,a]=r.split(`,`).map(Number);Ze.add(et(parseInt(t,10),i,a))}for(let t of e.observed){let e=tt(t.plane,t.x,t.z),n=qe.get(e);n&&n.id===t.id&&Je.has(e)&&(Je.delete(e),Ze.add(et(t.plane,t.x,t.z)))}}if(Ge){let e=0;for(let t of Ze){if(e++>=8)break;Ze.delete(t),Qe.has(t)&&(G(t),ft(t))}}_();let s=Ft.size+It.size+Rt.length;w(It.size+Rt.length>0?`loading ${Ft.size}/${s} cells…`:``)},Vt=!1,Ht=!1,Ut=e=>{Ge||Ht||(Ht=!0,jl.fetch(e).then(e=>{if(Ht=!1,!(Vt||!e)){Ge=e;for(let e of Qe)Ze.add(e)}}))};al().then(e=>{if(Vt)return;L.current.manifest=e,Ut(e.baked),pt(),He(),We();let t=e.botXTiles*128;h=Math.max(e.botXTiles,e.botZTiles)*128;let n=L.current.focusBot,r=s(M.get(`x`))??n.x,i=s(M.get(`z`))??n.z,o=t-r*128,c=i*128;a.set(o,0,c),v(),w(``),Bt()}).catch(e=>w(`world mesh not ready (${e.message??e}) — retrying…`));let Wt=setInterval(()=>{L.current.manifest?(Ge||Ut(L.current.manifest.baked),pt(),He(),We(),Re()):al().then(e=>{L.current.manifest=e,w(``),Bt()}).catch(()=>{})},5e3),Gt=Ru.map(e=>({...e}));for(let e=1;e<Gt.length;e++){let t=Gt[e].yaw-Gt[e-1].yaw;t=((t+180)%360+360)%360-180,Gt[e].yaw=Gt[e-1].yaw+t}let Kt=[0];for(let e=1;e<Gt.length;e++)Kt.push(Kt[e-1]+(Gt[e].sec??6));let qt=Kt[Kt.length-1],Jt=e=>{let t=L.current.manifest;if(!t)return;let n=Math.min(e,qt),r=0;for(;r<Kt.length-2&&n>Kt[r+1];)r++;let i=(n-Kt[r])/Math.max(1e-6,Kt[r+1]-Kt[r]);r===0&&(i=i*i*(3-2*i)),r===Kt.length-2&&(i=i*i*(3-2*i));let o=e=>Gt[Math.max(0,Math.min(Gt.length-1,e))],s=e=>zu(e(o(r-1)),e(o(r)),e(o(r+1)),e(o(r+2)),i),d=t.botXTiles*128;a.set(d-s(e=>e.x)*128,0,s(e=>e.z)*128),c=s(e=>e.yaw)*Math.PI/180,l=Math.max(u,Math.min(f,s(e=>e.pitch)*Math.PI/180)),N=Math.exp(s(e=>Math.log(e.zoom*128))),F(),v()},Yt=0,Xt=0,Zt=0,Qt=t=>{if(Zt=requestAnimationFrame(Qt),R.current.visible===!1)return;let o=L.current;if(o.manifest){Me.visible=o.sight,je.showPlates=o.tags;let n=o.entitiesRev!==V;n&&(V=o.entitiesRev,je.update(o.entities,t));let r=o.manifest.botXTiles*128,s=(e,t)=>new J(r-(e*128+64),Oe(e,t),t*128+64);n&&Me.update(o.entities.filter(e=>e.kind===`bot`),s),(o.route!==U||o.floor!==Ne)&&(U=o.route,Ne=o.floor,Pe(Lu(o.floor).plane,s)),Ct(Lu(o.floor).plane,o.tags,N/128,s);let u=jt.get(17);u&&(u.uniforms.vScroll.value=-(t/1280%1));let d=R.current.follow;if(d&&!z&&!P.current){let e=je.current().find(e=>e.key===`bot:${d}`);if(e){let n=s(e.x,e.z),r=Xt?Math.min(.1,(t-Xt)/1e3):0,i=r>0?1-Math.exp(-r/.12):1;a.x+=(n.x-a.x)*i,a.y=0,a.z+=(n.z-a.z)*i,v()}Xt=t}else Xt=0;if(I.current.length>0){let e=new Map,n=new Map;for(let t of je.current()){e.set(t.key,{x:t.x,z:t.z});let r=t.kind===`npc`&&t.npcId!=null?Fe.dims(t.npcId):null;n.set(t.key,(r?r.h:t.appearance?220:130)/2)}Be.frame(t,I.current,t=>e.get(t)??null,s,e=>n.get(e)??60)}else Be.frame(t,[],()=>null,s,()=>60);let f=Math.floor(t/120);if(f!==Pt){Pt=f;for(let[,e]of nt){let t=e.length>0&&e[0].userData.plane===we;for(let n=0;n<e.length;n++)e[n].visible=t&&n===f%e.length}}let p=t/Fu*Math.PI*2;for(let[,e]of rt)for(let{group:t,axis:n}of e)t.visible&&t.quaternion.setFromAxisAngle(n,p);je.frame(t,s,ke,i,e.clientWidth||800,e.clientHeight||600,N/128);let{right:m,up:h}=y(),g=new J(Math.cos(l)*Math.sin(c),Math.sin(l),Math.cos(l)*Math.cos(c)),_=m.multiplyScalar(-1),b=160*Math.sin(l);Fe.frame(t,je.snapshot(`npc`,t),s,_,h,c,g,b),Ie.frame(t,[...je.snapshot(`bot`,t),...je.snapshot(`player`,t)],s,_,h,c,g,b),ze.frame(o.groundItems,s,_,h,g,b)}let s=P.current;if(s){let e=(t-s.start)/1e3;Jt(e),e>=qt&&(P.current=null,ee(!1))}if(t-Yt>250&&(Yt=t,Bt()),oe){let e=oe;oe=null,e.kind===`canvas`?fe(e.x,e.y):e.kind===`plate`?pe(e.key):de(null)}n.render(r,i)};return Zt=requestAnimationFrame(Qt),F(),v(),()=>{Vt=!0,ie.current=null;for(let e of[...Ye.keys(),...nt.keys(),...rt.keys()])it(e);for(let e of[...lt.keys()])dt(e);Me.dispose(r),H.dispose(r),Be.dispose();for(let[,e]of St)e.remove();St.clear(),Fe.dispose(r),Ie.dispose(),ze.dispose(r),je.dispose(r),Ae.remove(),g&&clearTimeout(g),clearInterval(Wt),cancelAnimationFrame(Zt),te.disconnect();for(let[,e]of Ft)e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});for(let[,e]of jt)(e.uniforms.map?.value)?.dispose(),e.dispose();n.dispose(),e.removeChild(n.domElement)}},[]),(0,vl.jsxs)(`div`,{style:{position:`relative`,width:`100%`,height:`100%`},children:[(0,vl.jsx)(`div`,{ref:t,style:{position:`absolute`,inset:0,overflow:`hidden`}}),(0,vl.jsxs)(`div`,{style:{position:`absolute`,top:8,left:8,display:`flex`,gap:6,background:`rgba(16,16,26,.8)`,padding:`6px 8px`,borderRadius:6,alignItems:`center`,fontSize:13,userSelect:`none`},children:[!a&&Mu.map(e=>(0,vl.jsx)(`button`,{className:o===e.key?`active`:``,onClick:()=>s(e.key),children:e.label},e.key)),!a&&(0,vl.jsxs)(vl.Fragment,{children:[(0,vl.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,vl.jsx)(`input`,{type:`checkbox`,checked:_,onChange:e=>b(e.target.checked)}),`roofs`]}),(0,vl.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,vl.jsx)(`input`,{type:`checkbox`,checked:v,onChange:e=>x(e.target.checked)}),`sight`]}),(0,vl.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,vl.jsx)(`input`,{type:`checkbox`,checked:y,onChange:e=>S(e.target.checked)}),`tags`]}),(0,vl.jsx)(`button`,{style:{marginLeft:8},onClick:()=>{P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0))},children:N?`Stop`:`Fly`})]}),C&&(0,vl.jsx)(`span`,{style:{marginLeft:8,opacity:.8},children:C})]}),te&&(0,vl.jsxs)(`div`,{style:{position:`absolute`,left:Math.max(0,te.x-4),top:Math.max(0,te.y-8),zIndex:2e6,background:`rgba(208,208,208,0.63)`,padding:`2px 6px 4px 4px`,font:`bold 12px sans-serif`,whiteSpace:`nowrap`,userSelect:`none`},onPointerDown:e=>e.stopPropagation(),children:[(0,vl.jsx)(`div`,{style:{color:`#0ff`,textShadow:`1px 0 #000, 0 1px #000`},children:`Choose option`}),te.entries.map((e,t)=>(0,vl.jsxs)(`div`,{style:{textShadow:`1px 0 #000, 0 1px #000`,cursor:`pointer`,lineHeight:`15px`},onMouseEnter:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#ff0`)},onMouseLeave:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#fff`)},onClick:()=>{e.run?.(),ne(null)},children:[(0,vl.jsx)(`span`,{"data-verb":!0,style:{color:`#fff`},children:e.verb}),e.target&&(0,vl.jsxs)(`span`,{style:{color:e.tcolor??`#fff`},children:[` `,e.target]}),e.suffix&&(0,vl.jsx)(`span`,{style:{color:e.scolor??`#fff`},children:e.suffix})]},t))]}),T&&(0,vl.jsx)(`div`,{style:{position:`absolute`,bottom:8,left:8,background:`rgba(16,16,26,.85)`,padding:`4px 10px`,borderRadius:6,fontSize:13,fontFamily:`monospace`,pointerEvents:`none`},children:T}),D&&(0,vl.jsxs)(`div`,{style:{position:`absolute`,bottom:8,right:8,minWidth:180,background:`rgba(16,16,26,.92)`,padding:`8px 12px`,borderRadius:8,fontSize:13,fontFamily:`monospace`,border:`1px solid #3a4664`},children:[(0,vl.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,gap:12},children:[(0,vl.jsx)(`b`,{children:D.name??D.key}),(0,vl.jsx)(`span`,{style:{cursor:`pointer`,opacity:.7},onClick:()=>O(null),children:`✕`})]}),(0,vl.jsxs)(`div`,{style:{opacity:.85,marginTop:4},children:[D.kind,D.npcId==null?``:` · id ${D.npcId}`,D.inCombat?` · in combat`:``]}),D.appearance&&(0,vl.jsxs)(`div`,{style:{marginTop:6,borderTop:`1px solid #3a4664`,paddingTop:6,maxWidth:260},children:[ju(D.appearance,k).map(e=>(0,vl.jsxs)(`div`,{style:{display:`flex`,gap:8,lineHeight:`18px`},children:[(0,vl.jsx)(`span`,{style:{opacity:.55,width:52,flexShrink:0},children:e.slot}),(0,vl.jsx)(`span`,{children:e.names})]},e.slot)),ju(D.appearance,k).length===0&&(0,vl.jsx)(`div`,{style:{opacity:.55},children:`nothing equipped`})]})]})]})}var qu=`1,34,42,103,53,75,0,0,47,12,0,63|0,8,14,0`,Ju=`1,2,3,0,5|3,0,11,2`,Yu=Number(new URLSearchParams(location.search).get(`stress`)??0);function Xu(e){let t=[],n=Math.floor(e/2100)%4,r=Math.floor(e/2100)*3,i=[`I'd like to access my bank account`,null,`Yes please`,null][n],a=[null,`Good day, how may I help you?`,null,`Certainly, one moment`][n];for(let o=0;o<8;o++){let s=e/9e3+o*Math.PI/4,c=o>=6;t.push({username:`fakebot${o}`,status:`online`,scriptClass:null,description:null,serverIndex:100+o,position:o===3?{x:112,z:650,floor:0}:c?{x:111,z:648,floor:0}:{x:Math.round(120+10*Math.cos(s)),z:Math.round(645+8*Math.sin(s)),floor:0},fatiguePercent:0,combatLvl:o===1?3:40,sleeping:o===5,inCombat:o===3,dir:o===3?9:void 0,appearance:o%2==0?qu:Ju,serverTick:Math.floor(e/700),hits:o===3?14:30,maxHits:30,dmg:o===3&&Math.floor(e/700)%4==0?[3,0,7][Math.floor(e/2800)%3]:void 0,msg:o===0?i:void 0,msgTick:o===0?r:void 0,bubble:o===1?156:void 0,bubbleTick:o===1?r:void 0,projectiles:o===0&&Math.floor(e/700)%2==0?[{sprite:1,from:9203,fromNpc:!1,to:9106,toPlayer:!1},{sprite:2,from:9108,fromNpc:!0,to:9202,toPlayer:!0}]:void 0,npcs:o===0?[{serverIndex:9101,id:11,name:`walker-north`,inCombat:!1,x:116,z:652-Math.floor(e/700)%8},{serverIndex:9102,id:11,name:`walker-plusx`,inCombat:!1,x:112+Math.floor(e/700)%8,z:655},{serverIndex:9103,id:11,name:`brawler-a`,inCombat:!0,x:117,z:648,dir:8,hp:5,maxHp:15,dmg:Math.floor(e/700)%3==2?2:void 0,dmgTick:Math.floor(e/700)},{serverIndex:9104,id:11,name:`brawler-b`,inCombat:!0,x:117,z:648,dir:9,hp:12,maxHp:15},{serverIndex:9105,id:19,name:`rat-foe`,inCombat:!0,x:112,z:650,dir:8,hp:7,maxHp:10},{serverIndex:9106,id:95,name:`Banker`,inCombat:!1,x:114,z:646,msg:a,msgTick:r},{serverIndex:9107,id:11,name:`gossip-a`,inCombat:!1,x:117,z:645,msg:`Have you heard about the goblins down by the bridge?`,msgTick:r},{serverIndex:9108,id:11,name:`gossip-b`,inCombat:!1,x:118,z:645,msg:`You don't say! Terrible business that.`,msgTick:r},...Math.floor(e/2800)%2==0?[{serverIndex:7001,id:3,name:`Sheep`,inCombat:!1,x:124,z:653}]:[]]:[{serverIndex:o*2,id:[95,3,6,11,76,2,63,306][o%8],name:`npc${o}`,inCombat:!1,x:Math.round(115+12*Math.sin(s)),z:Math.round(650+6*Math.cos(s))}],players:o===0?[{serverIndex:9201,id:0,name:`pwalker`,inCombat:!1,x:118,z:652-Math.floor(e/700)%8,appearance:Ju,bubble:n<2?376:null,bubbleTick:n<2?r:null},{serverIndex:9202,id:0,name:`runeguy`,inCombat:!1,x:114,z:646,appearance:qu,combatLvl:87,msg:n===0?`So then I told him the quickest route to Varrock runs straight past the windmill and over the bridge by the old farmhouse`:null,msgTick:r},{serverIndex:9203,id:0,name:`duel-a`,inCombat:!0,x:112,z:644,dir:8,appearance:qu,combatLvl:62,skulled:!0,hp:9,maxHp:25,dmg:Math.floor(e/700)%3==0?4:void 0,dmgTick:Math.floor(e/700)},{serverIndex:9204,id:0,name:`duel-b`,inCombat:!0,x:112,z:644,dir:9,appearance:Ju,combatLvl:58,hp:21,maxHp:25,dmg:Math.floor(e/700)%3==1?0:void 0,dmgTick:Math.floor(e/700)}]:[],objects:o===0?[{serverIndex:9001,id:4,name:`Treestump`,inCombat:!1,x:119,z:640},{serverIndex:9004,id:98,name:`Rock`,inCombat:!1,x:116,z:642,dir:0,respawnId:102,respawnName:`Mithril rock`,respawnTicks:40-Math.floor(e/700)%40},{serverIndex:9005,id:97,name:`Fire`,inCombat:!1,x:121,z:647}]:[],groundItems:o===0?[{serverIndex:1,id:10,name:`Coins`,inCombat:!1,x:113,z:647},{serverIndex:5,id:20,name:`Bones`,inCombat:!1,x:113,z:647},{serverIndex:2,id:81,name:`Rune long sword`,inCombat:!1,x:114,z:648},{serverIndex:3,id:20,name:`Bones`,inCombat:!1,x:113,z:648},{serverIndex:4,id:373,name:`Lobster`,inCombat:!1,x:113,z:649}]:[],wallObjects:o===0?[{serverIndex:9002,id:2,name:`Door`,inCombat:!1,x:120,z:655,dir:1}]:[]})}if(new URLSearchParams(location.search).has(`stacktest`))for(let n=0;n<20;n++)t.push({username:`stack${n}`,status:`online`,scriptClass:null,description:null,serverIndex:4e4+n,position:{x:122,z:662,floor:0},fatiguePercent:0,sleeping:!1,inCombat:!1,appearance:qu,serverTick:Math.floor(e/700),hits:30,maxHits:30});if(Yu>0){let n=[],r=[];for(let e=0;e<Yu;e++)n.push({serverIndex:2e4+e,id:[11,3,19,63,76][e%5],name:`stress${e}`,inCombat:!1,x:90+e%40,z:610+Math.floor(e/40)});for(let e=0;e<Yu/2;e++)r.push({serverIndex:3e4+e,id:0,name:`sp${e}`,inCombat:!1,appearance:qu,x:90+e%30,z:700+Math.floor(e/30)});t.push({username:`stressbot`,status:`online`,scriptClass:null,description:null,position:{x:100,z:655,floor:0},fatiguePercent:0,sleeping:!1,inCombat:!1,serverTick:Math.floor(e/700),npcs:n,players:r})}return t}function Zu(e){let t=Math.floor(e/700);return[{serverIndex:7001,id:3,name:`Sheep`,x:121,z:651,t:29-t%30},{serverIndex:7002,id:63,name:`Skeleton`,x:110,z:653,t:60-t%60,tMin:Math.max(0,60-t%60-56),assumed:!0,checkedAgo:t%60}]}function Qu(){let[e,t]=(0,l.useState)(()=>Xu(0));(0,l.useEffect)(()=>{if(new URLSearchParams(location.search).has(`static`))return;let e=setInterval(()=>t(Xu(performance.now())),700);return()=>clearInterval(e)},[]);let[n,r]=(0,l.useState)(`fakebot0`);window.__selected=n,window.__setSel=r;let i=[{x:120,z:645,hop:!1},{x:118,z:647,hop:!1},{x:115,z:649,hop:!1},{x:113,z:652,hop:!1},{x:113,z:656,hop:!0},{x:118,z:658,hop:!1},{x:122,z:658,hop:!1}],a=new URLSearchParams(location.search).get(`useitem`),[o,s]=(0,l.useState)(()=>a?{id:parseInt(a,10),name:`Tinderbox`}:null);return window.__useItem=o,(0,vl.jsx)(`div`,{style:{width:`100vw`,height:`100vh`},children:(0,vl.jsx)(Ku,{bots:e,npcRespawns:Zu(performance.now()),route:i,walkTool:new URLSearchParams(location.search).has(`walktool`),useItem:o,onUseItemDone:()=>s(null),selectedBot:n,onSelectBot:r})})}(0,u.createRoot)(document.getElementById(`root`)).render((0,vl.jsx)(Qu,{}));
//# sourceMappingURL=index-ZbTJq0tf.js.map