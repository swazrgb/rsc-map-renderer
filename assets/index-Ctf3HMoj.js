...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(e,t,n){let r=new Float32Array(no),i=new J(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(){return new Vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(){return new Vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
	...
	`}var xo=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ks={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function qs(e,t){let n=Ks[t];return n===void 0?(G(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Js=new J;function Ys(){return wt.getLuminanceCoefficients(Js),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Js.x.toFixed(4)}, ${Js.y.toFixed(4)}, ${Js.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Rs(i,i.VERTEX_SHADER,y),S=Rs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ws(i,x,`vertex`),n=Ws(i,S,`fragment`);K(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,td=1<<27,nd=(e,t)=>e>=0&&e<4096&&t>=0&&t<4096?td|e<<12|t:0,rd=(e,t,n)=>e>=0&&e<4096&&t>=0&&t<4096?201326592|(n&3)<<24|e<<12|t:0;function id(e,t,n,r,i){let a=new DataView(e);if(a.getUint32(0)!==1381188403)throw Error(`bad cell magic`);let o=n*128,s=r*128,c=a.getUint16(16),l=18,u=[];for(let d=0;d<c;d++){let c=a.getInt16(l),d=a.getInt32(l+2);l+=6;let f=new Float32Array(d*3);for(let e=0;e<d;e++){let c=a.getInt16(l),u=c+o,d=a.getInt16(l+2),p=a.getInt16(l+4),m=p+s;l+=6,i&&c%128==0&&p%128==0&&i(n+c/128,r+p/128,-d),f[e*3]=t-u,f[e*3+1]=-d,f[e*3+2]=m}let p=new Uint8Array(e,l,d);l+=d;let m=new Uint8Array(e,l,d*3);l+=d*3;let h=null;if(c>=0){h=new Float32Array(d*2);for(let e=0;e<d*2;e++)h[e]=a.getInt16(l)/512,l+=2}let g=new _r;g.setAttribute(`position`,new X(f,3)),g.setAttribute(`shade`,new X(new Float32Array(p),1)),g.setAttribute(`base`,new X(new Uint8Array(m),3,!0)),h&&g.setAttribute(`uv`,new X(h,2)),u.push({tex:c,geometry:g})}return u}function ad(e){let t=(0,l.useRef)(null),n=()=>{let e=new URLSearchParams(location.search).get(`floor`);return Gu.some(t=>t.key===e)?e:`ground`},[r,i]=(0,l.useState)(n),a=e.overlays!=null,o=e.floorIndex==null?r:Gu[Math.max(0,Math.min(3,e.floorIndex))].key,s=t=>{e.onFloorIndexChange?e.onFloorIndexChange(Gu.findIndex(e=>e.key===t)):i(t)};(0,l.useEffect)(()=>{if(e.floorIndex!=null){let t=n();t!==Gu[e.floorIndex]?.key&&e.onFloorIndexChange?.(Gu.findIndex(e=>e.key===t))}},[]);let[c,u]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`roofs`)!==`0`),[f,p]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`sight`)!==`0`),[h,g]=(0,l.useState)(()=>new URLSearchParams(location.search).get(`tags`)===`1`),_=e.overlays?.roofs??c,v=e.overlays?.sight??f,y=e.overlays?.tags??h,b=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:t,sight:v,tags:y}):u(t),x=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:t,tags:y}):p(t),S=t=>e.onOverlaysChange?e.onOverlaysChange({roofs:_,sight:v,tags:t}):g(t),[C,w]=(0,l.useState)(`loading manifest…`),[T,E]=(0,l.useState)(``),[D,O]=(0,l.useState)(null),[k,A]=(0,l.useState)(null);(0,l.useEffect)(()=>{El().then(A).catch(()=>{})},[]);let[j,M]=(0,l.useState)([]);(0,l.useEffect)(()=>{let e=!1,t=()=>Tl().then(t=>{e||M(t)}).catch(()=>{e||setTimeout(t,5e3)});return t(),()=>{e=!0}},[]);let[N,ee]=(0,l.useState)(!1),P=(0,l.useRef)(null),F=(0,l.useRef)(new Set),I=(0,l.useRef)([]),[te,ne]=(0,l.useState)(null),re=(0,l.useRef)(!1);re.current=te!=null;let ie=(0,l.useRef)(null);(0,l.useEffect)(()=>{e.onFlyingChange?.(N)},[N]);let ae=(0,l.useRef)(e.flyNonce??0);(0,l.useEffect)(()=>{e.flyNonce==null||e.flyNonce===ae.current||(ae.current=e.flyNonce,P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0)))},[e.flyNonce]),(0,l.useEffect)(()=>{if(!e.follow)return;let t=(e.bots??[]).find(t=>t.username===e.follow)?.position?.floor;t!=null&&Gu[t]&&Gu[t].key!==o&&s(Gu[t].key)},[e.follow,e.bots]),(0,l.useEffect)(()=>{if(e.visible===!1)return;let t=setTimeout(()=>ie.current?.(),60);return()=>clearTimeout(t)},[e.visible]);let L=(0,l.useRef)({manifest:null,floor:`ground`,roofs:!0,sight:!0,tags:!0,focusBot:e.focus??{x:120,z:640},entities:[],entitiesRev:0,groundItems:[],observed:[],observedDoors:[],observedRev:0,respawnGhosts:[],route:null}),R=(0,l.useRef)(e);R.current=e,L.current.floor=o,L.current.roofs=_,L.current.sight=v,L.current.tags=y,L.current.route=e.route??null,e.focus&&(L.current.focusBot=e.focus);{let t=Xu(o).plane,n=[],r=new Map,i=new Map,a=(e,t)=>{t.msg!=null&&t.msgTick!=null&&(e.msgTick==null||t.msgTick>e.msgTick)&&(e.msg=t.msg,e.msgTick=t.msgTick)},s=new Set;for(let t of e.bots??[])t.serverIndex!=null&&s.add(t.serverIndex);for(let o of e.bots??[]){let c=o.position;c&&c.floor===t&&n.push({key:`bot:${o.username}`,kind:`bot`,x:c.x,z:c.z-c.floor*944,name:o.username,selected:o.username===e.selectedBot,inCombat:o.inCombat??!1,appearance:o.appearance,dir:o.dir,hp:o.hits,maxHp:o.maxHits,dmg:o.dmg,dmgTick:o.dmg==null?null:o.serverTick,msg:o.msg,msgTick:o.msgTick,bubble:o.bubble,bubbleTick:o.bubbleTick,sleeping:o.sleeping});for(let e of o.npcs??[]){if(Math.floor(e.z/944)!==t)continue;let i=r.get(e.serverIndex);if(i){a(i,e);continue}let o={key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,npcId:e.id,dir:e.dir,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick};r.set(e.serverIndex,o),n.push(o)}for(let e of o.players??[]){if(Math.floor(e.z/944)!==t||s.has(e.serverIndex))continue;let r=i.get(e.serverIndex);if(r){a(r,e);continue}let o={key:`pl:${e.serverIndex}`,kind:`player`,x:e.x,z:e.z%944,name:e.name,inCombat:e.inCombat,appearance:e.appearance,dir:e.dir,combatLvl:e.combatLvl,skulled:e.skulled,hp:e.hp,maxHp:e.maxHp,dmg:e.dmg,dmgTick:e.dmgTick,msg:e.msg,msgTick:e.msgTick,bubble:e.bubble,bubbleTick:e.bubbleTick};i.set(e.serverIndex,o),n.push(o)}}let c=new Map;for(let t of e.npcRespawns??[])c.set(t.serverIndex,t);for(let e of j){if(Math.floor(e.z/944)!==t||r.has(e.serverIndex))continue;let i=c.get(e.serverIndex);n.push({key:`npc:${e.serverIndex}`,kind:`npc`,x:e.x,z:e.z%944,name:e.name,inCombat:!1,npcId:e.id,ghost:!0,respawnTicks:i?.t??null,respawnTicksMin:i?.tMin??null,respawnAssumed:i?.assumed??null,respawnCheckedAgo:i?.checkedAgo??null})}L.current.entities=n,L.current.entitiesRev++;let l=[],u=new Set;for(let n of e.bots??[])for(let e of n.groundItems??[]){if(Math.floor(e.z/944)!==t)continue;let n=`${e.id}:${e.x},${e.z}`;u.has(n)||(u.add(n),l.push({id:e.id,x:e.x,z:e.z%944,name:e.name}))}L.current.groundItems=l;let d=[],f=new Set;for(let t of e.bots??[])for(let e of t.objects??[]){let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;f.has(n)||(f.add(n),d.push({plane:t,x:e.x,z:e.z%944,id:e.id}))}L.current.observed=d;let p=[],m=new Set;for(let t of e.bots??[])for(let e of t.wallObjects??[]){if(e.dir==null)continue;let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944},${e.dir}`;m.has(n)||(m.add(n),p.push({plane:t,x:e.x,z:e.z%944,dir:e.dir,id:e.id}))}L.current.observedDoors=p,L.current.observedRev++;let h=[],g=new Set;for(let t of e.bots??[])for(let e of t.objects??[]){if(e.respawnId==null||e.respawnTicks==null)continue;let t=Math.floor(e.z/944),n=`${t}:${e.x},${e.z%944}`;g.has(n)||(g.add(n),h.push({plane:t,x:e.x,z:e.z%944,dir:e.dir??0,id:e.respawnId,name:e.respawnName??null,t:e.respawnTicks}))}L.current.respawnGhosts=h;{let t=new Map;for(let n of e.bots??[])n.serverIndex!=null&&t.set(n.serverIndex,n.username);let r=new Map;for(let e of n)r.set(e.key,e);let i=performance.now();for(let n of e.bots??[])for(let e of n.projectiles??[]){let a=`${n.serverTick}:${e.sprite}:${e.fromNpc?`n`:`p`}${e.from}:${e.toPlayer?`p`:`n`}${e.to}`;if(F.current.has(a))continue;F.current.add(a);let o=e.fromNpc?`npc:${e.from}`:t.has(e.from)?`bot:${t.get(e.from)}`:`pl:${e.from}`,s=e.toPlayer?t.has(e.to)?`bot:${t.get(e.to)}`:`pl:${e.to}`:`npc:${e.to}`,c=r.get(o),l=r.get(s);!c||!l||I.current.push({key:a,sprite:e.sprite,fromKey:o,toKey:s,start:i,fx:c.x,fz:c.z,tx:l.x,tz:l.z})}I.current=I.current.filter(e=>i-e.start<1e3),F.current.size>2e3&&F.current.clear()}}return(0,l.useEffect)(()=>{let e=t.current;if(!e)return;let n=new al({antialias:!0});n.setPixelRatio(window.devicePixelRatio),e.appendChild(n.domElement);let r=new wn;r.background=new Sn(1052698);let i=new ba(-1,1,1,-1,-4e5,4e5),a=new J,o=new URLSearchParams(location.search),s=e=>{if(e==null)return null;let t=parseFloat(e);return Number.isFinite(t)?t:null},c=(s(o.get(`yaw`))??45)*Math.PI/180,l=(s(o.get(`pitch`))??45.8)*Math.PI/180,u=.02,f=1.5533;l=Math.max(u,Math.min(f,l));let p=2e5,h=1024*128,g=null,_=()=>{g||=setTimeout(()=>{g=null;let e=L.current.manifest;if(!e)return;let t=e.botXTiles*128,n=new URLSearchParams(location.search);n.set(`floor`,L.current.floor),n.set(`roofs`,L.current.roofs?`1`:`0`),n.set(`sight`,L.current.sight?`1`:`0`),n.set(`tags`,L.current.tags?`1`:`0`),n.set(`x`,((t-a.x)/128).toFixed(1)),n.set(`z`,(a.z/128).toFixed(1)),n.set(`zoom`,(N/128).toFixed(1)),n.set(`yaw`,(c*180/Math.PI).toFixed(1)),n.set(`pitch`,(l*180/Math.PI).toFixed(1)),history.replaceState(null,``,`${location.pathname}?${n}`)},400)},v=()=>{let e=5120;a.x=Math.max(-5120,Math.min(h+e,a.x)),a.y=Math.max(-3e3,Math.min(3e3,a.y)),a.z=Math.max(-5120,Math.min(h+e,a.z));let t=Math.cos(l);i.position.set(a.x+p*t*Math.sin(c),a.y+p*Math.sin(l),a.z+p*t*Math.cos(c)),i.up.set(0,1,0),i.lookAt(a);let n=R.current.sharedView,r=L.current.manifest;n&&r&&(n.current={x:(r.botXTiles*128-a.x)/128,z:a.z/128,zoom:N/128}),_(),window.__w3d={target:{x:a.x,y:a.y,z:a.z},yaw:c,pitch:l,viewHeightUnits:N}},y=()=>{let e=Math.sin(c),t=Math.cos(c),n=Math.sin(l),r=Math.cos(l);return{right:new J(t,0,-e),up:new J(-n*e,r,-n*t)}},b=()=>{let e=Math.sin(l);if(e<.15||a.y===0)return;let t=a.y/e,n=Math.cos(l);a.x-=n*Math.sin(c)*t,a.z-=n*Math.cos(c)*t,a.y=0},x=new Lt(1,1),S=new Lt(1,1),C=new Uint8Array(4),T=new Uint8Array(4),D=(e,t)=>{let a=n.domElement.getBoundingClientRect();if(!a.width||!a.height)return null;let o=(e-a.left)/a.width*2-1,s=-((t-a.top)/a.height*2-1),u=o*i.right,d=s*i.top,f=2*i.right/a.width,p=i.clone();p.left=u-f,p.right=u+f,p.bottom=d-f,p.top=d+f,p.updateProjectionMatrix();let m=n.getRenderTarget(),h=n.getClearColor(new Sn),g=n.getClearAlpha(),_=r.background;r.background=null;for(let e of zt.values())e.uniforms.pickMode.value=2,e.blending=0;let v=[];for(let e of r.children)e.userData.noPick&&e.visible&&(e.visible=!1,v.push(e));n.setRenderTarget(x),n.setClearColor(16777215,1),n.clear(),n.render(r,p),n.readRenderTargetPixels(x,0,0,1,1,C);for(let e of v)e.visible=!0;n.setRenderTarget(m),n.setClearColor(h,g),r.background=_;for(let e of zt.values())e.uniforms.pickMode.value=0,e.blending=1;let b=C[0]/255+C[1]/65025+C[2]/(65025*255);if(window.__pickDebug={buf:[C[0],C[1],C[2],C[3]],d:b,vx:u,vy:d,near:i.near,far:i.far},b>=.9999)return null;let S=i.near+b*(i.far-i.near),{right:w,up:T}=y(),E=new J(-Math.cos(l)*Math.sin(c),-Math.sin(l),-Math.cos(l)*Math.cos(c));return i.position.clone().addScaledVector(w,u).addScaledVector(T,d).addScaledVector(E,S)},k=new Ra,A=(e,t)=>{let r=n.domElement.getBoundingClientRect();if(r.width===0||r.height===0)return null;let o=new q((e-r.left)/r.width*2-1,-((t-r.top)/r.height)*2+1);k.setFromCamera(o,i);let s=-k.ray.origin.y/k.ray.direction.y;if(!isFinite(s)||s<0)return null;let c=k.ray.origin.clone().addScaledVector(k.ray.direction,s),l=2*Math.hypot(i.right,i.top),u=c.clone().sub(a);return u.y=0,u.length()>l&&c.sub(u).add(u.setLength(l)),c},j=(e,t,n)=>{let r=Math.max(u,Math.min(f,l+n))-l,o=new J(Math.cos(c),0,-Math.sin(c)),s=new _t().setFromAxisAngle(new J(0,1,0),t).multiply(new _t().setFromAxisAngle(o,-r)),d=i.position.clone().sub(e).applyQuaternion(s).add(e),p=a.clone().sub(e).applyQuaternion(s).add(e),m=d.sub(p),h=m.length();l=Math.max(u,Math.min(f,Math.asin(Math.max(-1,Math.min(1,m.y/h))))),c=Math.atan2(m.x,m.z);let g=Math.sin(l);if(g>=.15){let e=-p.y/g;a.set(p.x+m.x/h*e,0,p.z+m.z/h*e)}else a.copy(p),a.y=Math.max(-3e3,Math.min(3e3,a.y));v()},M=new URLSearchParams(location.search),N=(s(M.get(`zoom`))??60)*128,F=()=>{let t=e.clientWidth||800,r=e.clientHeight||600;n.setSize(t,r);let a=t/r;i.left=-N*a/2,i.right=N*a/2,i.top=N/2,i.bottom=-N/2,i.updateProjectionMatrix()},te=new ResizeObserver(F);te.observe(e),ie.current=()=>{let e=L.current.manifest;if(!e)return;let t=R.current.sharedView?.current;if(!t)return;let n=e.botXTiles*128;a.x=n-t.x*128,a.z=t.z*128,t.zoom>0&&(N=t.zoom*128,F()),v()};let ae=new Map;Promise.all([Cl(),wl()]).then(([e,t])=>{for(let t of e){let e=it(t.floor,t.x,t.z),n=$e.get(e);n||$e.set(e,n=[]),n.push(t),et.set(at(t.floor,t.x,t.z),t)}for(let e of G)rt.add(e);let n=new Map;for(let e of t.entries)n.set(`${e.id}_${e.dir}`,{name:e.name,tw:e.tw,th:e.th});for(let t of e){let e=n.get(`${t.id}_${t.dir}`),r=e?.tw??1,i=e?.th??1,a={id:t.id,dir:t.dir,name:e?.name??`object ${t.id}`,ax:t.x,az:t.z};for(let e=0;e<r;e++)for(let n=0;n<i;n++){let r=`${t.floor}:${t.x+e},${t.z+n}`,i=ae.get(r);i||ae.set(r,i=[]),i.push(a)}}}).catch(()=>{});let oe=null,se=``,ce=null,le=null,ue=e=>e?e.type===`entity`?`${e.kind} ${e.name??e.key}`+(e.npcId==null?``:` (id ${e.npcId})`)+` · tile ${Math.round(e.x)},${Math.round(e.z)}`+(e.inCombat?` · in combat`:``):e.type===`object`?`${e.name} (id ${e.id}, dir ${e.dir}, anchor ${e.ax},${e.az}, ${e.w}x${e.h})`:e.type===`wall`?`${e.name} (boundary ${e.id}, dir ${e.dir}, edge ${e.x},${e.z})`:e.type===`grounditem`?`${e.name??`item`} (id ${e.id}) · tile ${Math.round(e.x)},${Math.round(e.z)}`:`tile ${e.x},${e.z} · h ${H(e.x,e.z).toFixed(0)}`:``,de=e=>{Rt(e);let t=ue(e);t!==se&&(se=t,E(t))},fe=(e,t)=>{L.current.manifest&&de(It(e,t,!0))},pe=e=>{let t=Fe.current().find(t=>t.key===e);de(t?{type:`entity`,...t}:null)},z=null,me=new Map,he=null,ge=(e,t,r)=>{let o=n.domElement.getBoundingClientRect(),s=o.width?(e-o.left)/o.width*2-1:0,c=o.height?-((t-o.top)/o.height*2-1):0,l=i.right,u=i.top,d=N;N=Math.min(1024*128,Math.max(768,N*r));let f=N/d;F();let{right:p,up:m}=y();a.addScaledVector(p,s*l*(1-f)).addScaledVector(m,c*u*(1-f)),b(),v()},_e=()=>{let[e,t]=[...me.values()];return{dist:Math.hypot(e.x-t.x,e.y-t.y),midX:(e.x+t.x)/2,midY:(e.y+t.y)/2,angle:Math.atan2(t.y-e.y,t.x-e.x)}},ve=()=>{let e=_e();he={...e,pivot:D(e.midX,e.midY)??A(e.midX,e.midY)}},ye=()=>{if(!he||me.size<2)return;let e=_e();he.dist>0&&e.dist>0&&ge(e.midX,e.midY,he.dist/e.dist);let t=e.angle-he.angle;t>Math.PI?t-=2*Math.PI:t<-Math.PI&&(t+=2*Math.PI);let n=(e.midY-he.midY)*.008;j(he.pivot??a,-t,n),he.dist=e.dist,he.midX=e.midX,he.midY=e.midY,he.angle=e.angle},be=n.domElement;be.style.touchAction=`none`,e.style.touchAction=`none`,e.addEventListener(`contextmenu`,e=>e.preventDefault()),e.addEventListener(`pointerdown`,t=>{if(P.current&&(P.current=null,ee(!1)),t.pointerType===`touch`&&(me.set(t.pointerId,{x:t.clientX,y:t.clientY}),e.setPointerCapture(t.pointerId),me.size>=2)){z=null,oe={kind:`none`},me.size===2&&ve();return}if(t.button!==0&&t.button!==1&&t.button!==2)return;oe={kind:`none`};let n=t.button===0&&!t.shiftKey?`pan`:`rotate`;t.button===1&&t.preventDefault();let r=t.target.closest?.(`[data-entity-key]`);z={mode:n,button:t.button,pointerId:t.pointerId,lastX:t.clientX,lastY:t.clientY,downX:t.clientX,downY:t.clientY,pivot:n===`rotate`?D(t.clientX,t.clientY)??A(t.clientX,t.clientY):null,plateKey:r?.dataset.entityKey??null},window.__w3dPivot=z.pivot?{x:z.pivot.x,y:z.pivot.y,z:z.pivot.z}:null,e.setPointerCapture(t.pointerId)}),e.addEventListener(`pointermove`,e=>{if(e.pointerType===`touch`&&me.has(e.pointerId)&&(me.set(e.pointerId,{x:e.clientX,y:e.clientY}),he&&me.size>=2)){ye();return}if(!z){let t=e.target.closest?.(`[data-entity-key]`);oe=t?.dataset.entityKey?{kind:`plate`,key:t.dataset.entityKey}:e.target===be?{kind:`canvas`,x:e.clientX,y:e.clientY}:{kind:`none`};return}let t=e.clientX-z.lastX,r=e.clientY-z.lastY;if(z.lastX=e.clientX,z.lastY=e.clientY,z.mode===`rotate`){let e=z.pivot??a;j(e,-t*.008,r*.008)}else{let e=N/(n.domElement.clientHeight||600),{right:i,up:o}=y();a.addScaledVector(i,-t*e).addScaledVector(o,r*e),b(),v()}});let xe=e=>e<-9?`#ff0000`:e<-6?`#ff3000`:e<-3?`#ff7000`:e<0?`#ffb000`:e>9?`#00ff00`:e>6?`#40ff00`:e>3?`#80ff00`:e>0?`#c0ff00`:`#fff`,Se=(e,t)=>{if(e+2304>=2640)return 0;let n=2203-(t+(1776-944*Math.floor(t/944)));return n>0?1+Math.floor(n/6):0},Ce=1,we=(e,t)=>{let n=R.current.selectedBot,r=L.current.manifest;if(!n||!r)return[];let i=Ft(e,t);if(!i)return[];let a=Xu(L.current.floor).plane,o=e=>e+a*944,s=R.current.useItem??null,c=()=>R.current.onUseItemDone?.(),l=[],u=(e,t,r,i,a,o=0)=>Al(n,e,t,r,i,a,o).catch(()=>{}),d=i.bot??i.ent;if(d&&!d.ghost&&d.kind===`npc`&&d.npcId!=null){let e=parseInt(d.key.slice(4),10),t=d.name??He.info(d.npcId)?.name??`npc`,r=Math.round(d.x),i=o(Math.round(d.z)),a=He.info(d.npcId);if(s)l.push({verb:`Use ${s.name} with`,target:t,tcolor:`#ff0`,prio:710,run:()=>{u(`use_item_on_npc`,r,i,e,Ce++,s.id),c()}});else{let o=(R.current.bots??[]).find(e=>e.username===n);if(a?.atk){let n=(o?.combatLvl??0)-(a.lvl??0);l.push({verb:`Attack`,target:t,tcolor:`#ff0`,suffix:` (level-${a.lvl})`,scolor:xe(n),prio:n>=0?715:2715,run:()=>u(`npc_attack`,r,i,e,Ce++)})}l.push({verb:`Talk-to`,target:t,tcolor:`#ff0`,prio:720,run:()=>u(`npc_talk`,r,i,e,Ce++)}),a?.cmd1&&l.push({verb:a.cmd1,target:t,tcolor:`#ff0`,prio:725,run:()=>u(`npc_command1`,r,i,e,Ce++)}),a?.cmd2&&l.push({verb:a.cmd2,target:t,tcolor:`#ff0`,prio:833,run:()=>u(`npc_command2`,r,i,e,Ce++)})}}else if(d&&(d.kind===`player`||d.kind===`bot`)&&!(d.kind===`bot`&&d.name===n)){let e=d.kind===`player`?parseInt(d.key.slice(3),10):(R.current.bots??[]).find(e=>e.username===d.name)?.serverIndex,t=d.name??`player`,n=Math.round(d.x),r=o(Math.round(d.z));e!=null&&!s&&(Se(n,r)>0?l.push({verb:`Attack`,target:t,tcolor:`#fff`,prio:805,run:()=>u(`player_attack`,n,r,e,Ce++)}):l.push({verb:`Duel with`,target:t,tcolor:`#fff`,prio:2806,run:()=>u(`player_duel`,n,r,e,Ce++)}),l.push({verb:`Trade with`,target:t,tcolor:`#fff`,prio:2810,run:()=>u(`player_trade`,n,r,e,Ce++)}),l.push({verb:`Follow`,target:t,tcolor:`#fff`,prio:2820,run:()=>u(`player_follow`,n,r,e,Ce++)}))}for(let e of i.ground){let t=Math.round(e.x),n=o(Math.round(e.z));s?l.push({verb:`Use ${s.name} with`,target:e.name??`item`,tcolor:`#ff9040`,prio:210,run:()=>{u(`use_item_on_ground_item`,t,n,e.id,Ce++,s.id),c()}}):l.push({verb:`Take`,target:e.name??`item`,tcolor:`#ff9040`,prio:220,run:()=>u(`ground_item`,t,n,e.id,Ce++)})}if(i.wall?.type===`wall`){let e=i.wall,t=dt?.get(e.id),n=o(e.z);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:310,run:()=>{u(`use_item_on_wall_object`,e.x,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:320,run:()=>u(`wall_object`,e.x,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2300,run:()=>u(`wall_object2`,e.x,n,e.id,e.dir)}))}if(i.obj?.type===`object`){let e=i.obj,t=W?.objects.get(e.id),n=o(e.az);s?l.push({verb:`Use ${s.name} with`,target:e.name,tcolor:`#0ff`,prio:410,run:()=>{u(`use_item_on_object`,e.ax,n,e.id,e.dir,s.id),c()}}):(t?.cmd1&&l.push({verb:t.cmd1,target:e.name,tcolor:`#0ff`,prio:420,run:()=>u(`object`,e.ax,n,e.id,e.dir)}),t?.cmd2&&l.push({verb:t.cmd2,target:e.name,tcolor:`#0ff`,prio:2400,run:()=>u(`object2`,e.ax,n,e.id,e.dir)}))}if(i.tile){let e=i.tile;l.push({verb:`Walk here`,prio:920,run:()=>{kl(n,{x:e.x,z:o(e.z)}).catch(()=>{}),s&&c()}})}return l.sort((e,t)=>e.prio-t.prio),l},Te=(t,n)=>{let r=we(t,n);if(r.length===0)return;r.push({verb:`Cancel`,prio:4e3});let i=e.getBoundingClientRect();ne({x:t-i.left,y:n-i.top,entries:r})},Ee=t=>{let n=z&&!z.noClick&&Math.hypot(t.clientX-z.downX,t.clientY-z.downY)<4;if(n&&re.current){ne(null),z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(n&&z.button===2&&(R.current.walkTool||R.current.useItem)&&R.current.selectedBot){Te(t.clientX,t.clientY),z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId);return}if(z&&z.button===0&&!z.noClick&&Math.hypot(t.clientX-z.downX,t.clientY-z.downY)<4){let e=z.plateKey?Fe.current().find(e=>e.key===z.plateKey):null,n=e?{type:`entity`,...e}:It(t.clientX,t.clientY),r=R.current.selectedBot;if((R.current.walkTool||R.current.useItem)&&r&&n){let n=we(t.clientX,t.clientY);if(e&&n.length){let t=e.name??``,r=n.filter(e=>e.target===t);r.length&&(n=r)}n[0]?.run?.()}else n?.type===`entity`?(Fe.selectedEntityKey=n.key,n.kind===`bot`?(R.current.onSelectBot?.(n.key.slice(4)),O(null)):O({kind:n.kind,name:n.name??null,npcId:n.npcId??null,key:n.key,inCombat:!!n.inCombat,appearance:n.appearance})):n?.type===`object`?O({kind:`object`,name:n.name,npcId:n.id,key:`obj:${n.ax},${n.az}`,inCombat:!1}):n?.type===`wall`?O({kind:`boundary`,name:n.name,npcId:n.id,key:`wall:${n.x},${n.z},${n.dir}`,inCombat:!1}):(Fe.selectedEntityKey=null,O(null))}z=null,e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId)},De=t=>{if(t.pointerType===`touch`){let n=me.delete(t.pointerId);if(he){if(e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),me.size<2)if(he=null,me.size===1){let[[e,t]]=[...me.entries()];z={mode:`pan`,button:0,pointerId:e,lastX:t.x,lastY:t.y,downX:t.x,downY:t.y,pivot:null,plateKey:null,noClick:!0}}else z=null;return}if(!n)return}Ee(t)};e.addEventListener(`pointerup`,De),e.addEventListener(`pointercancel`,De),e.addEventListener(`pointerleave`,()=>{z||(oe={kind:`none`})}),e.addEventListener(`lostpointercapture`,e=>{z&&z.pointerId===e.pointerId&&(z=null)}),e.addEventListener(`wheel`,e=>{e.preventDefault(),ge(e.clientX,e.clientY,1.0015**e.deltaY)},{passive:!1});let Oe=1009,B=[null,null,null,null],ke=e=>{let t=B[e];return t||(t=new Float32Array(Oe*Oe).fill(NaN),B[e]=t),t},Ae=Xu(L.current.floor).plane,je=(e,t,n,r)=>{t>=0&&t<Oe&&n>=0&&n<Oe&&(e[n*Oe+t]=r)},V=(e,t,n)=>{if(t<0||t>=Oe||n<0||n>=Oe)return 0;let r=e[n*Oe+t];return Number.isNaN(r)?0:r},Me=(e,t,n)=>{let r=t+.5,i=n+.5,a=Math.floor(r),o=Math.floor(i),s=r-a,c=i-o,l=V(e,a,o),u=V(e,a+1,o),d=V(e,a,o+1),f=V(e,a+1,o+1);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c},H=(e,t)=>Me(ke(Ae),e,t),U=e=>(t,n)=>Me(ke(e),t,n),Ne=(e,t)=>{let n=H(e+.5,t)-H(e-.5,t),r=H(e,t+.5)-H(e,t-.5);return new J(n/128,1,-r/128).normalize()},Pe=document.createElement(`div`);Pe.style.cssText=`position:absolute;inset:0;overflow:hidden;pointer-events:none;user-select:none;`,e.appendChild(Pe);let Fe=new Ul(r,Pe),Ie=-1,Le=new Iu(r),Re=new Fu(r,5088255,.6,.16),ze,Be=null,Ve=(e,t)=>{let n=[],r=[];for(let t of L.current.route??[]){let i=Math.floor(t.z/944)===e;(t.hop||!i)&&(r.length>1&&n.push({pts:r,closed:!1}),r=[]),i&&r.push({x:t.x,z:t.z%944})}r.length>1&&n.push({pts:r,closed:!1}),Re.extrude(n,t)},He=new du(r),Ue=new Su(r);Fe.npcDims=e=>He.dims(e);let We=!1,Ge=()=>{We||Fe.chatFont||(We=!0,Ou().then(e=>{Jt||(Fe.chatFont=e)}).catch(()=>{We=!1}))};Ge();let Ke=new Tu(r),qe=new Vu(r),Je=!1,Ye=()=>{Je||(Je=!0,nu().then(e=>{if(Jt||!e){Je=!1;return}He.setAtlas(e)}))},Ze=!1,Qe=()=>{Ze||(Ze=!0,Cu().then(e=>{if(Jt||!e){Ze=!1;return}Ke.setAtlas(e),Fe.itemFrame=t=>{let n=e.frames.get(t);return n?{x:n.x,y:n.y,w:n.w,h:n.h,atlasW:e.width,atlasH:e.height}:null}}))},W=null,$e=new Map,et=new Map,tt=new Map,nt=new Map,rt=new Set,G=new Set,K=-1,it=(e,t,n)=>`${e}:${Math.floor((t-24)/48)},${Math.floor((n-24)/48)}`,at=(e,t,n)=>`${e}:${t},${n}`,ot=new Map,st=new Map,ct=e=>{let t=nt.get(e);t&&(r.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),nt.delete(e));let n=ot.get(e);if(n){for(let e of n)r.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});ot.delete(e)}let i=st.get(e);if(i){for(let{group:e}of i)r.remove(e),e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});st.delete(e)}},lt=e=>nd(e.x,e.z),ut=e=>{let t=L.current.manifest;if(!W||!t)return;ct(e);let n=$e.get(e)??[],i=parseInt(e.split(`:`)[0],10),a=[],o=new Set;for(let e of n){let t=at(i,e.x,e.z);o.add(t);let n=tt.get(t);a.push({id:n??e.id,dir:e.dir,x:e.x,z:e.z})}for(let[t,n]of tt){let[r,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(r,10)!==i||o.has(t))continue;let[c,l]=s.split(`,`).map(Number);it(i,c,l)===e&&a.push({id:n,dir:0,x:c,z:l})}if(a.length===0)return;let s=t.botXTiles*128,c=U(i),l=a.filter(e=>W.anims.has(e.id)),u=a.filter(e=>e.id===qu),d=a.filter(e=>!W.anims.has(e.id)&&e.id!==qu);if(d.length>0){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=i;for(let{tex:e,geometry:r}of Kl(W,d,s,c,lt))n.add(new ai(r,Vt(e,t.baked)));n.visible=i===Ae,nt.set(e,n),r.add(n)}if(l.length>0){let n=Math.max(...l.map(e=>W.anims.get(e.id).length)),a=[];for(let e=0;e<n;e++){let n=new hn;n.userData.kind=`scenery`,n.userData.plane=i;let o=l.map(t=>{let n=W.anims.get(t.id);return{...t,model:n[e%n.length]}});for(let{tex:e,geometry:r}of Kl(W,o,s,c,lt))n.add(new ai(r,Vt(e,t.baked)));n.visible=i===Ae&&e===0,a.push(n),r.add(n)}ot.set(e,a)}if(u.length>0){let n=[];for(let e of u){let a=ql(W,e,s,c);if(!a)continue;let o=new hn;o.userData.kind=`scenery`,o.userData.plane=i,o.position.copy(a);for(let{tex:n,geometry:r}of Kl(W,[e],s,c,lt))r.translate(-a.x,-a.y,-a.z),o.add(new ai(r,Vt(n,t.baked)));let l=e.dir*32*2*Math.PI/256,u=new J(-Math.cos(l),0,-Math.sin(l)).normalize();o.visible=i===Ae,n.push({group:o,axis:u}),r.add(o)}st.set(e,n)}},dt=null,ft=new Map,pt=new Map,mt=new Map,ht=new Map,gt=(e,t,n,r)=>`${e}:${t},${n},${r}`,vt=e=>{let t=ht.get(e);t&&(r.remove(t),t.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),ht.delete(e))},yt=e=>{let t=L.current.manifest;if(!dt||!t)return;vt(e);let n=ft.get(e)??[],i=parseInt(e.split(`:`)[0],10),a=[],o=new Set;for(let e of n){let t=gt(i,e.x,e.z,e.dir);o.add(t);let n=mt.get(t);a.push(n==null?e:{...e,id:n})}for(let[t,n]of mt){let[r,s]=[t.split(`:`)[0],t.split(`:`)[1]];if(parseInt(r,10)!==i||o.has(t))continue;let[c,l,u]=s.split(`,`).map(Number);it(i,c,l)===e&&a.push({id:n,x:c,z:l,floor:i,dir:u})}if(a.length===0)return;let s=t.botXTiles*128,c=new hn;c.userData.kind=`doors`,c.userData.plane=i;let l=U(i),u=(e,t)=>l(e-.5,t-.5);for(let{tex:e,geometry:n}of tu(dt,a,s,u,e=>rd(e.x,e.z,e.dir)))c.add(new ai(n,Vt(e,t.baked)));c.visible=i===Ae,ht.set(e,c),r.add(c)},Y=!1,bt=()=>{dt||Y||(Y=!0,Jl().then(e=>{if(Y=!1,!(Jt||!e)){dt=e.defs;for(let t of e.boundaries){let e=it(t.floor,t.x,t.z),n=ft.get(e);n||ft.set(e,n=[]),n.push(t),pt.set(gt(t.floor,t.x,t.z,t.dir),t)}for(let e of G)rt.add(e)}}))},xt=new _r;xt.setAttribute(`position`,new X(new Float32Array(192),3));let St=new Uint16Array(96);for(let e=0;e<16;e++)St.set([e*4,e*4+1,e*4+2,e*4,e*4+2,e*4+3],e*6);xt.setIndex(new X(St,1)),xt.setDrawRange(0,0);let Ct=new ai(xt,new qr({color:16770140,transparent:!0,opacity:.28,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-3,polygonOffsetUnits:-3,side:2}));Ct.renderOrder=9,Ct.frustumCulled=!1,Ct.userData.noPick=!0,r.add(Ct);let wt=e=>{let t=xt.getAttribute(`position`),n=L.current.manifest;if(!n)return;let r=n.botXTiles*128,i=0;for(let n of e){if(i>=16)break;let e=(e,t)=>new J(r-e*128,H(e-.5,t-.5)+3,t*128),a=[e(n.x,n.z),e(n.x+1,n.z),e(n.x+1,n.z+1),e(n.x,n.z+1)];for(let e=0;e<4;e++)t.setXYZ(i*4+e,a[e].x,a[e].y,a[e].z);i++}t.needsUpdate=!0,xt.setDrawRange(0,i*6)},Tt=null,Et=``,Dt=new qr({color:16770140,transparent:!0,opacity:.4,blending:2,depthWrite:!1}),Ot=e=>{let t=e?`${e.id}:${e.ax},${e.az},${e.dir}`:``;if(t===Et)return;Et=t,Tt&&=(r.remove(Tt),Tt.traverse(e=>{e instanceof ai&&e.geometry.dispose()}),null);let n=L.current.manifest;if(!e||!W||!n)return;let i=new hn;for(let{geometry:t}of Kl(W,[{id:e.id,dir:e.dir,x:e.ax,z:e.az}],n.botXTiles*128,H)){let e=new ai(t,Dt);e.renderOrder=9,i.add(e)}i.userData.noPick=!0,Tt=i,r.add(i)},kt=new Map,At=(t,n,r,a)=>{let o=L.current,s=new Set;if(n&&r<=60){i.updateMatrixWorld();let n=e.clientWidth||800,r=e.clientHeight||600;for(let e of o.respawnGhosts){if(e.plane!==t)continue;let o=`${e.x},${e.z}`,c=a(e.x,e.z).project(i);if(c.z>1||c.z<-1||c.x<-1.05||c.x>1.05||c.y<-1.05||c.y>1.05)continue;s.add(o);let l=kt.get(o);l||(l=document.createElement(`div`),l.style.cssText=`position:absolute;transform:translate(-50%,-100%);font:10px monospace;color:rgba(196,200,208,.5);background:rgba(10,14,24,.25);padding:0 4px;border-radius:4px;pointer-events:none;white-space:nowrap;z-index:880000;`,Pe.appendChild(l),kt.set(o,l));let u=`${e.name??e.id} · ${e.t}t`;l.textContent!==u&&(l.textContent=u),l.style.left=`${(c.x+1)/2*n}px`,l.style.top=`${(1-c.y)/2*r-26}px`}}for(let[e,t]of kt)s.has(e)||(t.remove(),kt.delete(e))},jt=(e,t,n)=>{for(let r=0;r>=-4;r--)for(let i=0;i>=-4;i--){let a=et.get(at(e,t+r,n+i));if(!a)continue;let o=tt.get(at(e,a.x,a.z))??a.id,s=W?.objects.get(o);if(!s)continue;let c=a.dir===0||a.dir===4?s.w:s.h,l=a.dir===0||a.dir===4?s.h:s.w;if(t>=a.x&&t<a.x+c&&n>=a.z&&n<a.z+l)return{type:`object`,id:o,name:s.name,ax:a.x,az:a.z,dir:a.dir,w:c,h:l}}return null},Mt=(e,t,n,r,i,a)=>{let o=i-n,s=a-r,c=o*o+s*s,l=c===0?0:Math.max(0,Math.min(1,((e-n)*o+(t-r)*s)/c));return Math.hypot(e-(n+l*o),t-(r+l*s))},Nt=(e,t,n)=>{if(!dt)return null;let r=Math.floor(t+.5),i=Math.floor(n+.5),a=null,o=.3;for(let s=-1;s<=1;s++)for(let c=-1;c<=1;c++){let l=r+s,u=i+c;for(let r=0;r<4;r++){let i=gt(e,l,u,r),s=mt.get(i)??pt.get(i)?.id;if(s==null)continue;let c=dt.get(s);if(!c||c.height<=0)continue;let d=l-.5,f=u-.5,[p,m,h,g]=r===0?[d,f,d+1,f]:r===1?[d,f,d,f+1]:r===2?[d+1,f,d,f+1]:[d,f,d+1,f+1],_=Mt(t,n,p,m,h,g);_<o&&(o=_,a={type:`wall`,id:s,name:c.name,x:l,z:u,dir:r})}}return a},Pt=(e,t)=>{if(!W)return null;let a=n.domElement.getBoundingClientRect();if(!a.width||!a.height)return null;let o=(e-a.left)/a.width*2-1,s=-((t-a.top)/a.height*2-1),c=o*i.right,l=s*i.top,u=2*i.right/a.width,d=i.clone();d.left=c-u,d.right=c+u,d.bottom=l-u,d.top=l+u,d.updateProjectionMatrix();let f=n.getRenderTarget(),p=n.getClearColor(new Sn),m=n.getClearAlpha(),h=r.background;r.background=null;for(let e of zt.values())e.uniforms.pickMode.value=1,e.blending=0;let g=[];for(let e of r.children)e.userData.noPick&&e.visible&&(e.visible=!1,g.push(e));n.setRenderTarget(S),n.setClearColor(0,0),n.clear(),n.render(r,d),n.readRenderTargetPixels(S,0,0,1,1,T);for(let e of g)e.visible=!0;n.setRenderTarget(f),n.setClearColor(p,m),r.background=h;for(let e of zt.values())e.uniforms.pickMode.value=0,e.blending=1;let _=T[3];if(_<8||_>15)return null;let v=T[0]|T[1]<<8|T[2]<<16|_<<24,y=v>>12&4095,b=v&4095,x=Xu(L.current.floor).plane;if((v>>26&1)==1){let e=v>>24&3,t=gt(x,y,b,e),n=mt.get(t)??pt.get(t)?.id,r=n==null?void 0:dt?.get(n);return r?{type:`wall`,id:n,name:r.name,x:y,z:b,dir:e}:null}return jt(x,y,b)},Ft=(e,t,r=!1)=>{let a=L.current.manifest;if(!a)return null;let o=a.botXTiles*128,s=i.position,u=new J(-Math.cos(l)*Math.sin(c),-Math.sin(l),-Math.cos(l)*Math.cos(c)),d=(e,t,n)=>(e-s.x)*u.x+(t-s.y)*u.y+(n-s.z)*u.z,f=null,p=1/0,m=null,h=1/0;{let r=n.domElement.getBoundingClientRect();if(r.width&&r.height){let n=e-r.left,a=t-r.top,s=r.width/(i.right-i.left);for(let e of Fe.current()){let t=o-(e.x*128+64),c=H(e.x,e.z),l=e.z*128+64,u=new J(t,c,l).project(i),g=e.kind===`npc`&&e.npcId!=null?He.dims(e.npcId):null,_=g?Math.max(56,g.w):90,v=g?Math.max(70,g.h):230,y=e.dir===8||e.dir===9,b=e.dir===8?-30:e.dir===9?30:0,x=(_/2+(y?15:0))*s,S=v*s,C=(u.x+1)/2*r.width+b*s,w=(1-u.y)/2*r.height,T=g?g.h:e.appearance?220:130,E=Math.min(w-S,w-T*s-12),D=w+10,O=(E+D)/2,k=(D-E)/2,A=(n-C)/x,j=(a-O)/k;if(A*A+j*j>1)continue;let M=d(t,c+Math.max(0,Math.min(1,(w-a)/S))*v,l);e.kind===`bot`?M<p&&(p=M,f=e):M<h&&(h=M,m=e)}}}let g=D(e,t)??A(e,t);if(!g)return{bot:f,ent:m,ground:[],wall:null,obj:null,tile:null,entDepth:null,objDepth:null};let _=d(g.x,g.y,g.z),v=(o-g.x)/128-.5,y=g.z/128-.5;if(!f&&!m){let e=Fe.nearestEntity(v,y,.6);e&&(e.kind===`bot`?f=e:(m=e,h=d(o-(e.x*128+64),H(e.x,e.z),e.z*128+64)))}let b=(e,t)=>{let n=Math.floor(e+.5);return!r||t===null?n:e>=t-.5-Yu&&e<=t+.5+Yu?t:n},x=b(v,r?ce:null),S=b(y,r?le:null);r&&(ce=x,le=S);let C=[];for(let e of L.current.groundItems){let t=Math.hypot(e.x-v,e.z-y);t<.7&&C.push({g:e,d:t})}C.sort((e,t)=>e.d-t.d);let w=Xu(L.current.floor).plane,T=Pt(e,t),E=null,O=null;if(T)T.type===`wall`?E=T:O=T;else if(!W)E=Nt(w,v,y),O=jt(w,x,S);else{let e=jt(w,x,S);e&&e.type===`object`&&(e.ax>=4096||e.az>=4096)&&(O=e)}return{bot:f,ent:m,ground:C.map(e=>e.g),wall:E,obj:O,tile:{x,z:S},entDepth:m?h:null,objDepth:_}};window.__w3dResolve=(e,t)=>It(e,t);let It=(e,t,n=!1)=>{let r=Ft(e,t,n);if(!r)return null;if(r.bot)return{type:`entity`,...r.bot};let i=r.wall??r.obj;if(r.ent)return i&&r.objDepth!=null&&r.entDepth!=null&&r.objDepth<r.entDepth?i:{type:`entity`,...r.ent};if(r.ground.length>0){let e=r.ground[0];return{type:`grounditem`,id:e.id,name:e.name,x:e.x,z:e.z}}return i||(r.tile?{type:`tile`,x:r.tile.x,z:r.tile.z}:null)},Rt=e=>{if(Fe.hoverKey=e?.type===`entity`?e.key:null,He.highlightKey=e?.type===`entity`&&e.kind===`npc`?e.key:null,Ue.highlightKey=e?.type===`entity`&&(e.kind===`bot`||e.kind===`player`)?e.key:null,e?.type===`object`){Ot(e);let t=[];for(let n=0;n<e.w;n++)for(let r=0;r<e.h;r++)t.push({x:e.ax+n,z:e.az+r});wt(t)}else Ot(null),e?.type===`entity`||e?.type===`grounditem`?wt([{x:Math.round(e.x),z:Math.round(e.z)}]):e?.type===`wall`||e?.type===`tile`?wt([{x:e.x,z:e.z}]):wt([]);be.style.cursor=e?.type===`entity`||e?.type===`object`||e?.type===`wall`?`pointer`:``},zt=new Map,Bt=new da,Vt=(e,t)=>{let n=zt.get(e);if(n)return n;let r={map:{value:null},textured:{value:e>=0},vScroll:{value:0},pickMode:{value:0}};if(e>=0){let n=Bt.load(Sl(e,t));n.magFilter=m,n.minFilter=m,n.wrapS=d,n.wrapT=d,n.flipY=!1,r.map.value=n}return n=new Hi({glslVersion:Xe,vertexShader:$u,fragmentShader:ed,uniforms:r,side:2}),zt.set(e,n),n},Ht=-1;window.__w3dAnim=()=>({cells:ot.size,anims:W?W.anims.size:-1,visible:[...ot.values()].map(e=>e.map(e=>+!!e.visible).join(``))}),window.__w3dSel=()=>({selectedEntityKey:Fe.selectedEntityKey,hoverKey:Fe.hoverKey,propSelected:R.current.selectedBot??null}),window.__w3dWindmills=()=>{let e=[];for(let[,t]of st)for(let{group:n}of t)e.push({plane:n.userData.plane,visible:n.visible,quat:[n.quaternion.x,n.quaternion.y,n.quaternion.z,n.quaternion.w]});return e},window.__w3dPlanes=()=>{let e=0,t=0,n=n=>{n.userData.plane!==Ae&&(t++,n.visible&&e++)};for(let[,e]of nt)n(e);for(let[,e]of ht)n(e);for(let[,e]of ot)e.forEach(n);for(let[,e]of Ut)n(e);return{activePlane:Ae,retained:t,wrongVisible:e,loaded:Ut.size,scenery:nt.size}};let Ut=new Map,Wt=new Set,Gt=[],Kt=null,qt=()=>{let e=L.current,t=e.manifest;if(!t)return;let n=t.botXTiles*128,{plane:i,kinds:o}=Xu(e.floor);if(Kt!==e.floor){Kt=e.floor,Ae=i;let r=(n-a.x)/128,s=a.z/128;Gt=[];for(let e of t.cells)if(e.plane===i)for(let n of o){if(!e.kinds.includes(n))continue;let i=`p${e.plane}_${e.a}_${e.b}_${n}`;if(Ut.has(i)||Wt.has(i))continue;let a=e.botX0+t.cellTiles/2,o=e.botZ0+t.cellTiles/2;Gt.push({cell:e,kind:n,key:i,d:Math.hypot(a-r,o-s)})}Gt.sort((e,t)=>e.d-t.d)}for(;Wt.size<24&&Gt.length>0;){let{cell:e,kind:i,key:a}=Gt.shift();Ut.has(a)||Wt.has(a)||(Wt.add(a),fetch(xl(e,i,t.baked)).then(e=>{if(!e.ok)throw Error(`${e.status}`);return e.arrayBuffer()}).then(o=>{let s=new hn;s.userData.kind=i,s.userData.plane=e.plane;let c=ke(e.plane),l=i===`terrain`?(e,t,n)=>je(c,e,t,n):void 0;for(let{tex:r,geometry:i}of id(o,n,e.botX0,e.botZ0,l))s.add(new ai(i,Vt(r,t.baked)));if(s.visible=e.plane===Ae,Ut.set(a,s),r.add(s),i===`terrain`){let t=it(e.plane,e.botX0,e.botZ0);G.add(t),rt.add(t)}}).catch(()=>{}).finally(()=>{Wt.delete(a),Gt.length>0&&setTimeout(qt,0)}))}for(let[,e]of Ut){let t=Ku.has(e.userData.kind)&&!L.current.roofs;e.visible=e.userData.plane===i&&!t}for(let[,e]of nt)e.visible=e.userData.plane===i;for(let[,e]of ht)e.visible=e.userData.plane===i;for(let[,e]of ot)if(e.length>0&&e[0].userData.plane!==i)for(let t of e)t.visible=!1;for(let[,e]of st)for(let{group:t}of e)t.visible=t.userData.plane===i;if(e.observedRev!==K&&W){if(K=e.observedRev,dt)for(let t of e.observedDoors){let e=gt(t.plane,t.x,t.z,t.dir),n=pt.get(e);!n||n.id!==t.id?mt.get(e)!==t.id&&(mt.set(e,t.id),rt.add(it(t.plane,t.x,t.z))):mt.has(e)&&(mt.delete(e),rt.add(it(t.plane,t.x,t.z)))}let t=new Map;for(let n of e.observed){let e=at(n.plane,n.x,n.z),r=et.get(e);(!r||r.id!==n.id)&&t.set(e,n.id)}for(let[e,n]of t)if(tt.get(e)!==n){tt.set(e,n);let[t,r]=e.split(`:`),[i,a]=r.split(`,`).map(Number);rt.add(it(parseInt(t,10),i,a))}for(let t of e.observed){let e=at(t.plane,t.x,t.z),n=et.get(e);n&&n.id===t.id&&tt.has(e)&&(tt.delete(e),rt.add(it(t.plane,t.x,t.z)))}}if(W){let e=0;for(let t of rt){if(e++>=8)break;rt.delete(t),G.has(t)&&(ut(t),yt(t))}}_();let s=Ut.size+Wt.size+Gt.length;w(Wt.size+Gt.length>0?`loading ${Ut.size}/${s} cells…`:``)},Jt=!1,Yt=!1,Xt=e=>{W||Yt||(Yt=!0,Wl.fetch(e).then(e=>{if(Yt=!1,!(Jt||!e)){W=e;for(let e of G)rt.add(e)}}))};bl().then(e=>{if(Jt)return;L.current.manifest=e,Xt(e.baked),bt(),Ye(),Qe();let t=e.botXTiles*128;h=Math.max(e.botXTiles,e.botZTiles)*128;let n=L.current.focusBot,r=s(M.get(`x`))??n.x,i=s(M.get(`z`))??n.z,o=t-r*128,c=i*128;a.set(o,0,c),v(),w(``),qt()}).catch(e=>w(`world mesh not ready (${e.message??e}) — retrying…`));let Zt=setInterval(()=>{L.current.manifest?(W||Xt(L.current.manifest.baked),bt(),Ye(),Qe(),Ge()):bl().then(e=>{L.current.manifest=e,w(``),qt()}).catch(()=>{})},5e3),Qt=Zu.map(e=>({...e}));for(let e=1;e<Qt.length;e++){let t=Qt[e].yaw-Qt[e-1].yaw;t=((t+180)%360+360)%360-180,Qt[e].yaw=Qt[e-1].yaw+t}let $t=[0];for(let e=1;e<Qt.length;e++)$t.push($t[e-1]+(Qt[e].sec??6));let en=$t[$t.length-1],tn=e=>{let t=L.current.manifest;if(!t)return;let n=Math.min(e,en),r=0;for(;r<$t.length-2&&n>$t[r+1];)r++;let i=(n-$t[r])/Math.max(1e-6,$t[r+1]-$t[r]);r===0&&(i=i*i*(3-2*i)),r===$t.length-2&&(i=i*i*(3-2*i));let o=e=>Qt[Math.max(0,Math.min(Qt.length-1,e))],s=e=>Qu(e(o(r-1)),e(o(r)),e(o(r+1)),e(o(r+2)),i),d=t.botXTiles*128;a.set(d-s(e=>e.x)*128,0,s(e=>e.z)*128),c=s(e=>e.yaw)*Math.PI/180,l=Math.max(u,Math.min(f,s(e=>e.pitch)*Math.PI/180)),N=Math.exp(s(e=>Math.log(e.zoom*128))),F(),v()},nn=0,rn=0,an=0,on=t=>{if(an=requestAnimationFrame(on),R.current.visible===!1)return;let o=L.current;if(o.manifest){Le.visible=o.sight,Fe.showPlates=o.tags;let n=o.entitiesRev!==Ie;n&&(Ie=o.entitiesRev,Fe.update(o.entities,t));let r=o.manifest.botXTiles*128,s=(e,t)=>new J(r-(e*128+64),H(e,t),t*128+64);n&&Le.update(o.entities.filter(e=>e.kind===`bot`),s),(o.route!==ze||o.floor!==Be)&&(ze=o.route,Be=o.floor,Ve(Xu(o.floor).plane,s)),At(Xu(o.floor).plane,o.tags,N/128,s);let u=zt.get(17);u&&(u.uniforms.vScroll.value=-(t/1280%1));let d=R.current.follow;if(d&&!z&&!P.current){let e=Fe.current().find(e=>e.key===`bot:${d}`);if(e){let n=s(e.x,e.z),r=rn?Math.min(.1,(t-rn)/1e3):0,i=r>0?1-Math.exp(-r/.12):1;a.x+=(n.x-a.x)*i,a.y=0,a.z+=(n.z-a.z)*i,v()}rn=t}else rn=0;if(I.current.length>0){let e=new Map,n=new Map;for(let t of Fe.current()){e.set(t.key,{x:t.x,z:t.z});let r=t.kind===`npc`&&t.npcId!=null?He.dims(t.npcId):null;n.set(t.key,(r?r.h:t.appearance?220:130)/2)}qe.frame(t,I.current,t=>e.get(t)??null,s,e=>n.get(e)??60)}else qe.frame(t,[],()=>null,s,()=>60);let f=Math.floor(t/120);if(f!==Ht){Ht=f;for(let[,e]of ot){let t=e.length>0&&e[0].userData.plane===Ae;for(let n=0;n<e.length;n++)e[n].visible=t&&n===f%e.length}}let p=t/Ju*Math.PI*2;for(let[,e]of st)for(let{group:t,axis:n}of e)t.visible&&t.quaternion.setFromAxisAngle(n,p);Fe.frame(t,s,Ne,i,e.clientWidth||800,e.clientHeight||600,N/128);let{right:m,up:h}=y(),g=new J(Math.cos(l)*Math.sin(c),Math.sin(l),Math.cos(l)*Math.cos(c)),_=m.multiplyScalar(-1),b=160*Math.sin(l);He.frame(t,Fe.snapshot(`npc`,t),s,_,h,c,g,b),Ue.frame(t,[...Fe.snapshot(`bot`,t),...Fe.snapshot(`player`,t)],s,_,h,c,g,b),Ke.frame(o.groundItems,s,_,h,g,b)}let s=P.current;if(s){let e=(t-s.start)/1e3;tn(e),e>=en&&(P.current=null,ee(!1))}if(t-nn>250&&(nn=t,qt()),oe){let e=oe;oe=null,e.kind===`canvas`?fe(e.x,e.y):e.kind===`plate`?pe(e.key):de(null)}n.render(r,i)};return an=requestAnimationFrame(on),F(),v(),()=>{Jt=!0,ie.current=null;for(let e of[...nt.keys(),...ot.keys(),...st.keys()])ct(e);for(let e of[...ht.keys()])vt(e);Le.dispose(r),Re.dispose(r),qe.dispose();for(let[,e]of kt)e.remove();kt.clear(),He.dispose(r),Ue.dispose(),Ke.dispose(r),Fe.dispose(r),Pe.remove(),g&&clearTimeout(g),clearInterval(Zt),cancelAnimationFrame(an),te.disconnect();for(let[,e]of Ut)e.traverse(e=>{e instanceof ai&&e.geometry.dispose()});for(let[,e]of zt)(e.uniforms.map?.value)?.dispose(),e.dispose();n.dispose(),e.removeChild(n.domElement)}},[]),(0,$.jsxs)(`div`,{style:{position:`relative`,width:`100%`,height:`100%`},children:[(0,$.jsx)(`div`,{ref:t,style:{position:`absolute`,inset:0,overflow:`hidden`}}),(0,$.jsxs)(`div`,{style:{position:`absolute`,top:8,left:8,display:`flex`,gap:6,zIndex:1e6,background:`rgba(16,16,26,.8)`,padding:`6px 8px`,borderRadius:6,alignItems:`center`,fontSize:13,userSelect:`none`},children:[!a&&Gu.map(e=>(0,$.jsx)(`button`,{className:o===e.key?`active`:``,onClick:()=>s(e.key),children:e.label},e.key)),!a&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:_,onChange:e=>b(e.target.checked)}),`roofs`]}),!e.hideSight&&(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:v,onChange:e=>x(e.target.checked)}),`sight`]}),(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:y,onChange:e=>S(e.target.checked)}),`tags`]}),e.extraToggles,(0,$.jsx)(`button`,{style:{marginLeft:8},onClick:()=>{P.current?(P.current=null,ee(!1)):(P.current={start:performance.now()},ee(!0))},children:N?`Stop`:`Fly`})]}),C&&(0,$.jsx)(`span`,{style:{marginLeft:8,opacity:.8},children:C})]}),te&&(0,$.jsxs)(`div`,{style:{position:`absolute`,left:Math.max(0,te.x-4),top:Math.max(0,te.y-8),zIndex:2e6,background:`rgba(208,208,208,0.63)`,padding:`2px 6px 4px 4px`,font:`bold 12px sans-serif`,whiteSpace:`nowrap`,userSelect:`none`},onPointerDown:e=>e.stopPropagation(),children:[(0,$.jsx)(`div`,{style:{color:`#0ff`,textShadow:`1px 0 #000, 0 1px #000`},children:`Choose option`}),te.entries.map((e,t)=>(0,$.jsxs)(`div`,{style:{textShadow:`1px 0 #000, 0 1px #000`,cursor:`pointer`,lineHeight:`15px`},onMouseEnter:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#ff0`)},onMouseLeave:e=>{let t=e.currentTarget.querySelector(`[data-verb]`);t&&(t.style.color=`#fff`)},onClick:()=>{e.run?.(),ne(null)},children:[(0,$.jsx)(`span`,{"data-verb":!0,style:{color:`#fff`},children:e.verb}),e.target&&(0,$.jsxs)(`span`,{style:{color:e.tcolor??`#fff`},children:[` `,e.target]}),e.suffix&&(0,$.jsx)(`span`,{style:{color:e.scolor??`#fff`},children:e.suffix})]},t))]}),T&&(0,$.jsx)(`div`,{style:{position:`absolute`,bottom:8,left:8,background:`rgba(16,16,26,.85)`,padding:`4px 10px`,borderRadius:6,fontSize:13,fontFamily:`monospace`,pointerEvents:`none`},children:T}),D&&(0,$.jsxs)(`div`,{style:{position:`absolute`,bottom:8,right:8,minWidth:180,background:`rgba(16,16,26,.92)`,padding:`8px 12px`,borderRadius:8,fontSize:13,fontFamily:`monospace`,border:`1px solid #3a4664`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,gap:12},children:[(0,$.jsx)(`b`,{children:D.name??D.key}),(0,$.jsx)(`span`,{style:{cursor:`pointer`,opacity:.7},onClick:()=>O(null),children:`✕`})]}),(0,$.jsxs)(`div`,{style:{opacity:.85,marginTop:4},children:[D.kind,D.npcId==null?``:` · id ${D.npcId}`,D.inCombat?` · in combat`:``]}),D.appearance&&(0,$.jsxs)(`div`,{style:{marginTop:6,borderTop:`1px solid #3a4664`,paddingTop:6,maxWidth:260},children:[Wu(D.appearance,k).map(e=>(0,$.jsxs)(`div`,{style:{display:`flex`,gap:8,lineHeight:`18px`},children:[(0,$.jsx)(`span`,{style:{opacity:.55,width:52,flexShrink:0},children:e.slot}),(0,$.jsx)(`span`,{children:e.names})]},e.slot)),Wu(D.appearance,k).length===0&&(0,$.jsx)(`div`,{style:{opacity:.55},children:`nothing equipped`})]})]})]})}function od(e){let t=e.d.length,n=new Int16Array(t*2),r=e.x,i=e.z;n[0]=r,n[1]=i;for(let a=1;a<t;a++){let t=e.d.charCodeAt(a-1)-48;r+=Math.floor(t/3)-1,i+=t%3-1,n[a*2]=r,n[a*2+1]=i}return n}var sd=[];function cd({data:e}){let t=(0,l.useMemo)(()=>({npcs:e.npcs.map(e=>({si:e.si,id:e.id??0,pos:od(e),n:e.d.length})),players:e.players.map(e=>({si:e.si,a:e.a??``,pos:od(e),n:e.d.length}))}),[e]),n=(0,l.useRef)(0),[r,i]=(0,l.useState)(0),[a,o]=(0,l.useState)(!0);return(0,l.useEffect)(()=>{if(!a)return;let t=0,r=a=>{n.current||=a,i(Math.floor((a-n.current)/e.tickMs)),t=requestAnimationFrame(r)};return t=requestAnimationFrame(r),()=>cancelAnimationFrame(t)},[e.tickMs,a]),(0,$.jsx)(`div`,{style:{width:`100vw`,height:`100vh`},children:(0,$.jsx)(ad,{bots:(0,l.useMemo)(()=>{if(!a)return sd;let n=t.npcs.map(t=>{let n=r%t.n*2;return{serverIndex:t.si,id:t.id,name:e.names[t.id]??null,x:t.pos[n],z:t.pos[n+1],inCombat:!1}}),i=t.players.map(e=>{let t=r%e.n*2;return{serverIndex:e.si,id:0,name:null,x:e.pos[t],z:e.pos[t+1],inCombat:!1,appearance:e.a}});return[{username:`demo`,status:`online`,scriptClass:null,description:null,serverTick:r,position:null,fatiguePercent:0,sleeping:!1,inCombat:!1,npcs:n,players:i}]},[t,r,a,e.names]),focus:{x:122,z:650},hideSight:!0,extraToggles:(0,$.jsxs)(`label`,{style:{marginLeft:8,display:`flex`,alignItems:`center`,gap:4},children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:a,onChange:e=>o(e.target.checked)}),`simulation`]})})})}function ld(){let[e,t]=(0,l.useState)(null),[n,r]=(0,l.useState)(null);return(0,l.useEffect)(()=>{fetch(yl(`/api/demo/entities.json`)).then(e=>e.ok?e.json():Promise.reject(Error(`${e.status}`))).then(t).catch(e=>r(String(e)))},[]),n?(0,$.jsx)(`div`,{style:{width:`100vw`,height:`100vh`},children:(0,$.jsx)(ad,{bots:[],focus:{x:122,z:650}})}):e?(0,$.jsx)(cd,{data:e}):(0,$.jsx)(`div`,{style:{padding:16},children:`Loading world…`})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(ld,{}));
//# sourceMappingURL=index-Ctf3HMoj.js.map